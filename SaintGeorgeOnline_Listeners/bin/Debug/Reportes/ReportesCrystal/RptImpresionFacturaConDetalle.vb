...
Public Class RptImpresionFacturaConDetalle
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptImpresionFacturaConDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SaintGeorgeOnline_Listeners.RptImpresionFacturaConDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptImpresionFacturaConDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptImpresionFacturaConDetalle = New RptImpresionFacturaConDetalle
        rpt.Site = Me.Site
        Return rpt
    End Function
