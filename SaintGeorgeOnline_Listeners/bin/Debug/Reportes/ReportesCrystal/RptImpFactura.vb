...
Public Class RptImpFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SaintGeorgeOnline_Listeners.RptImpFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptImpFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptImpFactura = New RptImpFactura
        rpt.Site = Me.Site
        Return rpt
    End Function
