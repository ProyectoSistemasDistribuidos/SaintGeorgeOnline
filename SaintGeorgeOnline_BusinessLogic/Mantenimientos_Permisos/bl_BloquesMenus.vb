...
Namespace ModuloPermisos
    ...
    Public Class bl_BloquesMenus

#Region "Atributos"

        Private str_Mensaje As String
        Private obj_da_BloqueMenu As da_BloquesMenus
...
#Region "Constructor"
        ...
        Public Sub New()
            obj_da_BloqueMenu = New da_BloquesMenus
        End Sub
...
#Region "Metodos Transacciones"
        ...
        Public Function FUN_INS_BloqueMenu(ByVal objSubbloqueMenu As be_BloquesMenus, ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            Return obj_da_BloqueMenu.FUN_INS_BloqueMenu(objSubbloqueMenu, str_Mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, int_CodigoModulo, int_CodigoOpcion)
        End Function
        ...
        Public Function FUN_UPD_BloqueMenu(ByVal objBloqueMenu As be_BloquesMenus, ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            Return obj_da_BloqueMenu.FUN_UPD_BloqueMenu(objBloqueMenu, str_Mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, int_CodigoModulo, int_CodigoOpcion)
        End Function
        ...
        Public Function FUN_DEL_BloqueMenu(ByVal int_Codigo As Integer, ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            Return obj_da_BloqueMenu.FUN_DEL_BloqueMenu(int_Codigo, str_Mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, int_CodigoModulo, int_CodigoOpcion)
        End Function
...
#Region "Metodos No Transaccionales"
        ...
        Public Function FUN_LIS_BloqueMenu(ByVal str_Descripcion As String, ByVal int_Estado As Integer, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet
            Return obj_da_BloqueMenu.FUN_LIS_BloqueMenu(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, int_CodigoModulo, int_CodigoOpcion)
        End Function
        ...
        Public Function FUN_GET_BloqueMenu(ByVal int_Codigo As Integer, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet
            Return obj_da_BloqueMenu.FUN_GET_BloqueMenu(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, int_CodigoModulo, int_CodigoOpcion)
        End Function
