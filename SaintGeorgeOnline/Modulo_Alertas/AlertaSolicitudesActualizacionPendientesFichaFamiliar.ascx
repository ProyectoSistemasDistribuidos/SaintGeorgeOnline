<%@ Control Language="VB" AutoEventWireup="false" CodeFile="AlertaSolicitudesActualizacionPendientesFichaFamiliar.ascx.vb" Inherits="Modulo_Alertas_AlertaSolicitudesActualizacionPendientesFichaFamiliar" %>

<atk:DragPanelExtender ID="DragPanelExtender_AlertaSolicitudesActualizacionPendientesFichaFamiliar" runat="server" 
                        Enabled="True" 
                        BehaviorID="Drag_AlertaSolicitudesActualizacionPendientesFichaFamiliar"                         
                        DragHandleID="pnlContainer_AlertaSolicitudesActualizacionPendientesFichaFamiliar" 
                        TargetControlID="pnlContainer_AlertaSolicitudesActualizacionPendientesFichaFamiliar">
</atk:DragPanelExtender>

<asp:Panel ID="pnlContainer_AlertaSolicitudesActualizacionPendientesFichaFamiliar" runat="server">
<div id="divSolicitudesActualizacionPendientesFichaFamiliar" runat="server" style="position: relative;width: 230px; height: 190px;">
                            ...
                            <tr>                                 
                                <td style="width:60px; height:30px;" align="right" valign="middle">
                                    <asp:ImageButton ID="btnRegularizarStock" runat="server" 
                                        ...
                                        PostBackUrl="~/Modulo_Matricula/ValidarFichaFamiliar.aspx" CausesValidation="false" />
                                </td>                                
                                <td style="width:170px; height:30px;" align="left" valign="middle">
                                    <asp:LinkButton ID="linkRegularizarStock" runat="server" 
                                        PostBackUrl="~/Modulo_Matricula/ValidarFichaFamiliar.aspx" 
...
<div id="ModalPopUP_AlertaSolicitudesActualizacionPendientesFichaFamiliar">
    <atk:ModalPopupExtender ID="pnModalListaAlertaSolicitudesActualizacionPendientesFichaFamiliar" runat="server"
        TargetControlID="VerListaAlertaSolicitudesActualizacionPendientesFichaFamiliar"
        PopupControlID="miPanelAlertaSolicitudesActualizacionPendientesFichaFamiliar"
        BackgroundCssClass="MiModalBackground" 
        DropShadow="false" 
        OkControlID="OKListaAlertaSolicitudesActualizacionPendientesFichaFamiliar" 
        CancelControlID="CancelListaAlertaSolicitudesActualizacionPendientesFichaFamiliar"
        Drag="true" 
        PopupDragHandleControlID="miDragControl" />           

    <asp:panel id="miPanelAlertaSolicitudesActualizacionPendientesFichaFamiliar" runat="server" BackColor="#4c4c4c" style="background:url('/SaintGeorgeOnline/App_Themes/Imagenes/fondoAlerta3.png') no-repeat; width:400px; height:400px; display: none">  
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:400px; height: 40px">
                    <tr>
                        ...
                        <td style="width:40px; height: 40px;" align="left" valign="middle">
                            <asp:ImageButton ID="btnCerraListaAlertaSolicitudesActualizacionPendientesFichaFamiliar" runat="server" Width="25" Height="29"
                                ImageUrl="/SaintGeorgeOnline/App_Themes/Imagenes/x.png" CssClass="miPaddingBottom"
                                onclick="btnCerraListaAlertaSolicitudesActualizacionPendientesFichaFamiliar_Click" ToolTip="Cerrar Panel"/>
                        </td>
                    </tr>
                </table> 
            </td>            
        ...
        <tr>
            <td style="width: 400px; height: 300px; border: solid 0px green" valign="top" align="center">   
                ...
                <asp:GridView ID="miGridviewSolicitudesActualizacionPendientesFichaFamiliar" runat="server"
                    Width="380"
                    ...
                    OnRowDataBound="miGridviewSolicitudesActualizacionPendientesFichaFamiliar_RowDataBound">    
    ...
    <div id="controlListaAlertaSolicitudesActualizacionPendientesFichaFamiliar" style="display:none">
            <input type="button" id="VerListaAlertaSolicitudesActualizacionPendientesFichaFamiliar" runat="server" />
            <input type="button" id="OKListaAlertaSolicitudesActualizacionPendientesFichaFamiliar" />
            <input type="button" id="CancelListaAlertaSolicitudesActualizacionPendientesFichaFamiliar" />
    </div>       
    </asp:panel>       
</div>  