<%@ Control Language="VB" AutoEventWireup="false" CodeFile="AlertaSolicitudesActualizacionPendientesFichaAlumno.ascx.vb" Inherits="Modulo_Alertas_AlertaSolicitudesActualizacionPendientesFichaAlumno" %>

<atk:DragPanelExtender ID="DragPanelExtender_AlertaSolicitudesActualizacionPendientesFichaAlumno" runat="server" 
                        Enabled="True" 
                        BehaviorID="Drag_AlertaSolicitudesActualizacionPendientesFichaAlumno"                         
                        DragHandleID="pnlContainer_AlertaSolicitudesActualizacionPendientesFichaAlumno" 
                        TargetControlID="pnlContainer_AlertaSolicitudesActualizacionPendientesFichaAlumno">
</atk:DragPanelExtender>

<asp:Panel ID="pnlContainer_AlertaSolicitudesActualizacionPendientesFichaAlumno" runat="server">
<div id="divSolicitudesActualizacionPendientesFichaAlumno" runat="server" style="position: relative;width: 230px; height: 190px;">
                            ...
                            <tr>                                 
                                <td style="width:60px; height:30px;" align="right" valign="middle">
                                    <asp:ImageButton ID="btnRegularizarStock" runat="server" 
                                        ...
                                        PostBackUrl="~/Modulo_Matricula/ValidarFichaAlumnos.aspx"  CausesValidation="false" />
                                </td>                                
                                <td style="width:170px; height:30px;" align="left" valign="middle">
                                    <asp:LinkButton ID="linkRegularizarStock" runat="server" 
                                        PostBackUrl="~/Modulo_Matricula/ValidarFichaAlumnos.aspx" 
...
<div id="ModalPopUP_AlertaSolicitudesActualizacionPendientesFichaAlumno">
    <atk:ModalPopupExtender ID="pnModalListaAlertaSolicitudesActualizacionPendientesFichaAlumno" runat="server"
        TargetControlID="VerListaAlertaSolicitudesActualizacionPendientesFichaAlumno"
        PopupControlID="miPanelAlertaSolicitudesActualizacionPendientesFichaAlumno"
        BackgroundCssClass="MiModalBackground" 
        DropShadow="false" 
        OkControlID="OKListaAlertaSolicitudesActualizacionPendientesFichaAlumno" 
        CancelControlID="CancelListaAlertaSolicitudesActualizacionPendientesFichaAlumno"
        Drag="true" 
        PopupDragHandleControlID="miDragControl" />           

    <asp:panel id="miPanelAlertaSolicitudesActualizacionPendientesFichaAlumno" runat="server" BackColor="#4c4c4c" style="background:url('/SaintGeorgeOnline/App_Themes/Imagenes/fondoAlerta3.png') no-repeat; width:400px; height:400px; display: none">  
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:400px; height: 40px">
                    <tr>
                        ...
                        <td style="width:40px; height: 40px;" align="left" valign="middle">
                            <asp:ImageButton ID="btnCerraListaAlertaSolicitudesActualizacionPendientesFichaAlumno" runat="server" Width="25" Height="29"
                                ImageUrl="/SaintGeorgeOnline/App_Themes/Imagenes/x.png" CssClass="miPaddingBottom"
                                onclick="btnCerraListaAlertaSolicitudesActualizacionPendientesFichaAlumno_Click" ToolTip="Cerrar Panel"/>
                        </td>
                    </tr>
                </table> 
            </td>            
        ...
        <tr>
            <td style="width: 400px; height: 300px; border: solid 0px green" valign="top" align="center">   
                ...
                <asp:GridView ID="miGridviewSolicitudesActualizacionPendientesFichaAlumno" runat="server"
                    Width="380"
                    ...
                    OnRowDataBound="miGridviewSolicitudesActualizacionPendientesFichaAlumno_RowDataBound">    
    ...
    <div id="controlListaAlertaSolicitudesActualizacionPendientesFichaAlumno" style="display:none">
            <input type="button" id="VerListaAlertaSolicitudesActualizacionPendientesFichaAlumno" runat="server" />
            <input type="button" id="OKListaAlertaSolicitudesActualizacionPendientesFichaAlumno" />
            <input type="button" id="CancelListaAlertaSolicitudesActualizacionPendientesFichaAlumno" />
    </div>       
    </asp:panel>       
</div>  