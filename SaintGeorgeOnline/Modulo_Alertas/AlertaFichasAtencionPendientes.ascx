<%@ Control Language="VB" AutoEventWireup="false" CodeFile="AlertaFichasAtencionPendientes.ascx.vb" Inherits="Modulo_Alertas_AlertaFichasAtencionPendientes" %>

<atk:DragPanelExtender ID="DragPanelExtender_AlertaFichasAtencionPendientes" runat="server" 
                        Enabled="True" 
                        BehaviorID="Drag_AlertaFichasAtencionPendientes"                         
                        DragHandleID="pnlContainer_AlertaFichasAtencionPendientes" 
                        TargetControlID="pnlContainer_AlertaFichasAtencionPendientes">
</atk:DragPanelExtender>

<asp:Panel ID="pnlContainer_AlertaFichasAtencionPendientes" runat="server">
<div id="divFichasAtencionPendientes" runat="server" style="position: relative; width: 230px; height: 150px;">
                            ...
                            <tr>                                 
                                <td style="width:60px; height:30px;" align="right" valign="middle">
                                    <asp:ImageButton ID="btnRegularizarStock" runat="server" 
                                        ...
                                        PostBackUrl="~/Modulo_Enfermeria/FichaAtencion.aspx" CausesValidation="false" />    
                                </td>                                
                                <td style="width:170px; height:30px;" align="left" valign="middle">
                                    <asp:LinkButton ID="linkRegularizarStock" runat="server" 
                                        PostBackUrl="~/Modulo_Enfermeria/FichaAtencion.aspx" 
...
<div id="ModalPopUP_AlertaFichasAtencionPendientes">
    <atk:ModalPopupExtender ID="pnModalListaAlertaFichasAtencionPendientes" runat="server"
        TargetControlID="VerListaAlertaFichasAtencionPendientes"
        PopupControlID="miPanelAlertaFichasAtencionPendientes"
        BackgroundCssClass="MiModalBackground" 
        DropShadow="false" 
        OkControlID="OKListaAlertaFichasAtencionPendientes" 
        CancelControlID="CancelListaAlertaFichasAtencionPendientes"
        Drag="true" 
        PopupDragHandleControlID="miDragControl" />           

    <asp:panel id="miPanelAlertaFichasAtencionPendientes" runat="server" BackColor="#4c4c4c" style="background:url('/SaintGeorgeOnline/App_Themes/Imagenes/fondoAlerta3.png') no-repeat; width:400px; height:400px; display: none">  
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:400px; height: 40px">
                    <tr>
                        ...
                        <td style="width:40px; height: 40px;" align="left" valign="middle">
                            <asp:ImageButton ID="btnCerraListaAlertaFichasAtencionPendientes" runat="server" Width="25" Height="29"
                                ImageUrl="/SaintGeorgeOnline/App_Themes/Imagenes/x.png" CssClass="miPaddingBottom"
                                onclick="btnCerraListaAlertaFichasAtencionPendientes_Click" ToolTip="Cerrar Panel"/>
                        </td>
                    </tr>
                </table> 
            </td>            
        ...
        <tr>
            <td style="width: 400px; height: 300px; border: solid 0px green" valign="top" align="center">   
                ...
                <asp:GridView ID="miGridviewFichasAtencionPendientes" runat="server"
                    Width="380"
                    ...
                    OnRowDataBound="miGridviewFichasAtencionPendientes_RowDataBound">    
                    <HeaderStyle CssClass="miGridviewBusquedaPersona_Header" Font-Underline="False" ForeColor="White" HorizontalAlign="Center" />            
                     <Columns>            
                        ...
                        <asp:BoundField DataField="DescTipoPaciente" HeaderText="Tipo Paciente">
    ...
    <div id="controlListaAlertaFichasAtencionPendientes" style="display:none">
            <input type="button" id="VerListaAlertaFichasAtencionPendientes" runat="server" />
            <input type="button" id="OKListaAlertaFichasAtencionPendientes" />
            <input type="button" id="CancelListaAlertaFichasAtencionPendientes" />
    </div>       
    </asp:panel>       
</div>  