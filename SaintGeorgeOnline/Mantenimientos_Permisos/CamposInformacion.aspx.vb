...
''' <summary>
''' Modulo de Mantenimiento de Permisos: CamposInformacion
''' </summary>
''' <remarks>
''' Código del Modulo: 3   
''' Código de la Opción:83  
''' </remarks>
Partial Class Mantenimientos_Permisos_CamposInformacion
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Campos de Información")
            ...
            If Not Page.IsPostBack Then
                ...
                tbDescripcion.Attributes.Add("onkeypress", " ValidarLength(this, 200);")
                tbDescripcion.Attributes.Add("onkeyup", " ValidarLength(this, 200);")
                tbCampoBD.Attributes.Add("onkeypress", " ValidarLength(this, 200);")
                tbCampoBD.Attributes.Add("onkeyup", " ValidarLength(this, 200);")
                tbCampoAlias.Attributes.Add("onkeypress", " ValidarLength(this, 200);")
                tbCampoAlias.Attributes.Add("onkeyup", " ValidarLength(this, 200);")
                tbTablaRef.Attributes.Add("onkeypress", " ValidarLength(this, 10);")
                tbTablaRef.Attributes.Add("onkeyup", " ValidarLength(this, 10);")
                listar()
            End If
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        ...
        'Master.SeteoPermisosAcciones(btnBuscar, 83)
        'Master.SeteoPermisosAcciones(btnExportar, 83)
        'Master.SeteoPermisosAcciones(btnGrabar, 83)
        'Master.SeteoPermisosAcciones(btnNuevo, 83)
    ...
    Private Sub Exportar()
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            ...
            auxDR.Item("CampoBD") = dr.Item("CampoBD").ToString
            auxDR.Item("CampoAlias") = dr.Item("CampoAlias").ToString
            auxDR.Item("TablaRef") = dr.Item("TablaRef").ToString
            auxDR.Item("TipoDato") = dr.Item("TipoDato").ToString
            auxDR.Item("Identificador") = dr.Item("Identificador").ToString
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "CamposInformacion")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "CamposInformacion")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "CamposInformacion")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_CamposInformacion.FUN_LIS_CamposInformacion(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_CamposInformacion.FUN_GET_CamposInformacion(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        ...
        tbCampoBD.Text = ds_Lista.Tables(0).Rows(0).Item("CampoBD").ToString
        tbCampoAlias.Text = ds_Lista.Tables(0).Rows(0).Item("CampoAlias").ToString
        tbTablaRef.Text = ds_Lista.Tables(0).Rows(0).Item("TablaRef").ToString
        tbTipoDato.Text = ds_Lista.Tables(0).Rows(0).Item("TipoDato").ToString
        tbIdentificador.Text = ds_Lista.Tables(0).Rows(0).Item("Identificador").ToString
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_CamposInformacion.FUN_DEL_CamposInformacion(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_CamposInformacion As New be_CamposInformacion
        Dim obj_BL_CamposInformacion As New bl_CamposInformacion
        ...
        obj_BE_CamposInformacion.Descripcion = tbDescripcion.Text.Trim
        obj_BE_CamposInformacion.CampoBD = tbCampoBD.Text.Trim
        obj_BE_CamposInformacion.CampoAlias = tbCampoAlias.Text.Trim
        obj_BE_CamposInformacion.TablaRef = tbTablaRef.Text.Trim
        obj_BE_CamposInformacion.TipoDato = tbTipoDato.Text.Trim
        obj_BE_CamposInformacion.Identificador = tbIdentificador.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_CamposInformacion.FUN_INS_CamposInformacion(obj_BE_CamposInformacion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_CamposInformacion.CodigoCampoInformacion = CInt(BoolGrabar)
            usp_valor = obj_BL_CamposInformacion.FUN_UPD_CamposInformacion(obj_BE_CamposInformacion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
...
#Region "Metodos del Gridview"
    ...
    Private Sub ImagenSorting(ByVal nombreBoton As String)
        ...
        Dim _btnSorting_d2 As ImageButton = CType(GridView1.HeaderRow.FindControl("btnSorting_CampoBD"), ImageButton)
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 51)
                Master.SeteoPermisosAcciones(btnActualizar, 51)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 51)
            End If
