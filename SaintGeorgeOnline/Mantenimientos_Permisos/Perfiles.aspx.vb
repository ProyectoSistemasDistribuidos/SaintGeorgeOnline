...
''' Código de la Opción:  
''' </remarks>
Partial Class Modulo_Permisos_Perfiles
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Perfiles")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(3, 53)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 53)
        Master.SeteoPermisosAcciones(btnExportar, 53)
        Master.SeteoPermisosAcciones(btnGrabar, 53)
        Master.SeteoPermisosAcciones(btnNuevo, 53)
    ...
    ''' </summary>
    ''' <returns>indicador sobre la validación del nombre de perfil</returns>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Perfil.FUN_LIS_Perfil(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 3, 53)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de perfil</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Perfil.FUN_GET_Perfil(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 3, 53)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de perfil</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Perfil.FUN_DEL_Perfil(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 3, 53)
        End If
    ...
    ''' </remarks>
    Private Sub Grabar()
        Dim obj_BE_Perfil As New be_Perfiles
        Dim obj_BL_Perfil As New bl_Perfiles
        ...
        obj_BE_Perfil.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Perfil.FUN_INS_Perfil(obj_BE_Perfil, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 3, 53)
        Else
            obj_BE_Perfil.CodigoPerfil = CInt(BoolGrabar)
            usp_valor = obj_BL_Perfil.FUN_UPD_Perfil(obj_BE_Perfil, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 3, 53)
        End If
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Perfiles")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Perfiles")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Perfiles")
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 53)
                Master.SeteoPermisosAcciones(btnActualizar, 53)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 53)
            End If
