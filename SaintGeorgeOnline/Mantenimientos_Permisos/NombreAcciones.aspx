<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="NombreAcciones.aspx.vb" Inherits="Modulo_Permisos_NombreAcciones" title="Página sin título" %>
                    ...
                    <div id="miGridviewMant">
                        <asp:GridView ID="GridView1" runat="server" 
                            ...
                            <Columns>                            
                                ...
                                <asp:TemplateField HeaderText="Codigo de Programación">  
                                    <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:150px;" align="right" valign="middle">Codigo de Programación&nbsp;</td>
                                            <td style="width:155px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_CodigoProgramacion" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="CodigoProgramacion"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_CodigoProgramacion_grilla" runat="server" Text='<%# Bind("CodigoProgramacion") %>' />
                                    </ItemTemplate>
                        ...
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" 
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 410px; " align="left" class="style3">
                                ...
                                <tr>
                                    <td align="left" class="style1">
                                        Codigo de Programación<span class="camposObligatorios">(*)</span></td>
                                    <td align="left" class="style5" style="min-width: 410px; ">
                                        <asp:TextBox ID="tbCodigoProgramacion" runat="server" Height="18px" style="margin-top: 0px" 
