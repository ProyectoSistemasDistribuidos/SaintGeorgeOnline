<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="CamposInformacion.aspx.vb" Inherits="Mantenimientos_Permisos_CamposInformacion" title="Página sin título" %>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 410px; height: 25px; padding-left:10px" align="left" valign="bottom">
                                        ...
                                        <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters"
                                            ...
                                            ValidChars="' ','_','.','á','é','í','ó','ú','(',')','?','¿','/','-'" Enabled="True">
                            ...
                            <Columns>                            
                                ...
                                <asp:TemplateField HeaderText="Descripción">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:190px;" align="right" valign="middle">Descripción&nbsp;</td>
                                            <td style="width:150px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_Descripcion" runat="server" 
                                                ToolTip="Descendente"    
                                    ...
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="340px" />
                                </asp:TemplateField>
                                
                                   <asp:TemplateField HeaderText="Campo BD">  
                                    <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:120px;" align="right" valign="middle">Campo BD</td>
                                            <td style="width:80px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_CampoBD" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="CampoBD"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("CampoBD") %>' />
                                    </ItemTemplate>
                                ...
                                <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        ...
                                        <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbDescripcion" ValidChars="' ','_','.','á','é','í','ó','ú','(',')','?','¿','/','-'">
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                 ...
                                 <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        <span>Campo BD&nbsp;</span><span class="camposObligatorios">(*)</span>
                                       <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbCampoBD" ValidChars="' ','_','.','á','é','í','ó','ú','(',')'">
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbCampoBD" runat="server" CssClass="miTextBox" Width="450px"
                                            Height="35px" Rows="2" TextMode="MultiLine" />
                                    </td>
                                </tr>
                                 <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        <span>Campo Alias&nbsp;</span><span class="camposObligatorios">(*)</span>
                                       <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbCampoAlias" ValidChars="' ','_','.','á','é','í','ó','ú','(',')'">
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbCampoAlias" runat="server" CssClass="miTextBox" Width="450px"
                                            Height="35px" Rows="2" TextMode="MultiLine" />
                                    </td>
                                </tr>
                                 <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        <span>Tabla referencia&nbsp;</span><span class="camposObligatorios">(*)</span>
                                       <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbTablaRef" ValidChars="' ','_','.','á','é','í','ó','ú','(',')'">
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbTablaRef" runat="server" CssClass="miTextBox" Width="450px"
                                            Height="35px" Rows="2" TextMode="MultiLine" />
                                    </td>
                                </tr>
                                 <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        <span>Tipo de Dato&nbsp;</span><span class="camposObligatorios">(*)</span>
                                       <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbTipoDato" ValidChars="' ','_','.','á','é','í','ó','ú','(',')'">
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbTipoDato" runat="server" CssClass="miTextBox" Width="450px"
                                            Height="35px" Rows="2" TextMode="MultiLine" />
                                    </td>
                                </tr>
                                 <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        <span>Identificador&nbsp;</span><span class="camposObligatorios">(*)</span>
                                       <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbIdentificador" ValidChars="' ','_','.','á','é','í','ó','ú','(',')'">
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbIdentificador" runat="server" CssClass="miTextBox" Width="450px"
                                            Height="35px" Rows="2" TextMode="MultiLine" />
                                    </td>
                                </tr>
                            </table>
