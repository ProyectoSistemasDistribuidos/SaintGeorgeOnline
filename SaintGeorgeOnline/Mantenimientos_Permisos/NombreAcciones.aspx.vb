...
''' <remarks>
''' Código del Modulo:    3
''' Código de la Opción:  54
''' </remarks>
Partial Class Modulo_Permisos_NombreAcciones
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Nombre de Acciones de Acceso")
...
#Region "Metodos"
    ...
    Private Function validar(ByRef str_Mensaje As String) As Boolean
        ...
        If Validacion.ValidarCamposIngreso(tbCodigoProgramacion) = False Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 1, "Código de Programación")
            result = False
        End If
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(3, 54, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(3, 54)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 54)
        Master.SeteoPermisosAcciones(btnExportar, 54)
        Master.SeteoPermisosAcciones(btnGrabar, 54)
        Master.SeteoPermisosAcciones(btnNuevo, 54)
    ...
    ''' <summary>
    ''' Lista la relación de nombres de acciónes.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_NombresAcciones.FUN_LIS_NombresAcciones(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 3, 54)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de nombre de accción</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_NombresAcciones.FUN_GET_NombresAcciones(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 3, 54)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de nombre de acción</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_NombresAcciones.FUN_DEL_NombresAcciones(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 3, 54)
        End If
    ...
    ''' </remarks>
    Private Sub Grabar()
        Dim obj_BE_NombresAcciones As New be_NombresAcciones
        Dim obj_BL_NombresAcciones As New bl_NombresAcciones
        ...
        obj_BE_NombresAcciones.Descripcion = tbDescripcion.Text.Trim
        obj_BE_NombresAcciones.CodigoProgramacion = tbCodigoProgramacion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_NombresAcciones.FUN_INS_NombresAcciones(obj_BE_NombresAcciones, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 3, 54)
        Else
            obj_BE_NombresAcciones.CodigoNombreAccion = CInt(BoolGrabar)
            usp_valor = obj_BL_NombresAcciones.FUN_UPD_NombresAcciones(obj_BE_NombresAcciones, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 3, 54)
        End If
    ...
    Private Sub Exportar()
        ...
        dt = Datos.agregarColumna(dt, "Codigo Programación", "String")
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            ...
            auxDR.Item("Codigo Programación") = dr.Item("CodigoProgramacion").ToString
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Nombres de Acciones")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Nombres de Acciones")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Nombres de Acciones")
...
#Region "Metodos del Gridview"
    ...
    Private Sub ImagenSorting(ByVal nombreBoton As String)
        ...
        Dim _btnSorting_d2 As ImageButton = CType(GridView1.HeaderRow.FindControl("btnSorting_CodigoProgramacion"), ImageButton)
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 54)
                Master.SeteoPermisosAcciones(btnActualizar, 54)
            ...
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 54)
