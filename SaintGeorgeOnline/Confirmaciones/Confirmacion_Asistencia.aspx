<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Confirmacion_Asistencia.aspx.vb" Inherits="Confirmaciones_Confirmacion_Asistencia" %>
    ...
    <div>
	    ...
	    <tr>
	      ...
	      <td class="tdSuperior" style="background-color: #FFFFFF">
              <img border="0" 
                  src="http://web.stgeorgescollege.edu.pe/Temporales_SanGeorgeOnline/Imagenes/Imagenes_Logos/Escudo_SG.jpg" 
	    ...
	    <tr>
	      <td align="center" class="tdSuperior">
	        <table border="0" cellpadding="8" cellspacing="0" width="100%">
	          <tr>
	            <td width="100%" align="center" class="TituloPro">Entrevista</td>
	          </tr>
	        </table>
	      </td>
	    </tr>
	    <tr>
	      <td align="center" class="tdBorde">
	          <table border="0" cellpadding="12" cellspacing="0" width="98%" class="TextoGeneral">
	            <tr>
	              <td width="100%">
	                <p align="center" class="TituloForm">Confirmación de asistencia</p>
	                <p align="justify">Estimado Padre de Familia, su entrevista ha sido confirmada exitosamente.</p>
	              </td>
	            </tr>
	          </table>
	      </td>
