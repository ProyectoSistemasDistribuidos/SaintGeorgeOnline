<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="Colegios.aspx.vb" Inherits="Mantenimientos_Colegio_Colegios" title="Página sin título" %>
                    ...
                    <div id="miBusquedaMant"><!-- 650px -->
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red;
                                min-width: 610px;">
                                <tr>
                                    <td rowspan="2" style="width: 100px; height: 25px;" align="left" valign="middle">
                                        <span>Descripción</span>
                                    </td>
                                    <td rowspan="2" style="width: 410px; height: 25px; padding-left:10px" align="left" valign="middle">
                        ...
                        <asp:GridView ID="GridView1" runat="server" 
                            ...
                            <Columns>                            
                                ...
                                <asp:BoundField DataField="PaginaWeb" HeaderText="Página Web" >
                                    ...
                                    <ItemStyle  CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Center" Width="300px" />
                                </asp:BoundField>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">                                
                                ...
                                <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        ...
                                        <atk:FilteredTextBoxExtender ID="ftbDescripcion" runat="server" FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters"
                                ...
                                <tr>
                                    <td style="width: 150px; height: 25px;" align="left" valign="middle">
                                        ...
                                        <atk:FilteredTextBoxExtender ID="ftbPaginaWeb" runat="server" FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters"
                                            TargetControlID="tbPaginaWeb" 
                                             Enabled="True">
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbPaginaWeb" runat="server" CssClass="miTextBox" Width="450px" MaxLength="100"/>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
