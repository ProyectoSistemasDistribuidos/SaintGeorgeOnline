<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="NombresGradosMinisterio.aspx.vb" Inherits="Mantenimientos_Matricula_NombresGradosMinisterio" title="Página sin título" %>
    ...
    <atk:TabContainer ID="TabContainer1" runat="server" Width="670px" ActiveTabIndex="0"
        ...
        <atk:TabPanel ID="miTab1" runat="server" HeaderText="Tab1" Enabled="true">
            ...
            <ContentTemplate> 
                <div style="border: solid 0px blue; width: 650px;">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red;
                                ...
                                <tr>
                                    ...
                                    <td style="width: 410px; height: 25px; padding-left:10px" align="left" valign="middle">
                                        ...
                                        <atk:FilteredTextBoxExtender ID="ftbBuscarDescripcion" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                    ...
                    <div id="GVLegenda">
                        ...
                        <atk:ModalPopupExtender ID="pnModalNombreGradoMinisterio" runat="server"
                            TargetControlID="VerNombreGradoMinisterio"
                            PopupControlID="pnlNombreGradoMinisterio"
                            BackgroundCssClass="MiModalBackground" 
                            DropShadow="true" 
                            OkControlID="OKNombreGradoMinisterio" 
                            CancelControlID="CancelNombreGradoMinisterio"
                            Drag="true" PopupDragHandleControlID="NombreGradoMinisterioHeader" />  

                        <asp:Panel id="pnlNombreGradoMinisterio" BackColor="White" BorderColor="Black" BorderWidth="1px" runat="server" style="width: 400px; display: none;">
            ...
            <tr>
                ...
                <td style="width: 340px; height: 26px; cursor: pointer;" align="left" valign="middle" class="miGVBusquedaFicha_Header_V2" colspan="2" id="NombreGradoMinisterioHeader">                
                ...
                <td style="width: 30px; height: 26px" align="right" valign="middle" class="miGVBusquedaFicha_Header_V2">
                    <asp:ImageButton ID="btnCerrarPanelNombreGradoMinisterio" runat="server" Width="16" Height="15"
                        ImageUrl="~/App_Themes/Imagenes/cross_icon_normal.png"
                        onclick="btnCerrarPanelNombreGradoMinisterio_Click" ToolTip="Cerrar Panel"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="width: 90px; height: 25px;" align="left" valign="middle">
                  <span>Descripción :&nbsp;</span><span class="camposObligatorios">(*)</span>
                    ...
                    <atk:FilteredTextBoxExtender ID="ftbDescripcion" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                        TargetControlID="tbDescripcion" >
                    </atk:FilteredTextBoxExtender>
                </td>
                <td style="width: 270px; height: 25px;" align="left" valign="middle">
                   <asp:TextBox ID="tbDescripcion" runat="server" CssClass="miTextBox" Width="200px"  />
                </td>
                <td style="width: 30px; height: 25px;" align="left" valign="middle" rowspan="4">&nbsp;</td>
            </tr>
            ...
            <tr><td style="height: 15px;" colspan="4"></td></tr>  
                            ...
                            <div id="controlNombreGradoMinisterio" style="display:none">
        <input type="button" id="VerNombreGradoMinisterio" runat="server" />
        <input type="button" id="OKNombreGradoMinisterio" />
        <input type="button" id="CancelNombreGradoMinisterio" />
    </div>   
