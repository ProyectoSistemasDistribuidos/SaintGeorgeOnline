...
''' <summary>
''' Modulo de Mantenimiento de Niveles
''' </summary>
''' <remarks>
''' Código del Modulo:    
''' Código de la Opción: 
...
Partial Class Mantenimientos_Matricula_Niveles
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Niveles")
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        str_TituloCabeceraArchivo = "Niveles"
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Niveles.FUN_LIS_Niveles(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Niveles.FUN_GET_Niveles(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Niveles.FUN_DEL_Niveles(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Niveles As New be_Niveles
        Dim obj_BL_Niveles As New bl_Niveles
        ...
        obj_BE_Niveles.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Niveles.FUN_INS_Niveles(obj_BE_Niveles, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_Niveles.CodigoNivel = CInt(BoolGrabar)
            usp_valor = obj_BL_Niveles.FUN_UPD_Niveles(obj_BE_Niveles, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
