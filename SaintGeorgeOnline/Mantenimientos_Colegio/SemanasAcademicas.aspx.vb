...
Imports System.IO
''' <summary>
''' Modulo de Mantenimiento de SemanasAcademicas
''' </summary>
''' <remarks>
''' Código del Modulo:    
''' Código de la Opción: 
''' </remarks>
Partial Class Mantenimientos_Colegio_SemanasAcademicas
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Semanas Académicas")
            ...
            Controles.CaracteresEspeciales.agregarGrupo(ftbDescripcionIngles, 1)
...
#Region "Metodos"
    ...
    Private Sub limpiarFiltros()
        ...
        tbBuscarDescripcion.Focus()
        tbBuscarAbreviatura.Text = ""
        tbBuscarDescripcionIngles.Text = ""
    End Sub
    ...
    Private Sub Exportar()
        ...
        str_TituloCabeceraArchivo = "Semanas Academicas"
        ...
        dt = Datos.agregarColumna(dt, "DescripcionIngles", "String")
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            ...
            auxDR.Item("DescripcionIngles") = dr.Item("DescripcionIngles").ToString
    ...
    ''' Fecha de modificación: _____________ 
    ''' </remarks>
    Private Sub limpiarCamposBuscar()
    ...
    ''' <summary>
    ''' Lista los datos de Semanas Academicas    
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Edgar Chang
    ''' Fecha de Creación:     27/07/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        Dim str_Abreviatura As String = tbBuscarAbreviatura.Text.Trim()
        Dim str_DescripcionIngles As String = tbBuscarDescripcionIngles.Text.Trim()
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_SemanasAcademicas.FUN_LIS_SemanasAcademicas(str_Descripcion, str_Abreviatura, str_DescripcionIngles, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Semanas Academicas</param>
    ''' <remarks>
    ''' Creador:               Edgar Chang 
    ''' Fecha de Creación:     27/07/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_Bl_SemanasAcademicas.FUN_GET_SemasAcademicas(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        ...
        tbDescripcionIngles.Text = ds_Lista.Tables(0).Rows(0).Item("DescripcionIngles").ToString
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_SemanasAcademicas.FUN_DEL_SemanasAcademicas(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
        If usp_valor > 0 Then
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_SemanasAcademicas As New be_SemanasAcademicas
        Dim obj_BL_SemanasAcademicas As New bl_SemanasAcademicas
        ...
        obj_BE_SemanasAcademicas.Descripcion = tbDescripcion.Text.Trim
        obj_BE_SemanasAcademicas.Abreviatura = tbAbreviatura.Text.Trim
        obj_BE_SemanasAcademicas.DescripcionIngles = tbDescripcionIngles.Text.Trim
        If BoolGrabar = 0 Then
            usp_valor = obj_BL_SemanasAcademicas.FUN_INS_SemanasAcademicas(obj_BE_SemanasAcademicas, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_SemanasAcademicas.CodigoSemanaAcademica = CInt(BoolGrabar)
            usp_valor = obj_BL_SemanasAcademicas.FUN_UPD_SemanasAcademicas(obj_BE_SemanasAcademicas, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
