<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="GradosMinisterio.aspx.vb" Inherits="Mantenimientos_Colegio_GradosMinisterio" title="Página sin título" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red;
                                ...
                                <tr>
                                    <td style="width: 100px; height: 25px;" align="left" valign="bottom">
                                        <span>Nivel Ministerio</span>
                                    </td>
                                    <td style="width: 410px; height: 25px;" align="left" valign="bottom">                                                                               
                                        <asp:DropDownList  ID="ddlBuscarNivelMinisterio" runat="server" Width="255px">
                                        </asp:DropDownList>                                         
                                ...
                                <tr>
                                    <td style="width: 100px; height: 25px;" align="left" valign="middle">
                                        <span>Nombre Grado</span>
                                    </td>
                                    <td style="min-width: 410px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList  ID="ddlBuscarNombreGrado" runat="server" Width="255px">
                                        </asp:DropDownList>                                      
                                    </td>
                                </tr>
                             </table>
                            ...
                            <Columns>                            
                                ...
                                <asp:TemplateField HeaderText="Descripcion">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:160px;" align="right" valign="middle">Nivel Ministerio&nbsp;</td>
                                            <td style="width:140px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="DescNivelMinisterio"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("DescNivelMinisterio") %>' />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="300px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="300px" />
                                </asp:TemplateField>
                                
                                <asp:BoundField DataField="DescNombreGradoMinisterio" HeaderText="Nombre Grado" >
                                    <HeaderStyle HorizontalAlign="Center" Width="240px" />
                                    <ItemStyle  CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Center" Width="240px" />
                                </asp:BoundField>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">                                
                                ...
                                <tr>
                                    <td style="width: 150px; height: 25px;" align="left" valign="middle">
                                        <span>Nivel Ministerio :&nbsp;</span><span class="camposObligatorios">(*)</span>
                                        <asp:HiddenField ID="hd_Codigo" runat="server" />     
                                    </td>
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList  ID="ddlNivelMinisterio" runat="server" Width="255px">
                                        </asp:DropDownList>  
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 150px; height: 25px;" align="left" valign="middle">
                                        <span>Nombre Grado :&nbsp;</span><span class="camposObligatorios">(*)</span>                                                                          
                                    </td>
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList  ID="ddlNombreGrado" runat="server" Width="255px">
                                        </asp:DropDownList>  
                                    </td>
                                </tr>
                            </table>
