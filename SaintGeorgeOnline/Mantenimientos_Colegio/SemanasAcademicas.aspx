<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="SemanasAcademicas.aspx.vb" Inherits="Mantenimientos_Colegio_SemanasAcademicas" title="Página sin título" %>
                        ...
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red;
                              ...
                              <tr>
                                    ...
                                    <td style="width: 410px; height: 25px; padding-left:10px" align="left" valign="middle">
                                        <asp:TextBox ID="tbBuscarAbreviatura" runat="server" CssClass="miTextBox" 
                               ...
                               <tr>
                                    ...
                                    <td style="width: 410px; height: 25px; padding-left:10px" align="left" valign="middle">
                                        <asp:TextBox ID="tbBuscarDescripcionIngles" runat="server" CssClass="miTextBox" 
                                            Width="400px" MaxLength="100" />
                                        <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" 
                                            FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters"
                                            TargetControlID="tbBuscarDescripcionIngles" Enabled="True">
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                            ...
                            <Columns>                            
                                ...
                                <asp:TemplateField HeaderText="Descripción">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:310px;" align="right" valign="middle">Descripción&nbsp;</td>
                                            <td style="width:260px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting" runat="server" 
                                                ToolTip="Descendente"    
                                ...
                                <asp:TemplateField HeaderText="Abreviatura">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:310px;" align="right" valign="middle">Abreviatura&nbsp;</td>
                                            <td style="width:260px;" align="left" valign="middle"></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Descripción Ingles">
                                <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:310px;" align="right" valign="middle">DescripcionIngles&nbsp;</td>
                                            <td style="width:260px;" align="left" valign="middle"></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate> 
                                    <ItemTemplate>
                                        <asp:Label ID="lblDescripcionIngles" runat="server" 
                                            Text='<%# Bind("DescripcionIngles") %>'></asp:Label>
                                    </ItemTemplate>
                                     <HeaderStyle HorizontalAlign="Center" Width="570px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="570px" />
                                </asp:TemplateField>
                             ...
                             <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">                                
                                  <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        ...
                                        <atk:FilteredTextBoxExtender ID="ftbAbreviatura" runat="server" 
                                            FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">                                
                                  <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        <span>Descripción Ingles :&nbsp;</span>
                                        <%--<asp:HiddenField ID="HiddenField1" runat="server" />--%>
                                        <atk:FilteredTextBoxExtender ID="ftbDescripcionIngles" runat="server" 
                                            FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbDescripcionIngles">
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbDescripcionIngles" runat="server" CssClass="miTextBox" Width="450px"
                                            Height="35px" Rows="2" TextMode="MultiLine" />
                                    </td>
                                </tr>
