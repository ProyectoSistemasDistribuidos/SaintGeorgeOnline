...
''' <summary>
''' Modulo de Mantenimiento de AulasMinisterio
''' </summary>
''' <remarks>
''' Código del Modulo:    
''' Código de la Opción: 
...
Partial Class Mantenimientos_Matricula_AulasMinisterio
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Aulas de Ministerio")
    ...
    Protected Sub btnCerrarPanelAulasMinisterio_Click()
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        str_TituloCabeceraArchivo = "Aulas de Ministerio"
    ...
    ''' <summary>
    ''' Lista los datos de aulas ministerio     
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_AulasMinisterio.FUN_LIS_AulasMinisterio(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_AulasMinisterio.FUN_GET_AulasMinisterio(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_AulasMinisterio.FUN_DEL_AulasMinisterio(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_AulasMinisterio As New be_AulasMinisterio
        Dim obj_BL_AulasMinisterio As New bl_AulasMinisterio
        ...
        obj_BE_AulasMinisterio.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_AulasMinisterio.FUN_INS_AulasMinisterio(obj_BE_AulasMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_AulasMinisterio.CodigoAulaMinisterio = CInt(BoolGrabar)
            usp_valor = obj_BL_AulasMinisterio.FUN_UPD_AulasMinisterio(obj_BE_AulasMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
