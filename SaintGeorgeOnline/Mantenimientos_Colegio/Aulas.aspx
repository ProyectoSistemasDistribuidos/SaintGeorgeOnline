<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="Aulas.aspx.vb" Inherits="Mantenimientos_Colegio_Aulas" title="Página sin título" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red;
                                ...
                                <tr>
                                    ...
                                    <td style="width: 410px; height: 25px; padding-left:10px" align="left" valign="middle">
                                       ...
                                       <%-- <atk:FilteredTextBoxExtender ID="ftbBuscarDescripcion" runat="server" FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters"
                        ...
                        <asp:GridView ID="GridView1" runat="server" 
                            ...
                            <Columns>                            
                                ...
                                <asp:TemplateField HeaderText="Descripcion">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            ...
                                            <td style="width:100px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_Descripcion" runat="server" 
                                                ToolTip="Descendente"    
                                ...
                                <asp:TemplateField HeaderText="Grado">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:140px;" align="right" valign="middle">Grado&nbsp;</td>
                                            <td style="width:100px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescGrado" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="DescGrado"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                  ...
                                  <asp:TemplateField HeaderText="Aula Ministerio">  
                                    <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:140px;" align="right" valign="middle">Aula Ministerio&nbsp;</td>
                                            <td style="width:100px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescAulaMinisterio" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="DescAulaMinisterio"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="lblDescAulaMinisterio" runat="server" Text='<%# Bind("DescAulaMinisterio") %>' />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="240px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="240px" />
                                </asp:TemplateField>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">                                
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList  ID="ddlGrado" runat="server" Width="255px">
                                        </asp:DropDownList>  
                                    </td>
                                </tr>
                                <tr>
