...
''' <summary>
''' Modulo de Mantenimiento de Subniveles
''' </summary>
''' <remarks>
''' Código del Modulo:    
''' Código de la Opción:  
...
Partial Class Mantenimientos_Colegio_Subniveles
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Subniveles")
            ...
            If Not Page.IsPostBack Then
                ...
                ViewState("SortExpression") = "DescSubnivel"
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            auxDR = dt.NewRow
            auxDR.Item("N°") = cont
            auxDR.Item("Descripcion") = dr.Item("DescSubnivel").ToString
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Subniveles")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Subniveles")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Niveles")
    ...
    Private Function validar(ByRef str_Mensaje As String) As Boolean
        ...
        If ddlNiveles.SelectedValue = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 3, "Nivel")
            result = False
        End If
    ...
    Private Sub cargarComboNiveles()
        ...
        Dim obj_BL_Nivel As New bl_Niveles
        Dim int_CodigoTipoUsuario As Integer = Me.Master.Obtener_CodigoTipoUsuarioLogueado
        Dim int_CodigoUsuario As Integer = Me.Master.Obtener_CodigoUsuarioLogueado
        Dim ds_Lista As DataSet = obj_BL_Nivel.FUN_LIS_Niveles("", -1, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Controles.llenarCombo(ddlNiveles, ds_Lista, "Codigo", "Descripcion", False, True)
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_Colegio As New bl_Subniveles
            ds_Lista = obj_BL_Colegio.FUN_LIS_Subniveles(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de subnivel</param>
    ''' <remarks>
    ''' Creador:               Juan Vento 
    ''' Fecha de Creación:     14/02/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Colegio.FUN_GET_Subniveles(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        ...
        ddlNiveles.SelectedValue = ds_Lista.Tables(0).Rows(0).Item("CodigoNivel").ToString
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Subniveles</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Colegio.FUN_DEL_Subniveles(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Subniveles As New be_Subniveles
        Dim obj_BL_obj_BE_Subnivel As New bl_Subniveles
        ...
        obj_BE_Subniveles.CodigoNivel = ddlNiveles.SelectedValue
        obj_BE_Subniveles.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_obj_BE_Subnivel.FUN_INS_Subniveles(obj_BE_Subniveles, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_Subniveles.CodigoSubnivel = CInt(BoolGrabar)
            usp_valor = obj_BL_obj_BE_Subnivel.FUN_UPD_Subniveles(obj_BE_Subniveles, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
