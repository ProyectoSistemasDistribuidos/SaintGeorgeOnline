<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="NivelesMinisterio.aspx.vb" Inherits="Mantenimientos_Matricula_NivelesMinisterio" title="Página sin título" %>
                        ...
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">                                
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        <span>Codigo Modular :&nbsp;</span><span class="camposObligatorios">(*)</span>
                                        <atk:FilteredTextBoxExtender ID="ftbCodigoModular" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbCodigoModular" >
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbCodigoModular" runat="server" CssClass="miTextBox" Width="450px"
                                            Height="35px" Rows="2" TextMode="MultiLine" MaxLength="8" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        <span>Abreviatura :&nbsp;</span><span class="camposObligatorios">(*)</span>
                                       <atk:FilteredTextBoxExtender ID="ftbAbreviatura" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbAbreviatura" >
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbAbreviatura" runat="server" CssClass="miTextBox" Width="450px"
                                            Height="35px" Rows="2" TextMode="MultiLine" MaxLength="8" />
                                    </td>
                                </tr>
                                 <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        <span>Caracteristica :&nbsp;</span><span class="camposObligatorios">(*)</span>
                                        <atk:FilteredTextBoxExtender ID="ftbCaracteristica" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbCaracteristica" >
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbCaracteristica" runat="server" CssClass="miTextBox" Width="450px"
                                            Height="35px" Rows="2" TextMode="MultiLine" MaxLength="8" />
                                    </td>
                                </tr>
