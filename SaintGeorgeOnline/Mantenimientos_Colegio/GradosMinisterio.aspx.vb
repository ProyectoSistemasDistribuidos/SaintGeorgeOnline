...
''' <summary>
''' Modulo de Mantenimiento de GradosMinisterio
''' </summary>
''' <remarks>
''' Código del Modulo:    
''' Código de la Opción:  
''' </remarks>
''' 
Partial Class Mantenimientos_Colegio_GradosMinisterio
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Grados Ministerio")

            If Not Page.IsPostBack Then

                SetearAccionesAcceso()
                ViewState("SortExpression") = "DescNivelMinisterio"
                ...
                cargarComboNivelesMinisterio()
                cargarComboNombresGrado()
                listar()
            End If
    ...
    Protected Sub btnCancelar_Click()
        ...
        ddlNivelMinisterio.Focus()
        ddlNivelMinisterio.SelectedValue = 0
        ddlNombreGrado.SelectedValue = 0
        hd_Codigo.Value = 0
...
#Region "Metodos"
    ...
    Private Sub limpiarFiltros()
        ...
        ddlBuscarNivelMinisterio.SelectedValue = 0
        ddlBuscarNombreGrado.SelectedValue = 0
        ddlBuscarNivelMinisterio.Focus()
    ...
    Private Sub Exportar()
        ...
        dt = Datos.agregarColumna(dt, "Nivel de Ministerio", "String")
        dt = Datos.agregarColumna(dt, "Nombre de Grado Ministerio", "String")
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            auxDR = dt.NewRow
            auxDR.Item("N°") = cont
            auxDR.Item("Nivel de Ministerio") = dr.Item("DescNivelMinisterio").ToString
            auxDR.Item("Nombre de Grado Ministerio") = dr.Item("DescNombreGradoMinisterio").ToString
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Grados Ministerio")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Grados Ministerio")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Grados Ministerio")
    ...
    Private Function validar(ByRef str_Mensaje As String) As Boolean
        ...
        If ddlNivelMinisterio.SelectedValue = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 3, "Nivel Ministerio")
            result = False
        End If

        If ddlNombreGrado.SelectedValue = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 3, "Nombre Grado Ministerio")
            result = False
        End If
    ...
    ''' <summary>
    ''' Carga el combo Niveles Ministerio
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Juan Vento
    ''' Fecha de Creación:     14/02/2011
    ...
    ''' Fecha de modificación: _____________ 
    ''' </remarks>
    Private Sub cargarComboNivelesMinisterio()
        ...
        Controles.llenarCombo(ddlBuscarNivelMinisterio, ds_Lista, "Codigo", "Descripcion", True, False)
        Controles.llenarCombo(ddlNivelMinisterio, ds_Lista, "Codigo", "Descripcion", False, True)

    End Sub

    ''' <summary>
    ''' Carga el combo Nombres Grado Ministerio
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Juan Vento
    ''' Fecha de Creación:     14/02/2011
    ...
    ''' Fecha de modificación: _____________ 
    ''' </remarks>
    Private Sub cargarComboNombresGrado()

        Dim obj_BL_NombresGradosMinisterio As New bl_NombresGradosMinisterio
        Dim int_CodigoTipoUsuario As Integer = Me.Master.Obtener_CodigoTipoUsuarioLogueado
        Dim int_CodigoUsuario As Integer = Me.Master.Obtener_CodigoUsuarioLogueado
        Dim ds_Lista As DataSet = obj_BL_NombresGradosMinisterio.FUN_LIS_NombresGradosMinisterio("", -1, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Controles.llenarCombo(ddlBuscarNombreGrado, ds_Lista, "Codigo", "Descripcion", True, False)
        Controles.llenarCombo(ddlNombreGrado, ds_Lista, "Codigo", "Descripcion", False, True)
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        Dim int_NivelMinisterio As Integer = CInt(ddlBuscarNivelMinisterio.SelectedValue)
        Dim int_NombreGradoMinisterio As Integer = CInt(ddlBuscarNombreGrado.SelectedValue)
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_GradosMinisterio.FUN_LIS_GradosMinisterio(int_NivelMinisterio, int_NombreGradoMinisterio, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_GradosMinisterio.FUN_GET_GradosMinisterio(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)

        hd_Codigo.Value = CInt(ds_Lista.Tables(0).Rows(0).Item("Codigo").ToString)
        ddlNivelMinisterio.SelectedValue = ds_Lista.Tables(0).Rows(0).Item("CodigoNivelMinisterio").ToString
        ddlNombreGrado.SelectedValue = ds_Lista.Tables(0).Rows(0).Item("CodigoNombreGradoMinisterio").ToString
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de GradosMinisterio</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_GradosMinisterio.FUN_DEL_GradosMinisterio(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
       End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_GradosMinisterio As New be_GradosMinisterio
        Dim obj_BL_obj_BE_Subnivel As New bl_GradosMinisterio
        ...
        obj_BE_GradosMinisterio.CodigoNivelMinisterio = ddlNivelMinisterio.SelectedValue
        obj_BE_GradosMinisterio.CodigoNombreGradoMinisterio = ddlNombreGrado.SelectedValue

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_obj_BE_Subnivel.FUN_INS_GradosMinisterio(obj_BE_GradosMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_GradosMinisterio.CodigoGradoMinisterio = CInt(BoolGrabar)
            usp_valor = obj_BL_obj_BE_Subnivel.FUN_UPD_GradosMinisterio(obj_BE_GradosMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
