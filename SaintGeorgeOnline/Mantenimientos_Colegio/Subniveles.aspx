<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="Subniveles.aspx.vb" Inherits="Mantenimientos_Colegio_Subniveles" title="Página sin título" %>
                            ...
                            <Columns>                            
                                ...
                                <asp:TemplateField HeaderText="Descripcion">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:160px;" align="right" valign="middle">Descripcion&nbsp;</td>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("DescSubnivel") %>' />
                                    </ItemTemplate>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">                                
                                ...
                                <tr>
                                    <td style="width: 150px; height: 25px;" align="left" valign="middle">
                                        <span>Nivel :&nbsp;</span><span class="camposObligatorios">(*)</span>
                                    </td>
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList  ID="ddlNiveles" runat="server" Width="255px">
                                        </asp:DropDownList>  
                                    </td>
                                </tr>
                                <tr>
