<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="Grados.aspx.vb" Inherits="Mantenimientos_Colegio_Grados" title="Página sin título" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red;
                                ...
                                <tr>
                                    <td style="width: 150px; height: 25px;" align="left" valign="middle">
                                        <span>Descripción en Ingles</span>
                                    </td>
                                    <td style="width: 360px; height: 25px; padding-left:10px" align="left" valign="middle">
                    ...
                    <div id="misRegistrosEncontrados">
                        <fieldset>
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; width: 610px;">
                                <tr>
                                    <td style="width: 150px; height: 21px;" align="left" valign="middle">
                                    ...
                                    <td style="width: 360px; height: 21px;" align="left" valign="bottom">                                  
                            ...
                            <Columns>                            
                                ...
                                <asp:TemplateField HeaderText="Descripcion">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="90px">
                                        <tr>
                                            <td style="width:70px;" align="right" valign="middle">Descripción&nbsp;</td>
                                            <td style="width:20px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_Codigo" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="Codigo"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                    ...
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="90px" />
                                </asp:TemplateField>
                                
                                <asp:TemplateField HeaderText="Descripcion en Español">  
                                    <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="90px">
                                        <tr>
                                            <td style="width:70px;" align="right" valign="middle">Descripción en Español&nbsp;</td>
                                            <td style="width:20px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescripcionEspaniol" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="Codigo"/></td>
                                ...
                                <asp:TemplateField HeaderText="Abreviatura">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="80">
                                        <tr>
                                            <td style="width:50px;" align="right" valign="middle">Abreviatura&nbsp;</td>
                                            <td style="width:30px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_Abreviatura" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="Codigo"/></td>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblAbrev" runat="server" Text='<%# Bind("Abrev") %>' />
                                    </ItemTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Nivel">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="80px">
                                        <tr>
                                            <td style="width:60px;" align="right" valign="middle">Nivel&nbsp;</td>
                                            <td style="width:20px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescNivel" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="DescNivel"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="lblDescNivel" runat="server" Text='<%# Bind("DescNivel") %>' />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="80px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="80px" />
                                </asp:TemplateField>
                                
                                <asp:TemplateField HeaderText="SubNivel">  
                                    <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100px">
                                        <tr>
                                            <td style="width:80px;" align="right" valign="middle">Sub Nivel&nbsp;</td>
                                            <td style="width:20px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescSubnivel" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="DescSubnivel"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="lblDescSubNivel" runat="server" Text='<%# Bind("DescSubnivel") %>' />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="100px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="100px" />
                                </asp:TemplateField>
                                
                                <asp:TemplateField HeaderText="Grado Ministerio">  
                                    <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100px">
                                        <tr>
                                            <td style="width:80px;" align="left" valign="middle">Grado Ministerio&nbsp;</td>
                                            <td style="width:20px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescGradoMinisterio" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="DescGradoMinisterio"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="lblDescGradoMinisterio" runat="server" Text='<%# Bind("DescGradoMinisterio") %>' />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="100px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="100px" />
                                </asp:TemplateField>
                    ...
                    <div id="miDetalleMant">
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">                                
                                ...
                                <tr>
                                    <td style="width: 150px; height: 25px;" align="left" valign="middle">
                                        <span>Subnivel :&nbsp;</span><span class="camposObligatorios">(*)</span>
                                        <asp:HiddenField ID="HiddenField1" runat="server" />     
                                    </td>
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList  ID="ddlSubnivel" runat="server" Width="255px">
                                        </asp:DropDownList>  
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 150px; height: 25px;" align="left" valign="middle">
                                        <span>Grado Ministerio :&nbsp;</span><span class="camposObligatorios">(*)</span>                                                                          
                                    </td>
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList  ID="ddlGradoMinisterio" runat="server" Width="255px">
                                        </asp:DropDownList>  
                                    </td>
                                </tr>                                
                                ...
                                <tr>
                                    <td style="width: 150px; height: 50px;" align="left" valign="middle">
                                        <span>Descripción en Español :&nbsp;</span><span class="camposObligatorios">(*)</span>                                       
                                        <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters"
                                            TargetControlID="tbDescripcionEspaniol" 
                                            ValidChars="' ','.','á','é','í','ó','ú','(',')'" Enabled="True">
                                        </atk:FilteredTextBoxExtender>
                                    </td>
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">                                        
                                 ...
                                 <tr>
                                    ...
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">                                        
                                        <asp:TextBox ID="tbAbreviatura" runat="server" CssClass="miTextBox" Width="450px" MaxLength ="10"
                                            Height="35px" Rows="2" TextMode="MultiLine" />
                                    </td>
                                </tr>
                            </table>
