...
''' <summary>
''' Modulo de Mantenimiento de NombresGradosMinisterio
''' </summary>
''' <remarks>
''' Código del Modulo:  
''' Código de la Opción: 
...
Partial Class Mantenimientos_Matricula_NombresGradosMinisterio
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Nombres de Grados Ministerio")
    ...
    Protected Sub btnNuevo_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        limpiarCampos()
        pnModalNombreGradoMinisterio.Show()
    ...
    Protected Sub btnCancelar_Click()
        ...
        hd_Codigo.Value = 0
        pnModalNombreGradoMinisterio.Hide()
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Nombres de Grados Ministerio")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Nombres de Grados Ministerio")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Nombres de Grados Ministerio")
    ...
    ''' <summary>
    ''' Lista los datos de Nombre de Grados de ministerio     
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_NombresGradosMinisterio.FUN_LIS_NombresGradosMinisterio(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_NombresGradosMinisterio.FUN_GET_NombresGradosMinisterio(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_NombresGradosMinisterio.FUN_DEL_NombresGradosMinisterio(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Protected Sub btnCerrarPanelNombreGradoMinisterio_Click()
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_NombresGradosMinisterio As New be_NombresGradosMinisterio
        Dim obj_BL_NombresGradosMinisterio As New bl_NombresGradosMinisterio
        ...
        obj_BE_NombresGradosMinisterio.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_NombresGradosMinisterio.FUN_INS_NombresGradosMinisterio(obj_BE_NombresGradosMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_NombresGradosMinisterio.CodigoNombreGradoMinist = CInt(BoolGrabar)
            usp_valor = obj_BL_NombresGradosMinisterio.FUN_UPD_NombresGradosMinisterio(obj_BE_NombresGradosMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
