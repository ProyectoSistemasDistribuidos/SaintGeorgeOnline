...
''' <summary>
''' Modulo de Mantenimiento de NivelesMinisterio
''' </summary>
''' <remarks>
''' Código del Modulo:   
''' Código de la Opción:
''' </remarks>
Partial Class Mantenimientos_Matricula_NivelesMinisterio
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Niveles de Ministerio")
            Controles.CaracteresEspeciales.agregarGrupo(ftbBuscarDescripcion, 1)
            Controles.CaracteresEspeciales.agregarGrupo(ftbDescripcion, 1)
            Controles.CaracteresEspeciales.agregarGrupo(ftbCodigoModular, 1)
            Controles.CaracteresEspeciales.agregarGrupo(ftbAbreviatura, 1)
            Controles.CaracteresEspeciales.agregarGrupo(ftbCaracteristica, 1)
            ...
            If Not Page.IsPostBack Then
                ...
                tbCodigoModular.Attributes.Add("onkeypress", " ValidarLength(this, 10);")
                tbCodigoModular.Attributes.Add("onkeyup", " ValidarLength(this, 10);")
                tbAbreviatura.Attributes.Add("onkeypress", " ValidarLength(this, 10);")
                tbAbreviatura.Attributes.Add("onkeyup", " ValidarLength(this, 10);")
                tbCaracteristica.Attributes.Add("onkeypress", " ValidarLength(this, 10);")
                tbCaracteristica.Attributes.Add("onkeyup", " ValidarLength(this, 10);")
...
#Region "Metodos"
    ...
    ''' <summary>
    ''' Exporta el listado de la información filtrada del gridView en formato WORD,EXCEL,HTML,PDF,HTML..
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas
    ''' Fecha de Creación:     13/01/2011
    ...
    Private Sub Exportar()
        ...
        dt = Datos.agregarColumna(dt, "Codigo Modular", "String")
        dt = Datos.agregarColumna(dt, "Abreviatura", "String")
        dt = Datos.agregarColumna(dt, "Caracteristica Abrev.", "String")
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            ...
            auxDR.Item("Codigo Modular") = dr.Item("CodigoModular").ToString
            auxDR.Item("Abreviatura") = dr.Item("Abreviatura").ToString
            auxDR.Item("Caracteristica Abrev.") = dr.Item("CaracteristicaAbrev").ToString
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Niveles de Ministerio")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Niveles de Ministerio")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Niveles de Ministerio")
    ...
    Private Function validar(ByRef str_Mensaje As String) As Boolean
        ...
        If tbCodigoModular.Text.Trim.Length = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 1, "Código Modular")
            result = False
        End If
        If Validacion.ValidarCamposIngreso(tbCodigoModular) = False Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 2, "Código Modular")
            result = False
        End If

        If tbAbreviatura.Text.Trim.Length = 0 Then
        ...
        If tbCaracteristica.Text.Trim.Length = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 1, "Característica")
            result = False
        End If
        If Validacion.ValidarCamposIngreso(tbCaracteristica) = False Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 2, "Característica")
            result = False
        End If
    ...
    ''' <summary>
    ''' Lista los datos de Niveles Ministerio     
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_NivelesMinisterio.FUN_LIS_NivelesMinisterio(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_NivelesMinisterio.FUN_GET_NivelesMinisterio(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        ...
        tbCodigoModular.Text = ds_Lista.Tables(0).Rows(0).Item("CodigoModular").ToString
        tbAbreviatura.Text = ds_Lista.Tables(0).Rows(0).Item("Abreviatura").ToString
        tbCaracteristica.Text = ds_Lista.Tables(0).Rows(0).Item("CaracteristicaAbrev").ToString
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_NivelesMinisterio.FUN_DEL_NivelesMinisterio(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_NivelesMinisterio As New be_NivelesMinisterio
        Dim obj_BL_NivelesMinisterio As New bl_NivelesMinisterio
        ...
        obj_BE_NivelesMinisterio.Descripcion = tbDescripcion.Text.Trim
        obj_BE_NivelesMinisterio.CodigoModular = tbCodigoModular.Text.Trim
        obj_BE_NivelesMinisterio.Abreviatura = tbAbreviatura.Text.Trim
        obj_BE_NivelesMinisterio.CaracteristicaAbrev = tbCaracteristica.Text.Trim
      
        If BoolGrabar = 0 Then
            usp_valor = obj_BL_NivelesMinisterio.FUN_INS_NivelesMinisterio(obj_BE_NivelesMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_NivelesMinisterio.CodigoNivelesMinisterio = CInt(BoolGrabar)
            usp_valor = obj_BL_NivelesMinisterio.FUN_UPD_NivelesMinisterio(obj_BE_NivelesMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
