...
''' <summary>
''' Modulo de Mantenimiento de Aulas
''' </summary>
''' <remarks>
''' Código del Modulo:    
''' Código de la Opción:  
...
Partial Class Mantenimientos_Colegio_Aulas
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        dt = Datos.agregarColumna(dt, "DescripcionGrado", "String")
        dt = Datos.agregarColumna(dt, "DescripcionAulaMinisterio", "String")
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            ...
            auxDR.Item("DescripcionGrado") = dr.Item("DescGrado").ToString
            auxDR.Item("DescripcionAulaMinisterio") = dr.Item("DescAulaMinisterio").ToString
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Aulas")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Aulas")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Aulas")
    ...
    Private Function validar(ByRef str_Mensaje As String) As Boolean
        ...
        If ddlAulaMinisterio.SelectedValue = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 3, "Aula Ministerio")
            result = False
        End If
    ...
    Private Sub cargarComboGrados()
        ...
        Controles.llenarCombo(ddlGrado, ds_Lista, "Codigo", "Descripcion", False, True)

    End Sub

    ''' <summary>
    ''' Carga el combo Aula Ministerio
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Juan Vento
    ''' Fecha de Creación:     14/02/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Aulas.FUN_LIS_Aulas(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Aulas.FUN_GET_Aulas(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)

        hd_Codigo.Value = CInt(ds_Lista.Tables(0).Rows(0).Item("Codigo").ToString)
        ddlGrado.SelectedValue = ds_Lista.Tables(0).Rows(0).Item("CodigoGrado").ToString
        ddlAulaMinisterio.SelectedValue = ds_Lista.Tables(0).Rows(0).Item("CodigoAulaMinisterio").ToString
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_bl_Aulas.FUN_DEL_Aulas(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
       End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Aulas As New be_Aulas
        Dim obj_BL_Aulas As New bl_Aulas
        ...
        obj_BE_Aulas.CodigoGrado = ddlGrado.SelectedValue
        obj_BE_Aulas.CodigoAulaMinisterio = ddlAulaMinisterio.SelectedValue
        obj_BE_Aulas.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Aulas.FUN_INS_Aulas(obj_BE_Aulas, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_Aulas.CodigoAula = CInt(BoolGrabar)
            usp_valor = obj_BL_Aulas.FUN_UPD_Aulas(obj_BE_Aulas, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
...
#Region "Metodos del Gridview"
    ...
    Private Sub ImagenSorting(ByVal nombreBoton As String)
        ...
        Dim _btnSorting_d2 As ImageButton = CType(GridView1.HeaderRow.FindControl("btnSorting_DescGrado"), ImageButton)
        Dim _btnSorting_d3 As ImageButton = CType(GridView1.HeaderRow.FindControl("btnSorting_DescAulaMinisterio"), ImageButton)
