...
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 36
''' </remarks>
Partial Class Mantenimientos_Matricula_NivelesInstruccion
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Niveles de Instrucción")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 36)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 36)
        Master.SeteoPermisosAcciones(btnExportar, 36)
        Master.SeteoPermisosAcciones(btnGrabar, 36)
        Master.SeteoPermisosAcciones(btnNuevo, 36)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 36, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Niveles de Instrucción")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Niveles de Instrucción")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Niveles de Instrucción")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_NivelesInstruccion.FUN_LIS_NivelesInstruccion(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 36)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Niveles de Instrucción</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     11/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_NivelesInstruccion.FUN_GET_NivelesInstruccion(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 36)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_NivelesInstruccion.FUN_DEL_NivelesInstruccion(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 36)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_NivelInstruccion As New be_NivelesInstruccion
        Dim obj_BL_NivelesInstruccion As New bl_NivelesInstruccion
        ...
        obj_BE_NivelInstruccion.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_NivelesInstruccion.FUN_INS_NivelesInstruccion(obj_BE_NivelInstruccion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 36)
        Else
            obj_BE_NivelInstruccion.CodigoNivelInstruccion = CInt(BoolGrabar)
            usp_valor = obj_BL_NivelesInstruccion.FUN_UPD_NivelesInstruccion(obj_BE_NivelInstruccion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 36)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 36)
                Master.SeteoPermisosAcciones(btnActualizar, 36)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 36)
            End If
