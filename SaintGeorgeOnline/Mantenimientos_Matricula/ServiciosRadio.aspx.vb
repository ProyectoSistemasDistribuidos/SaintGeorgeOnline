...
''' <summary>
''' Modulo de Mantenimiento de Servicios de Radio
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 32
''' </remarks>
Partial Class Mantenimientos_Matricula_ServiciosRadio
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Servicios de Radio")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 32)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 32)
        Master.SeteoPermisosAcciones(btnExportar, 32)
        Master.SeteoPermisosAcciones(btnGrabar, 32)
        Master.SeteoPermisosAcciones(btnNuevo, 32)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 32, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Dim ds_Lista As DataSet = ObtenerResultadoBusqueda(1)
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Servicios de Radio")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Servicios de Radio")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Servicios de Radio")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_ServicioRadio As New bl_ServiciosRadio
            ds_Lista = obj_BL_ServicioRadio.FUN_LIS_ServicioRadio(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 32)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Servicio de radio</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     11/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_ServicioRadio.FUN_GET_ServicioRadio(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 32)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_ServicioRadio.FUN_DEL_ServicioRadio(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 32)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_ServicioRadio As New be_ServiciosRadio
        Dim obj_BL_ServicioRadio As New bl_ServiciosRadio
        ...
        obj_BE_ServicioRadio.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_ServicioRadio.FUN_INS_ServicioRadio(obj_BE_ServicioRadio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 32)
        Else
            obj_BE_ServicioRadio.CodigoServicioRadio = CInt(BoolGrabar)
            usp_valor = obj_BL_ServicioRadio.FUN_UPD_ServicioRadio(obj_BE_ServicioRadio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 32)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 32)
                Master.SeteoPermisosAcciones(btnActualizar, 32)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 32)
            End If
