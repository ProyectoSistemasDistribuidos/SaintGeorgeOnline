...
''' <summary>
''' Modulo de Mantenimiento de Parentescos
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 30
''' </remarks>
Partial Class Mantenimientos_Matricula_Parentescos
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Parentescos")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 30)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 30)
        Master.SeteoPermisosAcciones(btnExportar, 30)
        Master.SeteoPermisosAcciones(btnGrabar, 30)
        Master.SeteoPermisosAcciones(btnNuevo, 30)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 30, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Dim ds_Lista As DataSet = ObtenerResultadoBusqueda(1)
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Parentescos")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Parentescos")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Parentescos")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_Parentesco As New bl_Parentescos
            ds_Lista = obj_BL_Parentesco.FUN_LIS_Parentesco(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 30)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Parentesco</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     11/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Parentesco.FUN_GET_Parentesco(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 30)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Parentesco.FUN_DEL_Parentesco(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 30)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Parentesco As New be_Parentescos
        Dim obj_BL_Parentesco As New bl_Parentescos
        ...
        obj_BE_Parentesco.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Parentesco.FUN_INS_Parentesco(obj_BE_Parentesco, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 30)
        Else
            obj_BE_Parentesco.CodigoParentesco = CInt(BoolGrabar)
            usp_valor = obj_BL_Parentesco.FUN_UPD_Parentesco(obj_BE_Parentesco, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 30)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 30)
                Master.SeteoPermisosAcciones(btnActualizar, 30)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 30)
            End If
