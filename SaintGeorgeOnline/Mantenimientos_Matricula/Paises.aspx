<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="Paises.aspx.vb" Inherits="Mantenimientos_Matricula_Paises" title="Página sin título" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Pais Ministerio">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:100px;" align="right" valign="middle">Pais Ministerio</td>
                                            <td style="width:55px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescripcionPaisMinisterio" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="DescripcionPaisMinisterio"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("DescripcionPaisMinisterio") %>' />
                                    </ItemTemplate>
