...
''' <summary>
''' Modulo de Mantenimiento de Niveles de Instruccion
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 37
''' </remarks>
Partial Class Mantenimientos_Matricula_EscolaridadesMinisterio
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Escolaridades de Ministerio")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 37)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 37)
        Master.SeteoPermisosAcciones(btnExportar, 37)
        Master.SeteoPermisosAcciones(btnGrabar, 37)
        Master.SeteoPermisosAcciones(btnNuevo, 37)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 37, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Escolaridades de Ministerio")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Escolaridades de Ministerio")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Escolaridades de Ministerio")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Religiones.FUN_LIS_Religiones(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 41)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Escolaridad Ministerio</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim obj_BL_EscolaridadMinisterio As New bl_EscolaridadesMinisterio
        Dim int_CodigoUsuario As Integer = Me.Master.Obtener_CodigoUsuarioLogueado
        Dim int_CodigoTipoUsuario As Integer = Me.Master.Obtener_CodigoTipoUsuarioLogueado

        Dim ds_Lista As DataSet = obj_BL_EscolaridadMinisterio.FUN_GET_EscolaridadMinisterio(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 37)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_EscolaridadMinisterio.FUN_DEL_EscolaridadMinisterio(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 37)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_EscolaridadMinisterio As New be_EscolaridadesMinisterio
        Dim obj_BL_EscolaridadMinisterio As New bl_EscolaridadesMinisterio
        ...
        obj_BE_EscolaridadMinisterio.Descripcion = tbDescripcion.Text.Trim
        obj_BE_EscolaridadMinisterio.Abreviatura = tbAbreviatura.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_EscolaridadMinisterio.FUN_INS_EscolaridadMinisterio(obj_BE_EscolaridadMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 37)
        Else
            obj_BE_EscolaridadMinisterio.CodigoEscolaridadMinisterio = CInt(BoolGrabar)
            usp_valor = obj_BL_EscolaridadMinisterio.FUN_UPD_EscolaridadMinisterio(obj_BE_EscolaridadMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 37)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 37)
                Master.SeteoPermisosAcciones(btnActualizar, 37)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 37)
            End If
