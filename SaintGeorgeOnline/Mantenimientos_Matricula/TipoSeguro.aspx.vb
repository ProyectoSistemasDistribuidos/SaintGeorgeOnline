...
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 44
''' </remarks>
Partial Class Mantenimientos_Matricula_TipoSeguro
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Tipos de Seguro")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 44)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 44)
        Master.SeteoPermisosAcciones(btnExportar, 44)
        Master.SeteoPermisosAcciones(btnGrabar, 44)
        Master.SeteoPermisosAcciones(btnNuevo, 44)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 44, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Tipos de Seguro")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Tipos de Seguro")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Tipos de Seguro")
    ...
    ''' <summary>
    ''' Lista los datos de Tipo de Seguro     
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_TiposSeguro.FUN_LIS_TipoSeguro(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 44)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Tipo de Seguro</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_TiposSeguro.FUN_GET_TipoSeguro(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 44)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_TiposSeguro.FUN_DEL_TipoSeguro(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 44)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_TiposSeguro As New be_TiposSeguro
        Dim obj_BL_TiposSeguro As New bl_TiposSeguro
        ...
        obj_BE_TiposSeguro.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_TiposSeguro.FUN_INS_TipoSeguro(obj_BE_TiposSeguro, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 44)
        Else
            obj_BE_TiposSeguro.CodigoTipoSeguro = CInt(BoolGrabar)
            usp_valor = obj_BL_TiposSeguro.FUN_UPD_TipoSeguro(obj_BE_TiposSeguro, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 44)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 44)
                Master.SeteoPermisosAcciones(btnActualizar, 44)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 44)
            End If
