...
''' <summary>
''' Modulo de Mantenimiento de Paises Ministerio
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción:  35
''' </remarks>
Partial Class Mantenimientos_Matricula_PaisesMinisterio
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Paises Ministerio")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 35)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 35)
        Master.SeteoPermisosAcciones(btnExportar, 35)
        Master.SeteoPermisosAcciones(btnGrabar, 35)
        Master.SeteoPermisosAcciones(btnNuevo, 35)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 35, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Dim obj_BL_PaisesMinisterio As New bl_PaisesMinisterio
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Paises Ministerio")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Paises Ministerio")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Paises Ministerio")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_PaisesMinisterio As New bl_PaisesMinisterio
            ds_Lista = obj_BL_PaisesMinisterio.FUN_LIS_PaisesMinisterio(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 35)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de pais ministerio</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_PaisesMinisterio.FUN_GET_PaisesMinisterio(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 35)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_PaisesMinisterio.FUN_DEL_PaisesMinisterio(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 35)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_PaisMinisterio As New be_PaisesMinisterio
        Dim obj_BL_PaisesMinisterio As New bl_PaisesMinisterio
        ...
        obj_BE_PaisMinisterio.Descripcion = tbDescripcion.Text.Trim
        obj_BE_PaisMinisterio.Abreviatura = tbAbreviatura.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_PaisesMinisterio.FUN_INS_PaisesMinisterio(obj_BE_PaisMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 35)
        Else
            obj_BE_PaisMinisterio.CodigoPaisMinisterio = CInt(BoolGrabar)
            usp_valor = obj_BL_PaisesMinisterio.FUN_UPD_PaisesMinisterio(obj_BE_PaisMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 35)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 35)
                Master.SeteoPermisosAcciones(btnActualizar, 35)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 35)
            End If
