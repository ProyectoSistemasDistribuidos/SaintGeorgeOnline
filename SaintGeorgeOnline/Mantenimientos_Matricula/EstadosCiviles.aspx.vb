...
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 49
''' </remarks>
Partial Class Mantenimientos_Matricula_EstadosCiviles
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Estados Civiles")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 49)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 49)
        Master.SeteoPermisosAcciones(btnExportar, 49)
        Master.SeteoPermisosAcciones(btnGrabar, 49)
        Master.SeteoPermisosAcciones(btnNuevo, 49)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 49, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Estados Civiles")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Estados Civiles")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Estados Civiles")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_EstadosCiviles.FUN_LIS_EstadosCiviles(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 49)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Estado civil</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_EstadosCiviles.FUN_GET_EstadosCiviles(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 49)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_EstadosCiviles.FUN_DEL_EstadosCiviles(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 49)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_EstadosCiviles As New be_EstadosCiviles
        Dim obj_BL_EstadosCiviles As New bl_EstadosCiviles
        ...
        obj_BE_EstadosCiviles.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_EstadosCiviles.FUN_INS_EstadosCiviles(obj_BE_EstadosCiviles, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 49)
        Else
            obj_BE_EstadosCiviles.CodigoEstadoCivil = CInt(BoolGrabar)
            usp_valor = obj_BL_EstadosCiviles.FUN_UPD_EstadosCiviles(obj_BE_EstadosCiviles, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 49)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 49)
                Master.SeteoPermisosAcciones(btnActualizar, 49)
            Else
                btnActivar.Attributes.Add("OnClick", "return confirm_activar();")
                btnActualizar.Visible = False
                btnEliminar.Visible = False
                Master.SeteoPermisosAcciones(btnActivar, 49)
