...
''' <summary>
''' Modulo de Mantenimiento de Houses
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 29
''' </remarks>
Partial Class Mantenimientos_Matricula_Paises
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Paises")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 29)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 29)
        Master.SeteoPermisosAcciones(btnExportar, 29)
        Master.SeteoPermisosAcciones(btnGrabar, 29)
        Master.SeteoPermisosAcciones(btnNuevo, 29)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 29, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        dt = Datos.agregarColumna(dt, "Pais", "String")
        dt = Datos.agregarColumna(dt, "Pais Ministerio", "String")
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            auxDR = dt.NewRow
            auxDR.Item("N°") = cont
            auxDR.Item("Pais") = dr.Item("Descripcion").ToString
            auxDR.Item("Pais Ministerio") = dr.Item("DescripcionPaisMinisterio").ToString
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Paises")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Paises")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Paises")
    ...
    Private Sub MostrarAlertas()
        ...
        If ddlTipo.SelectedValue = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 3, "Tipo de alergia")
        End If
    ...
    ''' <summary>
    '''  Carga la lista de paises de ministerio 
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ...
    ''' Fecha de modificación: _____________ 
    ''' </remarks>
    Private Sub cargarComboPaisMinisterio()
        Dim obj_BL_PaisMinisterio As New bl_PaisesMinisterio
        Dim int_CodigoUsuario As Integer = Me.Master.Obtener_CodigoUsuarioLogueado
        Dim int_CodigoTipoUsuario As Integer = Me.Master.Obtener_CodigoTipoUsuarioLogueado

        Dim ds_Lista As DataSet = obj_BL_PaisMinisterio.FUN_LIS_PaisesMinisterio("", 1, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 29)
    ...
    Private Function validar(ByRef str_Mensaje As String) As Boolean
        ...
        If ddlTipo.Text.Trim.Length = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 1, "País Ministerio")
            result = False
        End If
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        Dim int_CodigoPaisMinisterio As Integer = CInt(ddlBuscarTipo.SelectedValue)
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Pais.FUN_LIS_Pais(str_Descripcion, int_CodigoPaisMinisterio, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 29)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Paises</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     11/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Pais.FUN_GET_Pais(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 29)

        hd_Codigo.Value = CInt(ds_Lista.Tables(0).Rows(0).Item("Codigo").ToString)
        ddlTipo.SelectedValue = CInt(ds_Lista.Tables(0).Rows(0).Item("Codigotipo").ToString)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Pais.FUN_DEL_Pais(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 29)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Pais As New be_Paises
        Dim obj_BL_Pais As New bl_Paises
        ...
        obj_BE_Pais.Descripcion = tbDescripcion.Text.Trim
        obj_BE_Pais.CodigoPaisMinisterio = CInt(ddlTipo.SelectedValue)

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Pais.FUN_INS_Pais(obj_BE_Pais, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 29)
        Else
            obj_BE_Pais.CodigoPais = CInt(BoolGrabar)
            usp_valor = obj_BL_Pais.FUN_UPD_Pais(obj_BE_Pais, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 29)
        End If
...
#Region "Metodos del Gridview"
    ...
    Private Sub ImagenSorting(ByVal nombreBoton As String)
        ...
        Dim _btnSorting_d2 As ImageButton = CType(GridView1.HeaderRow.FindControl("btnSorting_DescripcionPaisMinisterio"), ImageButton)
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 29)
                Master.SeteoPermisosAcciones(btnActualizar, 29)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 29)
            End If
