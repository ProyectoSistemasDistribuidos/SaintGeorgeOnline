<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="Idiomas.aspx.vb" Inherits="Mantenimientos_Matricula_Idiomas" title="Página sin título" %>
                    ...
                    <div id="miBusquedaMant">
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red;
                                ...
                                <tr>
                                    <td style="width: 100px; height: 25px;" align="left" valign="middle">
                                        <span>Idioma Ministerio</span>
                                    </td>
                                    <td style="min-width: 410px; height: 25px; padding-left: 10px;" align="left" 
                                        valign="bottom">
                                        <asp:DropDownList ID="ddlBuscarTipo" runat="server" Height="18px" Width="150px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Descripción">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:190px;" align="right" valign="middle">Pais&nbsp;</td>
                                ...
                                <asp:TemplateField HeaderText="Pais Ministerio">  
                                    <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:100px;" align="right" valign="middle">Idioma Ministerio</td>
                                            <td style="width:55px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescripcionIdiomasMinisterio" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="DescripcionIdiomasMinisterio"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("DescripcionIdiomasMinisterio") %>' />
                                    </ItemTemplate>
                    ...
                    <div id="miDetalleMant">
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">
                                ...
                                <tr>
                                    <td style="width: 100px; height: 25px;" align="left" valign="middle">
                                        <span>Pais Ministerio&nbsp;</span><span class="camposObligatorios">(*)</span>
                                    </td>
                                    <td style="min-width: 410px; height: 25px;" align="left" valign="bottom">
