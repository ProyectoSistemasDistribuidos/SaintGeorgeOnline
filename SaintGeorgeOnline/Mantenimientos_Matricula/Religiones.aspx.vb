...
''' <summary>
''' Modulo de Mantenimiento de Religiones
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 41
''' </remarks>
Partial Class Mantenimientos_Matricula_Religiones
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Religiones")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 41)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 41)
        Master.SeteoPermisosAcciones(btnExportar, 41)
        Master.SeteoPermisosAcciones(btnGrabar, 41)
        Master.SeteoPermisosAcciones(btnNuevo, 41)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 41, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Dim ds_Lista As DataSet = ObtenerResultadoBusqueda(1)
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Religiones")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Religiones")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Religiones")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_EscolaridadMinisterio.FUN_LIS_EscolaridadMinisterio(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 37)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Religión</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Religiones.FUN_GET_Religiones(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 41)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Religiones.FUN_DEL_Religiones(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 41)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Religiones As New be_Religiones
        Dim obj_BL_Religiones As New bl_Religiones
        ...
        obj_BE_Religiones.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Religiones.FUN_INS_Religiones(obj_BE_Religiones, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 41)
        Else
            obj_BE_Religiones.CodigoReligion = CInt(BoolGrabar)
            usp_valor = obj_BL_Religiones.FUN_UPD_Religiones(obj_BE_Religiones, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 41)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 41)
                Master.SeteoPermisosAcciones(btnActualizar, 41)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 41)
            End If
