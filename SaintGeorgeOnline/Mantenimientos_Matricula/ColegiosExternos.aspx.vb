...
''' <summary>
''' Modulo de Mantenimiento de Colegios Externos
''' </summary>
''' <remarks>
''' Código del Modulo:   
''' Código de la Opción: 
''' </remarks>
Partial Class Mantenimientos_Matricula_ColegiosExternos
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Colegios Externos")
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "ColegiosExternos")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Colegios Externos")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Colegios Externos")
        ...
        ElseIf rbExportar.SelectedValue = 3 Then 'HTML
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Colegios Externos")
            reporte_html = Arreglo_Datos(0)
    ...
    ''' <summary>
    ''' Lista los datos de Colegios Externos   
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     04/04/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_ColegiosExternos As New bl_ColegiosExternos
            ds_Lista = obj_BL_ColegiosExternos.FUN_LIS_ColegiosExternos(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Colegio Externo</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     04/04/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_ColegiosExternos.FUN_GET_ColegiosExternos(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_ColegiosExternos.FUN_DEL_ColegiosExternos(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_ColegiosExternos As New be_ColegiosExternos
        Dim obj_BL_ColegiosExternos As New bl_ColegiosExternos
        ...
        obj_BE_ColegiosExternos.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_ColegiosExternos.FUN_INS_ColegiosExternos(obj_BE_ColegiosExternos, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_ColegiosExternos.CodigoColegiosExternos = CInt(BoolGrabar)
            usp_valor = obj_BL_ColegiosExternos.FUN_UPD_ColegiosExternos(obj_BE_ColegiosExternos, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
