...
''' <summary>
''' Modulo de Mantenimiento de Nacionalidades
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 62
''' </remarks>
Partial Class Mantenimientos_Matricula_Nacionalidades
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Nacionalidades")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 62)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 62)
        Master.SeteoPermisosAcciones(btnExportar, 62)
        Master.SeteoPermisosAcciones(btnGrabar, 62)
        Master.SeteoPermisosAcciones(btnNuevo, 62)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 62, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Nacionalidades")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Nacionalidades")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Nacionalidades")
    ...
    ''' <summary>
    ''' Lista los datos de Nacionalidades     
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_nacionalidades.FUN_LIS_Nacionalidades(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 62)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Nacionalidades</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Nacionalidades.FUN_GET_Nacionalidades(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 62)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de Nacionalidades</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Nacionalidades.FUN_DEL_Nacionalidades(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 62)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Nacionalidad As New be_Nacionalidades
        Dim obj_BL_Nacionalidad As New bl_Nacionalidades
        ...
        obj_BE_Nacionalidad.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Nacionalidad.FUN_INS_Nacionalidades(obj_BE_Nacionalidad, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 62)
        Else
            obj_BE_Nacionalidad.CodigoNacionalidad = CInt(BoolGrabar)
            usp_valor = obj_BL_Nacionalidad.FUN_UPD_Nacionalidades(obj_BE_Nacionalidad, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 62)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 62)
                Master.SeteoPermisosAcciones(btnActualizar, 62)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 62)
            End If
