...
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 28
''' </remarks>
Partial Class Mantenimientos_Matricula_Houses
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Houses")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 28)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 28)
        Master.SeteoPermisosAcciones(btnExportar, 28)
        Master.SeteoPermisosAcciones(btnGrabar, 28)
        Master.SeteoPermisosAcciones(btnNuevo, 28)
    ...
    Private Sub Exportar()
        ...
        Try
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Houses")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Houses")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Houses")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Houses.FUN_LIS_Houses(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 29)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Houses</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     10/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Houses.FUN_GET_Houses(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 28)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Houses.FUN_DEL_Houses(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 28)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_House As New be_Houses
        Dim obj_BL_Houses As New bl_Houses
        ...
        obj_BE_House.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Houses.FUN_INS_Houses(obj_BE_House, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 28)
        Else
            obj_BE_House.CodigoHouse = CInt(BoolGrabar)
            usp_valor = obj_BL_Houses.FUN_UPD_Houses(obj_BE_House, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 28)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 28)
                Master.SeteoPermisosAcciones(btnActualizar, 28)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 28)
            End If
