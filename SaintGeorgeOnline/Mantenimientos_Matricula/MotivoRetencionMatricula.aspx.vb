...
''' <summary>
''' Modulo de Mantenimiento de Retenciones de Matrícula
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción:  80
''' </remarks>
Partial Class Mantenimientos_Matricula_MotivoRetencionMatricula
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Motivo de Retención")
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            auxDR = dt.NewRow
            auxDR.Item("N°") = cont
            auxDR.Item("Motivo") = dr.Item("Descripcion").ToString
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Motivos de Retención de Matrícula")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Motivos de Retención de Matrícula")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Motivos de Retención de Matrícula")
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 80)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 80, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Function validar(ByRef str_Mensaje As String) As Boolean
        ...
        If tbMensajeUsuario.Text.Trim.Length = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 1, "Mensaje de Usuario")
            result = False
        End If
        If Validacion.ValidarCamposIngreso(tbMensajeUsuario) = False Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 2, "Mensaje de Usuario")
            result = False
        End If
    ...
    ''' <summary>
    ''' Lista la relación de paises ministerio.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_MotivoRestriccionMatricula.FUN_LIS_MotivoRestriccionMatricula(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 80)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de motivo de retención</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_MotivoRestriccionMatricula.FUN_GET_MotivoRestriccionMatricula(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 80)
        ...
        tbMensajeUsuario.Text = ds_Lista.Tables(0).Rows(0).Item("MensajeAlerta").ToString
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de motivo de retención de matricula</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_MotivoRestriccionMatricula.FUN_DEL_MotivoRestriccionMatricula(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 80)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_MotivoRestriccionMatricula As New be_MotivoRestriccionMatricula
        Dim obj_BL_MotivoRestriccionMatricula As New bl_MotivoRestriccionMatricula
        ...
        obj_BE_MotivoRestriccionMatricula.Descripcion = tbDescripcion.Text.Trim
        obj_BE_MotivoRestriccionMatricula.MensajeAlerta = tbMensajeUsuario.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_MotivoRestriccionMatricula.FUN_INS_MotivoRestriccionMatricula(obj_BE_MotivoRestriccionMatricula, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 80)
        Else
            obj_BE_MotivoRestriccionMatricula.CodigoMotivoRestriccionMatricula = CInt(BoolGrabar)
            usp_valor = obj_BL_MotivoRestriccionMatricula.FUN_UPD_MotivoRestriccionMatricula(obj_BE_MotivoRestriccionMatricula, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 80)
        End If
