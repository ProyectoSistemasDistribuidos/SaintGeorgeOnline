...
''' <summary>
''' Modulo de Mantenimiento de Idiomas Ministerio
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 61
''' </remarks>
Partial Class Mantenimientos_Matricula_IdiomasMinisterio
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Idiomas Ministerio")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 61)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 61)
        Master.SeteoPermisosAcciones(btnExportar, 61)
        Master.SeteoPermisosAcciones(btnGrabar, 61)
        Master.SeteoPermisosAcciones(btnNuevo, 61)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 61, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Dim ds_Lista As DataSet = ObtenerResultadoBusqueda(1)
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Idiomas Ministerio")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Idiomas Ministerio")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Idiomas Ministerio")
    ...
    ''' <summary>
    ''' Lista los datos de Idioma Ministerio     
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_IdiomasMinisterio.FUN_LIS_IdiomasMinisterio(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 61)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Idioma Ministerio</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_IdiomasMinisterio.FUN_GET_IdiomasMinisterio(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 61)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_IdiomasMinisterio.FUN_DEL_IdiomasMinisterio(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 61)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_IdiomasMinisterio As New be_IdiomasMinisterio
        Dim obj_BL_IdiomasMinisterio As New bl_IdiomasMinisterio
        ...
        obj_BE_IdiomasMinisterio.Descripcion = tbDescripcion.Text.Trim
        obj_BE_IdiomasMinisterio.Abreviatura = tbAbreviatura.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_IdiomasMinisterio.FUN_INS_IdiomasMinisterio(obj_BE_IdiomasMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 61)
        Else
            obj_BE_IdiomasMinisterio.CodigoIdiomaMinisterio = CInt(BoolGrabar)
            usp_valor = obj_BL_IdiomasMinisterio.FUN_UPD_IdiomasMinisterio(obj_BE_IdiomasMinisterio, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 61)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 61)
                Master.SeteoPermisosAcciones(btnActualizar, 61)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 61)
            End If
