...
''' <summary>
''' Modulo de Mantenimiento de Clinicas
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 42
''' </remarks>
Partial Class Mantenimientos_Matricula_Clinicas
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Clinicas")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 42)
    ...
    Private Sub Exportar()
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Clinicas")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Clinicas")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Clinicas.FUN_LIS_Clinicas(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 42)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Clinicas.FUN_GET_Clinicas(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 42)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Clinicas.FUN_DEL_Clinicas(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 42)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Clinicas As New be_Clinicas
        Dim obj_BL_Clinicas As New bl_Clinicas
        ...
        obj_BE_Clinicas.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Clinicas.FUN_INS_Clinicas(obj_BE_Clinicas, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 42)
        Else
            obj_BE_Clinicas.CodigoClinica = CInt(BoolGrabar)
            usp_valor = obj_BL_Clinicas.FUN_UPD_Clinicas(obj_BE_Clinicas, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 42)
        End If
