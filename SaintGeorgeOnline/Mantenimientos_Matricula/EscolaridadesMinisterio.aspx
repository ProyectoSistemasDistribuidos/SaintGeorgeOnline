<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="EscolaridadesMinisterio.aspx.vb" Inherits="Mantenimientos_Matricula_EscolaridadesMinisterio" title="Página sin título" %>
                        ...
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">                                
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="middle">
                                        <asp:TextBox ID="tbAbreviatura" runat="server" CssClass="miTextBox" Width="150px "
                                            Height="21px" MaxLength="8" />
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
