...
''' <summary>
''' Modulo de Mantenimiento de Tipo de documento de identidad
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 50
''' </remarks>
Partial Class Mantenimientos_Matricula_Idiomas
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Idiomas")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 50)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 50)
        Master.SeteoPermisosAcciones(btnExportar, 50)
        Master.SeteoPermisosAcciones(btnGrabar, 50)
        Master.SeteoPermisosAcciones(btnNuevo, 50)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 50, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Dim dt As DataTable = New DataTable("ListaExportar")
            ...
            dt = Datos.agregarColumna(dt, "Idioma Ministerio", "String")
            ...
            For Each dr As DataRow In ds_Lista.Tables(0).Rows
                auxDR = dt.NewRow
                auxDR.Item("N°") = cont
                auxDR.Item("Idioma") = dr.Item("Descripcion").ToString
                auxDR.Item("Idioma Ministerio") = dr.Item("DescripcionIdiomasMinisterio").ToString
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Idiomas")
                reporte_html = Arreglo_Datos(0)
                NombreArchivo = Arreglo_Datos(1)
                NombreArchivo = NombreArchivo & ".doc"

                rutamadre = Server.MapPath(".")
                rutamadre = rutamadre.Replace("\Mantenimientos_Matricula", "\Reportes\")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Idiomas")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Idiomas")
    ...
    Private Sub MostrarAlertas()
        ...
        If Validacion.ValidarCamposIngreso(tbDescripcion) = False Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 2, "Descripción") ' Palabras con más de 50 caracteres
        ElseIf tbDescripcion.Text.Trim.Length = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 1, "Descripción") ' No ha ingresado la descripción
        End If

        If ddlTipo.SelectedValue = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 3, "Idioma Ministerio")
        End If
    ...
    ''' <summary>
    '''  Carga la lista de Idiomas de ministerio 
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ...
    ''' Fecha de modificación: _____________ 
    ''' </remarks>
    Private Sub cargarComboIdiomasMinisterio()
        Dim obj_BL_IdiomasMinisterio As New bl_IdiomasMinisterio
        Dim int_CodigoUsuario As Integer = Me.Master.Obtener_CodigoUsuarioLogueado
        Dim int_CodigoTipoUsuario As Integer = Me.Master.Obtener_CodigoTipoUsuarioLogueado

        Dim ds_Lista As DataSet = obj_BL_IdiomasMinisterio.FUN_LIS_IdiomasMinisterio("", 1, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 50)

        Controles.llenarCombo(ddlBuscarTipo, ds_Lista, "Codigo", "Descripcion", True, False)
        Controles.llenarCombo(ddlTipo, ds_Lista, "Codigo", "Descripcion", False, True)
    End Sub
    ...
    Private Function validar(ByRef str_Mensaje As String) As Boolean
        ...
        If ddlTipo.SelectedValue = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 3, "País ministerio")
            result = False
        End If
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        Dim int_CodigoIdiomaMinisterio As Integer = CInt(ddlBuscarTipo.SelectedValue)
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Idiomas.FUN_LIS_Idiomas(str_Descripcion, int_CodigoIdiomaMinisterio, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 50)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Idiomas</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Idiomas.FUN_GET_Idiomas(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 50)

        hd_Codigo.Value = CInt(ds_Lista.Tables(0).Rows(0).Item("Codigo").ToString)
        ddlTipo.SelectedValue = CInt(ds_Lista.Tables(0).Rows(0).Item("CodigoIdiomaMinisterio").ToString)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Idiomas.FUN_DEL_Idiomas(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 50)
        End If
    ...
    ''' </remarks>
    Private Sub Grabar()
        Dim obj_BE_Idiomas As New be_Idiomas
        Dim obj_BL_Idiomas As New bl_Idiomas
        ...
        obj_BE_Idiomas.Descripcion = tbDescripcion.Text.Trim
        obj_BE_Idiomas.CodigoIdiomaMinisterio = CInt(ddlTipo.SelectedValue)

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Idiomas.FUN_INS_Idiomas(obj_BE_Idiomas, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 50)
        Else
            obj_BE_Idiomas.CodigoIdioma = CInt(BoolGrabar)
            usp_valor = obj_BL_Idiomas.FUN_UPD_Idiomas(obj_BE_Idiomas, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 50)
        End If
...
#Region "Metodos del Gridview"
    ...
    Private Sub ImagenSorting(ByVal nombreBoton As String)
        ...
        Dim _btnSorting_d2 As ImageButton = CType(GridView1.HeaderRow.FindControl("btnSorting_DescripcionIdiomasMinisterio"), ImageButton)
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 50)
                Master.SeteoPermisosAcciones(btnActualizar, 50)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 50)
            End If
