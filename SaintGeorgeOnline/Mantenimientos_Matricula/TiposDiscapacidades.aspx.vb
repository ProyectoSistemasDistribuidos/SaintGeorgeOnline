...
''' <summary>
''' Modulo de Mantenimiento de Tipos de Discapacidades
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción:  34
''' </remarks>
Partial Class Mantenimientos_Matricula_TiposDiscapacidades
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Tipos de Discapacidades")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 34)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 34)
        Master.SeteoPermisosAcciones(btnExportar, 34)
        Master.SeteoPermisosAcciones(btnGrabar, 34)
        Master.SeteoPermisosAcciones(btnNuevo, 34)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 34, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Tipos de Discapacidades")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Tipos de Discapacidades")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Tipos de Discapacidades")
    ...
    ''' <summary>
    ''' Lista la relación de tipos de discapacidades.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BE_TiposDiscapacidades As New bl_TiposDiscapacidades
            ds_Lista = obj_BE_TiposDiscapacidades.FUN_LIS_TiposDiscapacidades(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 34)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de tipos de discapacidades</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BE_TiposDiscapacidades.FUN_GET_TiposDiscapacidades(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 34)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de tipo de discapacidades</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BE_TiposDiscapacidades.FUN_DEL_TiposDiscapacidades(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 34)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_TipoDiscapacidad As New be_TiposDiscapacidades
        Dim obj_BE_TiposDiscapacidades As New bl_TiposDiscapacidades
        ...
        obj_BE_TipoDiscapacidad.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BE_TiposDiscapacidades.FUN_INS_TiposDiscapacidades(obj_BE_TipoDiscapacidad, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 34)
        Else
            obj_BE_TipoDiscapacidad.CodigoTipoDiscapacidad = CInt(BoolGrabar)
            usp_valor = obj_BE_TiposDiscapacidades.FUN_UPD_TiposDiscapacidades(obj_BE_TipoDiscapacidad, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 34)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 34)
                Master.SeteoPermisosAcciones(btnActualizar, 34)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 34)
            End If
