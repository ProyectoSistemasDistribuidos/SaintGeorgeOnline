...
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción:  81
''' </remarks>
Partial Class Mantenimientos_Matricula_CompaniaSeguro
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Compañia de Seguros")
...
#Region "Metodos"
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 81, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 81)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 42)
        Master.SeteoPermisosAcciones(btnExportar, 42)
        Master.SeteoPermisosAcciones(btnGrabar, 42)
        Master.SeteoPermisosAcciones(btnNuevo, 42)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Compañia Seguro")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "CompaniaSeguro")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "CompaniaSeguro")
        ...
        ElseIf rbExportar.SelectedValue = 3 Then 'HTML
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Clinicas")
            reporte_html = Arreglo_Datos(0)
    ...
    ''' <summary>
    ''' Lista la relación de compañias de seguros.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_CompaniaSeguro.FUN_LIS_CompaniaSeguro(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 81)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Compañoa de Seguro</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_CompaniaSeguro.FUN_GET_CompaniaSeguro(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 81)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de compañia de seguro</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_CompaniaSeguro.FUN_DEL_CompaniaSeguro(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 81)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_CompaniaSeguro As New be_CompaniaSeguro
        Dim obj_BL_CompaniaSeguro As New bl_CompaniaSeguro
        ...
        obj_BE_CompaniaSeguro.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_CompaniaSeguro.FUN_INS_CompaniaSeguro(obj_BE_CompaniaSeguro, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 81)
        Else
            obj_BE_CompaniaSeguro.CodigoCompaniaSeguro = CInt(BoolGrabar)
            usp_valor = obj_BL_CompaniaSeguro.FUN_UPD_CompaniaSeguro(obj_BE_CompaniaSeguro, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 81)
        End If
