...
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 31
''' </remarks>
Partial Class Mantenimientos_Matricula_Profesiones
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Profesiones")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 31)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 31)
        Master.SeteoPermisosAcciones(btnExportar, 31)
        Master.SeteoPermisosAcciones(btnGrabar, 31)
        Master.SeteoPermisosAcciones(btnNuevo, 31)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 31, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Profesiones")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Profesiones")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Profesiones")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_Profesion As New bl_Profesiones
            ds_Lista = obj_BL_Profesion.FUN_LIS_Profesion(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 31)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Profesión</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     11/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Profesion.FUN_GET_Profesion(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 31)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Profesion.FUN_DEL_Profesion(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 31)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Profesion As New be_Profesiones
        Dim obj_BL_Profesion As New bl_Profesiones
        ...
        obj_BE_Profesion.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Profesion.FUN_INS_Profesion(obj_BE_Profesion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 31)
        Else
            obj_BE_Profesion.CodigoProfesion = CInt(BoolGrabar)
            usp_valor = obj_BL_Profesion.FUN_UPD_Profesion(obj_BE_Profesion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 31)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 31)
                Master.SeteoPermisosAcciones(btnActualizar, 31)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 31)
            End If
