...
''' <summary>
''' Modulo de Mantenimiento de Profesiones
''' </summary>
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 33
''' </remarks>
Partial Class Mantenimientos_Matricula_SituacionesLaborales
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Situaciones Laborales")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 33)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 33)
        Master.SeteoPermisosAcciones(btnExportar, 33)
        Master.SeteoPermisosAcciones(btnGrabar, 33)
        Master.SeteoPermisosAcciones(btnNuevo, 33)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 33, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Situaciones Laborales")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Situaciones Laborales")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Situaciones Laborales")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_SituacionLaboral As New bl_SituacionesLaborales
            ds_Lista = obj_BL_SituacionLaboral.FUN_LIS_SituacionLaboral(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 33)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Situación Laboral</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     11/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_SituacionLaboral.FUN_GET_SituacionLaboral(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 33)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_SituacionLaboral.FUN_DEL_SituacionLaboral(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 33)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_SituacionLaboral As New be_SituacionesLaborales
        Dim obj_BL_SituacionLaboral As New bl_SituacionesLaborales
        ...
        obj_BE_SituacionLaboral.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_SituacionLaboral.FUN_INS_SituacionLaboral(obj_BE_SituacionLaboral, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 33)
        Else
            obj_BE_SituacionLaboral.CodigoSituacionLaboral = CInt(BoolGrabar)
            usp_valor = obj_BL_SituacionLaboral.FUN_UPD_SituacionLaboral(obj_BE_SituacionLaboral, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 33)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 33)
                Master.SeteoPermisosAcciones(btnActualizar, 33)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 33)
            End If
