...
''' <summary>
''' Modulo de Mantenimiento de Motivos de salidas de alumnos
''' </summary>
''' <remarks>
''' Código del Modulo:   
''' Código de la Opción: 
''' </remarks>
Partial Class Mantenimientos_Matricula_MotivoSalidaAlumno
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Motivos de Salidas de Alumnos")
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Motivos de Salidas de Alumnos")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Motivos de Salidas de Alumnos")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Motivos de Salidas de Alumnos")
    ...
    ''' <summary>
    ''' Lista los datos de motivos de salidas de alumnos   
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     04/04/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_MotivosSalidasAlumnos As New bl_MotivosSalidasAlumnos
            ds_Lista = obj_BL_MotivosSalidasAlumnos.FUN_LIS_MotivoSalidaAlumno(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Motivo de salida de alumno</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     04/04/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_MotivosSalidasAlumnos.FUN_GET_MotivoSalidaAlumno(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_MotivosSalidasAlumnos.FUN_DEL_MotivoSalidaAlumno(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_MotivosSalidasAlumnos As New be_MotivosSalidasAlumnos
        Dim obj_BL_MotivosSalidasAlumnos As New bl_MotivosSalidasAlumnos
        ...
        obj_BE_MotivosSalidasAlumnos.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_MotivosSalidasAlumnos.FUN_INS_MotivoSalidaAlumno(obj_BE_MotivosSalidasAlumnos, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_MotivosSalidasAlumnos.CodigoMotivoSalidaAlumno = CInt(BoolGrabar)
            usp_valor = obj_BL_MotivosSalidasAlumnos.FUN_UPD_MotivoSalidaAlumno(obj_BE_MotivosSalidasAlumnos, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
