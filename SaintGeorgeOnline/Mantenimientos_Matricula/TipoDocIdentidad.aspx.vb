...
''' <remarks>
''' Código del Modulo:    2
''' Código de la Opción: 43
''' </remarks>
Partial Class Mantenimientos_Matricula_TipoDocIdentidad
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Tipos de Documentos de Identidad")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(2, 43)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 43)
        Master.SeteoPermisosAcciones(btnExportar, 43)
        Master.SeteoPermisosAcciones(btnGrabar, 43)
        Master.SeteoPermisosAcciones(btnNuevo, 43)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(2, 43, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Dim ds_Lista As DataSet = ObtenerResultadoBusqueda(1)
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Tipos de Documentos de Identidad")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Tipos de Documentos de Identidad")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Tipos de Documentos de Identidad")
    ...
    ''' <summary>
    ''' Lista los datos de Documento de Identidad     
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_TipoDocIdentidad.FUN_LIS_TipoDocIdentidad(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 43)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Documento de identidad</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     13/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_TipoDocIdentidad.FUN_GET_TipoDocIdentidad(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 43)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_TipoDocIdentidad.FUN_DEL_TipoDocIdentidad(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 43)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_TipoDocIdentidad As New be_TiposDocumentosIdentidad
        Dim obj_BL_TipoDocIdentidad As New bl_TipoDocIdentidad
        ...
        obj_BE_TipoDocIdentidad.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_TipoDocIdentidad.FUN_INS_TipoDocIdentidad(obj_BE_TipoDocIdentidad, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 43)
        Else
            obj_BE_TipoDocIdentidad.CodigoTipoDocIdentidad = CInt(BoolGrabar)
            usp_valor = obj_BL_TipoDocIdentidad.FUN_UPD_TipoDocIdentidad(obj_BE_TipoDocIdentidad, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 43)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 43)
                Master.SeteoPermisosAcciones(btnActualizar, 43)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 43)
            End If
