...
Partial Class Modulo_Matricula_AsignacionAulaAlumnos
...
#Region "Eventos"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Asignacion Aula Alumnos")
...
#Region "Metodos"
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_Alumnos As New bl_Alumnos
            ds_Lista = obj_BL_Alumnos.FUN_LIS_AsignacionAulasAlumnos(int_AnioAcademico, int_Grado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
