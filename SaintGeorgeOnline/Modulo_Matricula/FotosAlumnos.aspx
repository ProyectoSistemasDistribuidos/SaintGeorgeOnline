<%@ Page Title="" Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="FotosAlumnos.aspx.vb" Inherits="Modulo_Matricula_FotosAlumnos" %>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 420px; height: 25px;" align="left" valign="middle">                                    
                                           <asp:ImageButton ID="btnGrabar" runat="server" Width="74" Height="19" ImageUrl="~/App_Themes/Imagenes/btnGrabar_1.png"
                                                ...
                                                onclick="btnGrabar_Click" Visible="false" />&nbsp;
                                                      ...
                                                      <%--<asp:GridView ID="GridView1" runat="server" 
                                                           ...
                                                           OnRowDataBound="GridView1_RowDataBound"
                                                            ...
                                                            <Columns>     
                                                                <asp:TemplateField >                                                                      
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblCodigoMatricula" runat="server" Text='<%# Bind("CodigoPersona") %>' />
                                                                    </ItemTemplate>
                                                                    <ItemStyle CssClass="miHiddenStyle" HorizontalAlign="Left" Width="0px" />
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField >                                                                      
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblFila" runat="server" Text='<%# Bind("IdFila") %>' />
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateField>  
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblNombreAlumno" runat="server" Text='<%# Bind("NombreCompleto") %>' />
                                                                    </ItemTemplate>
                                                                   <ItemStyle  CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="230px" />
                                                                </asp:TemplateField>  
                                                                <asp:TemplateField>  
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblGrado" runat="server" Text='<%# Bind("GradoAula") %>' />
                                                                    </ItemTemplate>
                                                                   <ItemStyle  CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Center" Width="100px" />
                                                                </asp:TemplateField>  
                                                              </Columns>  
