...
''' <summary>
''' Módulo de Registro de Fichas de Familiar
''' </summary>
''' <remarks>
''' Código del Modulo:    2
...
Partial Class Modulo_Matricula_frameFichaFamiliar
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not Page.IsPostBack Then
                ...
                If Session("CodigoFamiliarRegistrado") Is Nothing Then
    ...
    Protected Sub btnFichaCancelar_Click()
        ...
        'str_Script = "var btnClose = parent.document.getElementById('ctl00_ContentPlaceHolder1_btnCerrar_IngresarFamiliar'); alert(btnClose.id); btnClose.click();"
        'ScriptManager.RegisterClientScriptBlock(Me.Page, GetType(String), "", str_Script, True)


        'Me.Page.ClientScript.RegisterStartupScript(Me.GetType(), "alert", "cerrar();", True)
...
#End Region
    ...
    Private Sub EstadoDatosFamiliar(ByVal bool_Estado As Boolean)
        ...
        If bool_Estado Then
            ...
            btnAgregarDetalleFichaAutos.ImageUrl = "~/App_Themes/Imagenes/btnAgregarRegistroDetalle_1.png"
        Else
            ...
            btnAgregarDetalleFichaAutos.ImageUrl = "~/App_Themes/Imagenes/btnAgregarRegistroDetalle_0.png"
        End If
    ...
    Private Sub GrabarFicha(ByVal bool_FichaCompleta As Boolean)
        ...
        obj_BE_Familiar.FechaNacimiento = IIf(tbFechaNacimiento.Text.Trim.Length = 0, Nothing, tbFechaNacimiento.Text.Trim)
        ...
        If usp_valor > 0 Then
            ...
            Session("CodigoFamiliarRegistrado") = usp_valor
            ...
            'Dim str_Script As String = ""
            'str_Script = "var btnClose = parent.document.getElementById('ctl00_ContentPlaceHolder1_btnCerrar_IngresarFamiliar'); btnClose.click();"
            'ScriptManager.RegisterClientScriptBlock(Me.Page, GetType(String), "", str_Script, True)
