        ...
        <atk:TabPanel ID="miTab1" runat="server" HeaderText="Tab1" Enabled="true">
            ...
            <ContentTemplate> 
                <div style="border: solid 0px blue; width: 650px;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="360px">
                                        <tr>
                                            <td align="left" valign="middle" style="width: 110px; height: 25px;">
                                                <asp:TextBox ID="tbFechaSolicitudInicial" runat="server" 
                                            ...
                                            <td align="left" valign="middle" style="width: 110px; height: 25px;">
                                                <asp:TextBox ID="tbFechaSolicitudFinal" runat="server" 
                                                    CssClass="miTextBoxCalendar" Height="18px"  
                                                    style="font-size: 8pt; font-family: Arial;" />    
                    ...
                    <div id="miGridviewMantActualizacion_Ficha" style="width: 840px;">                    
                            ...
                            <Columns>            
                                ...
                                <asp:TemplateField HeaderText="NombreCompletoFamiliar">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:220px;" align="right" valign="middle">Nombre Completo Familiar&nbsp;</td>
                                            <td style="width:125px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_NombreCompleto_FamiliarActualizar" runat="server" 
                                                ToolTip="Descendente"    
                                    ...
                                    <HeaderStyle HorizontalAlign="Center" Width="345px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="345px" />
                                </asp:TemplateField>
                            ...
                            <PagerTemplate>
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 840px;">
                                    <tr>                                        
                                        ...
                                        <td style="height: 20px; width: 440px;" align="center" valign="middle">                                           
