...
''' <summary>
''' Modulo de Validacion de Ficha de Familiares
''' </summary>
''' <remarks>
''' Código del Modulo:    2
...
#Region "Metodos Actualizacion"
    ...
    Private Sub enviarEmailSolicitanteActualidacion(ByVal int_CodigoSolicitud As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_SolicitudActualizacionDatos.FUN_LIS_DatosSolicitanteActualizacion(int_CodigoSolicitud, int_TipoSolicitud, int_CodigoUsuario, int_CodigoTipoUsuario, 2, 57)
        ...
        If ds_Lista.Tables(0).Rows.Count > 0 Then
            ...
            If int_EnvioEmail > 0 Then ' Enviar email
                ...
                sb_Cuerpo.Append("Se informa que su solicitud de actualización de datos de Familiar ha sido actualizada correctamente.<br />")
