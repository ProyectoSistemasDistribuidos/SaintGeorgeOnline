...
''' </remarks>
Partial Class Modulo_Matricula_Fpanel
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                If Request.QueryString("Tipo") IsNot Nothing Then
                    Dim tipo As String = Request.QueryString("tipo").ToString
                    cargarOpcionesMantenimiento()


                    'If Session("FichaFamiliar_Panel") IsNot Nothing Then
                    If Request.QueryString("CodigoFamiliar") IsNot Nothing Then

                        Dim int_CodigoFamiliar As Integer = Request.QueryString("CodigoFamiliar") 'Session("FichaFamiliar_Panel") ' Convert.ToInt32(Request.QueryString("CodigoFamiliar")) 'Session("FichaFamiliar_Panel") 'Request.QueryString("CodigoFamiliar")
                    ...
                    If tipo.Equals("Actualizar") Then
                        btnFichaCancelar.Visible = False
                        btnDisponibilidad.Visible = False
                        'VerRegistro("Actualización", 2)
                    ElseIf tipo.Equals("Agregar") Then
...
#End Region
    ...
    Private Sub GrabarFicha(ByVal bool_FichaCompleta As Boolean)
        ...
        obj_BE_Familiar.FechaNacimiento = dt_fecha 'If(tbFechaNacimiento.Text.Trim.Length <= 9, Nothing, tbFechaNacimiento.Text.Trim)
        ...
        'Datos Laborales
        obj_BE_Familiar.codigosituacionlaboral = IIf(ddlSituacionLaboral.SelectedValue = 0, Nothing, ddlSituacionLaboral.SelectedValue)
