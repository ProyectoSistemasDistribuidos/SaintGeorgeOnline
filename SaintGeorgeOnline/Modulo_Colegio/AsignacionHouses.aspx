<%@ Page Title="" Language="VB" MasterPageFile="~/PaginaPrincipal.master"  AutoEventWireup="false" CodeFile="AsignacionHouses.aspx.vb" Inherits="Modulo_Colegio_AsignacionHouses" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; width: 820px;">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td style="padding-left :8px;width:200px; height: 25px;" align="left" valign="middle">                           
                                        <asp:DropDownList ID="ddlBuscarAula" runat="server" Width="180px" OnSelectedIndexChanged="ddlBuscarAula_SelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>                                                   
                                    </td>
                                    <td style="width: 420px; height: 25px;" align="left" valign="middle">                                    
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; width:570px;">
                                                <tr>
                                                   <td id="miHeaderDetCPago2" style="border-bottom:solid; border-top:solid;    border-width:1px;  border-color:#a6a3a3;  width: 20px; height: 26px; text-align:center; color:White;font-size:10px; background-color:Teal; " align="center" >
                                                    ...
                                                    Codigo Alumno</td>
                                                    <td id="miHeaderDetCPago2" style="border-bottom:solid; border-top:solid;   border-width:1px;  border-color:#a6a3a3;  width: 170px; height: 26px; text-align:left; color:White;font-size:10px; background-color:Teal; " align="center" >
                                                    Nombre Completo</td>
                                                    ...
                                                    <td id="miHeaderDetCPago2" style=" border-bottom:solid; border-top:solid;   border-width:1px;  border-color:#a6a3a3;  width: 100px; height: 26px; text-align:center; color:White;font-size:10px; background-color:Teal; " align="center" >
                                                    Sección</td>
                                                    <td id="miHeaderDetCPago2" style=" border-bottom:solid; border-top:solid;   border-width:1px;  border-color:#a6a3a3;  width: 110px; height: 26px; text-align:center; color:White;font-size:10px; background-color:Teal; " align="center" >
                                                    Houses</td>
                                                </tr>
                                                <tr>
                                                    <td colspan ="6" style="border-bottom:solid; border-left:solid; border-right:solid;   border-width:1px;  border-color:#a6a3a3; ">
                                                      ...
                                                      <asp:GridView ID="GridView1" runat="server" 
                                                            ...
                                                            <Columns>     
                                                              ...
                                                              <asp:BoundField DataField="CodigoHouse" HeaderText="CodigoHouse" ItemStyle-Width="0" HeaderStyle-CssClass="miHiddenStyle" ItemStyle-CssClass="miHiddenStyle" />                                
