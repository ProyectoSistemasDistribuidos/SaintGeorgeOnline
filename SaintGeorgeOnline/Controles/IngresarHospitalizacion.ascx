<%@ Control Language="VB" AutoEventWireup="false" CodeFile="IngresarHospitalizacion.ascx.vb" Inherits="Controles_IngresarHospitalizacion" %>
<style type="text/css">   
    .miTextBox{
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel_IngresarHospitalizacion" runat="server">
    <ContentTemplate>      
    <atk:ModalPopupExtender ID="ModalPopupExtender_IngresarHospitalizacion" runat="server"
        PopupControlID="Panel_IngresarHospitalizacion"
        TargetControlID="btnVer_IngresarHospitalizacion"
        OkControlID="btnOK_IngresarHospitalizacion" 
        CancelControlID="btnCancel_IngresarHospitalizacion"
        BackgroundCssClass="modalBackground"  
        Drag="True" PopupDragHandleControlID="dragCtrl_IngresarHospitalizacion" Enabled="True" />      
    <asp:panel id="Panel_IngresarHospitalizacion" BackColor="White" BorderColor="Black" BorderWidth="1" runat="server" style="width: 500px; display: none;">
        <table cellpadding="0" cellspacing="0" border="0" id="panelRegistro" style="width: 500px;">          
            <tr>
                ...
                <td style="width: 440px; height: 26px; cursor: pointer;" align="left" valign="middle" class="header" colspan="2" id="dragCtrl_IngresarHospitalizacion">                
                    <span style="font-weight:bold; font-size:11px; font-family:Arial; cursor: pointer;">
                        <asp:Label ID="lbltitulo" runat="server" text="Registro de Hospitalizacion" />
                    </span>
                </td>
                <td style="width: 30px; height: 26px" align="right" valign="middle" class="header">
                    <asp:ImageButton ID="btnCerrar_IngresarHospitalizacion" runat="server" Width="16px" Height="15px"
                        ImageUrl="~/App_Themes/Imagenes/cross_icon_normal.png"
                        onclick="btnCerrar_IngresarHospitalizacion_Click" ToolTip="Cerrar Panel"/>                                        
                </td>
            </tr>
            <tr><td colspan="4">
            ...
            <tr>
                <td colspan="4" align="center" valign="middle"> 
                    <asp:ImageButton ID="btnGrabar_IngresarHospitalizacion" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnGrabar_IngresarHospitalizacion_Click" />&nbsp;
                    <asp:ImageButton ID="btnCancelar_IngresarHospitalizacion" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnCerrar_IngresarHospitalizacion_Click" CausesValidation="False"/>
                </td>
            </tr>   
            <tr><td colspan="4"><br /></td></tr>             
        </table>  
        <div id="controlIngresarHospitalizacion" style="display:none">
            <input type="button" id="btnVer_IngresarHospitalizacion" runat="server" />
            <input type="button" id="btnOK_IngresarHospitalizacion" />
            <input type="button" id="btnCancel_IngresarHospitalizacion" />
        </div>       
    </asp:panel> 
    </ContentTemplate>        
    </asp:UpdatePanel> 