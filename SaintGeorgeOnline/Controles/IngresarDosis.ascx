<%@ Control Language="VB" AutoEventWireup="false" CodeFile="IngresarDosis.ascx.vb" Inherits="Controles_IngresarDosis" %>
<style type="text/css">   
    .miTextBox{
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel_IngresarDosis" runat="server">
    <ContentTemplate>      
    <atk:ModalPopupExtender ID="ModalPopupExtender_IngresarDosis" runat="server"
        PopupControlID="Panel_IngresarDosis"
        TargetControlID="btnVer_IngresarDosis"
        OkControlID="btnOK_IngresarDosis" 
        CancelControlID="btnCancel_IngresarDosis"
        BackgroundCssClass="modalBackground" 
        Drag="True" PopupDragHandleControlID="dragCtrl_IngresarDosis" Enabled="True" />         
    <asp:panel id="Panel_IngresarDosis" BackColor="White" BorderColor="Black" BorderWidth="1" runat="server" style="width: 500px; display: none;">
        <table cellpadding="0" cellspacing="0" border="0" id="panelRegistro" style="width: 500px;">          
            <tr>
                ...
                <td style="width: 440px; height: 26px; cursor: pointer;" align="left" valign="middle" class="header" colspan="2" id="dragCtrl_IngresarDosis">                
                    <span style="font-weight:bold; font-size:11px; font-family:Arial; cursor: pointer;">
                        <asp:Label ID="lbltitulo" runat="server" text="Registro de Dosis de Vacuna" />
                    </span>
                </td>
                <td style="width: 30px; height: 26px" align="right" valign="middle" class="header">
                    <asp:ImageButton ID="btnCerrar_IngresarDosis" runat="server" Width="16px" Height="15px"
                        ImageUrl="~/App_Themes/Imagenes/cross_icon_normal.png"
                        onclick="btnCerrar_IngresarDosis_Click" ToolTip="Cerrar Panel"/>                                        
                </td>
            </tr>
            <tr><td colspan="4">
            ...
            <tr>
                <td colspan="4" align="center" valign="middle"> 
                    <asp:ImageButton ID="btnGrabar_IngresarDosis" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnGrabar_IngresarDosis_Click" />&nbsp;
                    <asp:ImageButton ID="btnCancelar_IngresarDosis" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnCerrar_IngresarDosis_Click" CausesValidation="False"/>
                </td>
            </tr>   
            <tr><td colspan="4"><br /></td></tr>             
        </table>  
        <div id="controlIngresarDosis" style="display:none">
            <input type="button" id="btnVer_IngresarDosis" runat="server" />
            <input type="button" id="btnOK_IngresarDosis" />
            <input type="button" id="btnCancel_IngresarDosis" />
        </div>       
    </asp:panel> 
    </ContentTemplate>        
    </asp:UpdatePanel>  