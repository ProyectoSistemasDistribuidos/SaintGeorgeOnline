<%@ Control Language="VB" AutoEventWireup="false" CodeFile="IngresarVacuna.ascx.vb" Inherits="Controles_IngresarVacuna" %>
<style type="text/css">   
    .miTextBox{
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel_IngresarVacuna" runat="server">
    <ContentTemplate>      
    <atk:ModalPopupExtender ID="ModalPopupExtender_IngresarVacuna" runat="server"
        PopupControlID="Panel_IngresarVacuna"
        TargetControlID="btnVer_IngresarVacuna"
        OkControlID="btnOK_IngresarVacuna" 
        CancelControlID="btnCancel_IngresarVacuna"
        BackgroundCssClass="modalBackground"  
        Drag="True" PopupDragHandleControlID="dragCtrl_IngresarVacuna" Enabled="True" />      
    <asp:panel id="Panel_IngresarVacuna" BackColor="White" BorderColor="Black" BorderWidth="1" runat="server" style="width: 500px; display: none;">
        <table cellpadding="0" cellspacing="0" border="0" id="panelRegistro" style="width: 500px;">          
            <tr>
                ...
                <td style="width: 440px; height: 26px; cursor: pointer;" align="left" valign="middle" class="header" colspan="2" id="dragCtrl_IngresarVacuna">                
                    <span style="font-weight:bold; font-size:11px; font-family:Arial; cursor: pointer;">
                        <asp:Label ID="lbltitulo" runat="server" text="Registro de Vacuna" />
                    </span>
                </td>
                <td style="width: 30px; height: 26px" align="right" valign="middle" class="header">
                    <asp:ImageButton ID="btnCerrar_IngresarVacuna" runat="server" Width="16px" Height="15px"
                        ImageUrl="~/App_Themes/Imagenes/cross_icon_normal.png"
                        onclick="btnCerrar_IngresarVacuna_Click" ToolTip="Cerrar Panel"/>                                        
                </td>
            </tr>
            <tr><td colspan="4">
            ...
            <tr>
                <td colspan="4" align="center" valign="middle"> 
                    <asp:ImageButton ID="btnGrabar_IngresarVacuna" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnGrabar_IngresarVacuna_Click" />&nbsp;
                    <asp:ImageButton ID="btnCancelar_IngresarVacuna" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnCerrar_IngresarVacuna_Click" CausesValidation="False"/>
                </td>
            </tr>   
            <tr><td colspan="4"><br /></td></tr>             
        </table>  
        <div id="controlIngresarVacuna" style="display:none">
            <input type="button" id="btnVer_IngresarVacuna" runat="server" />
            <input type="button" id="btnOK_IngresarVacuna" />
            <input type="button" id="btnCancel_IngresarVacuna" />
        </div>       
    </asp:panel> 
    </ContentTemplate>        
    </asp:UpdatePanel>   