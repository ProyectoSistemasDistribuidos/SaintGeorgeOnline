...
Partial Class Controles_IngresarTiposCaracteristicasPiel
...
#Region "Eventos"
    ...
    End Sub
    Protected Sub btnGrabar_IngresarTiposCaracteristicasPiel_Click()
        Try
        ...
        End Try
    End Sub
    Protected Sub btnCerrar_IngresarTiposCaracteristicasPiel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
...
#Region "Métodos Públicos"
    ...
    Public Sub ocultarModal()
        ...
        Me.ModalPopupExtender_IngresarTiposCaracteristicasPiel.Hide()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub mostrarModal()
        ...
        Me.ModalPopupExtender_IngresarTiposCaracteristicasPiel.Show()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub Grabar()
        ...
        Dim obj_BE_TiposCaracteristicasPiel As New be_TiposCaracteristicasPiel
        ...
        obj_BE_TiposCaracteristicasPiel.Descripcion = Me.tbDescripcion.Text.Trim
        usp_valor = obj_BL_TiposCaracteristicasPiel.FUN_INS_TipoCaracteristicaPiel(obj_BE_TiposCaracteristicasPiel, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
...
#Region "Métodos Privados"
    ...
    Private Sub actualizarComboPadre()
        ...
        Dim obj_BL_TiposCaracteristicasPiel As New bl_TiposCaracteristicasPiel
        Dim obj_BE_TiposCaracteristicasPiel As New be_TiposCaracteristicasPiel
        Dim int_CodigoTipoTiposCaracteristicasPiel As Integer = obj_BE_TiposCaracteristicasPiel.CodigoCaracteristicaPiel
        Dim ds_Lista As DataSet = obj_BL_TiposCaracteristicasPiel.FUN_LIS_TipoCaracteristicaPiel(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 1)
