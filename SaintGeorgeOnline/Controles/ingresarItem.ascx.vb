...
Partial Class Controles_ingresarItem
...
#Region "Eventos"
    ...
    Protected Sub btnGrabar_IngresarItem_Click()
        Try
    ...
    Protected Sub btnCerrar_IngresarItem_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
...
#Region "Métodos Públicos"
    ...
    Public Sub ocultarModal()
        ...
        Me.ModalPopupExtender_IngresarItem.Hide()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub mostrarModal()
        ...
        Me.ModalPopupExtender_IngresarItem.Show()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub Grabar()
        ...
        Dim obj_BE_Item As New be_Item
        Dim obj_BL_Item As New bl_Item
        ...
        obj_BE_Item.Descripcion = Me.tbDescripcion.Text.Trim
        obj_BE_Item.CodigoTipoItem = Me.ddlTipo.SelectedValue

        usp_valor = obj_BL_Item.FUN_INS_Item(obj_BE_Item, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
...
#Region "Métodos Privados"
    ...
    Private Sub cargarComboTipo()
        ...
        Dim obj_BL_TipoItem As New bl_TipoItem
        ...
        Dim ds_Lista As DataSet = obj_BL_TipoItem.FUN_LIS_TipoItem(str_Descripcion, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Controles.llenarCombo(Me.ddlTipo, ds_Lista, "Codigo", "Descripcion", False, True)
    ...
    Private Function validarGrabar(ByRef str_Mensaje As String) As Boolean
        ...
        If ddlTipo.SelectedValue = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 3, "Tipo")
            result = False
        End If
    ...
    Private Sub actualizarComboPadre()
        ...
        Dim int_CodigoUsuario As Integer = Me.Obtener_CodigoUsuarioLogueado
        Dim obj_BL_Item As New bl_Item
        Dim ds_Lista As DataSet = obj_BL_Item.FUN_LIS_Item(str_Descripcion, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        ...
        Controles.llenarCombo(combo, ds_Lista, "CodigoItem", "Descripcion", False, True)
