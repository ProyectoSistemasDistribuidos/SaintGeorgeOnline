...
Partial Class Controles_ingresarEnfermedad
...
#Region "Eventos"
    ...
    Protected Sub btnGrabar_IngresarEnfermedad_Click()
        Try
    ...
    Protected Sub btnCerrar_IngresarEnfermedad_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
...
#Region "Métodos Públicos"
    ...
    Public Sub ocultarModal()
        ...
        Me.ModalPopupExtender_IngresarEnfermedad.Hide()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub mostrarModal()
        ...
        Me.ModalPopupExtender_IngresarEnfermedad.Show()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub Grabar()
        ...
        obj_BE_Enfermedad.Descripcion = Me.tbDescripcion.Text.Trim
        usp_valor = obj_BL_Enfermedad.FUN_INS_Enfermedad(obj_BE_Enfermedad, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
...
#Region "Métodos Privados"
    ...
    Private Sub actualizarComboPadre()
        ...
        Dim int_CodigoUsuario As Integer = Me.Obtener_CodigoTipoUsuarioLogueado
        Dim obj_BL_Enfermedad As New bl_Enfermedades
        Dim ds_Lista As DataSet = obj_BL_Enfermedad.FUN_LIS_Enfermedad(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
