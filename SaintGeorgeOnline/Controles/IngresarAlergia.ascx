<%@ Control Language="VB" AutoEventWireup="false" CodeFile="IngresarAlergia.ascx.vb" Inherits="Controles_IngresarAlergia" %>
<style type="text/css">   
    .miTextBox{
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel_IngresarAlergias" runat="server">
    <ContentTemplate>      
    <atk:ModalPopupExtender ID="ModalPopupExtender_IngresarAlergias" runat="server"
        PopupControlID="Panel_IngresarAlergias"
        TargetControlID="btnVer_IngresarAlergias"
        OkControlID="btnOK_IngresarAlergias" 
        CancelControlID="btnCancel_IngresarAlergias"
        BackgroundCssClass="modalBackground" 
        Drag="True" PopupDragHandleControlID="dragCtrl_IngresarAlergias" Enabled="True" />      
    <asp:panel id="Panel_IngresarAlergias" BackColor="White" BorderColor="Black" BorderWidth="1" runat="server" style="width: 500px; display: none;">
        <table cellpadding="0" cellspacing="0" border="0" id="panelRegistro" style="width: 500px;">          
            <tr>
                ...
                <td style="width: 440px; height: 26px; cursor: pointer;" align="left" valign="middle" class="header" colspan="2" id="dragCtrl_IngresarAlergias">                
                    <span style="font-weight:bold; font-size:11px; font-family:Arial; cursor: pointer;">
                        <asp:Label ID="lbltitulo" runat="server" text="Registro de Alergia" />
                    </span>
                </td>
                <td style="width: 30px; height: 26px" align="right" valign="middle" class="header">
                    <asp:ImageButton ID="btnCerrar_IngresarAlergias" runat="server" Width="16px" Height="15px"
                        ImageUrl="~/App_Themes/Imagenes/cross_icon_normal.png"
                        onclick="btnCerrar_IngresarAlergias_Click" ToolTip="Cerrar Panel"/>                                        
                </td>
            </tr>
            <tr><td colspan="4">
            ...
            <tr>
                <td style="width: 80px; height: 25px;" align="left" valign="middle">
                    <span>Tipo de alergia :&nbsp;</span><span class="camposObligatorios">(*)</span>
                </td>
                <td style="min-width: 360px; height: 25px;" align="left" valign="bottom">
                <asp:HiddenField ID="hd_Codigo" runat="server" />
                    <asp:DropDownList ID="ddlTipo" runat="server" Height="18px" Width="235px" AutoPostBack="False">
                    </asp:DropDownList>
                </td>
            ...
            <tr>
                <td colspan="4" align="center" valign="middle"> 
                    <asp:ImageButton ID="btnGrabar_IngresarAlergias" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnGrabar_IngresarAlergias_Click" />&nbsp;
                    <asp:ImageButton ID="btnCancelar_IngresarAlergias" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnCerrar_IngresarAlergias_Click" CausesValidation="False"/>
                </td>
            </tr>   
            <tr><td colspan="4"><br /></td></tr>             
        </table>  
        <div id="controlIngresarAlergias" style="display:none">
            <input type="button" id="btnVer_IngresarAlergias" runat="server" />
            <input type="button" id="btnOK_IngresarAlergias" />
            <input type="button" id="btnCancel_IngresarAlergias" />
        </div>       
    </asp:panel> 
    </ContentTemplate>        
    </asp:UpdatePanel>  