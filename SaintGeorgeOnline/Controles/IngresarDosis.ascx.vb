...
Partial Class Controles_IngresarDosis
...
#Region "Eventos"
    ...
    Protected Sub btnGrabar_IngresarDosis_Click()
        Try
    ...
    Protected Sub btnCerrar_IngresarDosis_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
...
#Region "Métodos Públicos"
    ...
    Public Sub ocultarModal()
        ...
        Me.ModalPopupExtender_IngresarDosis.Hide()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub mostrarModal()
        ...
        Me.ModalPopupExtender_IngresarDosis.Show()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub Grabar()
        ...
        Dim obj_BE_Dosis As New be_DosisVacunas
        Dim obj_BL_Dosis As New bl_DosisVacunas
        Dim usp_mensaje As String = ""
        ...
        obj_BE_Dosis.Descripcion = Me.tbDescripcion.Text.Trim
        usp_valor = obj_BL_Dosis.FUN_INS_DosisVacuna(obj_BE_Dosis, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
...
#Region "Métodos Privados"
    ...
    Private Sub actualizarComboPadre()
        ...
        Dim int_CodigoUsuario As Integer = Me.Obtener_CodigoTipoUsuarioLogueado
        Dim obj_BL_Dosis As New bl_DosisVacunas
        Dim ds_Lista As DataSet = obj_BL_Dosis.FUN_LIS_DosisVacuna(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
