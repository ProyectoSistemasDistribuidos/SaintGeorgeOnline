<%@ Control Language="VB" AutoEventWireup="false" CodeFile="IngresarTiposCaracteristicasPiel.ascx.vb" Inherits="Controles_IngresarTiposCaracteristicasPiel" %>
<style type="text/css">   
    .miTextBox{
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel_IngresarTiposCaracteristicasPiel" runat="server">
    <ContentTemplate>      
    <atk:ModalPopupExtender ID="ModalPopupExtender_IngresarTiposCaracteristicasPiel" runat="server"
        PopupControlID="Panel_IngresarTiposCaracteristicasPiel"
        TargetControlID="btnVer_IngresarTiposCaracteristicasPiel"
        OkControlID="btnOK_IngresarTiposCaracteristicasPiel" 
        CancelControlID="btnCancel_IngresarTiposCaracteristicasPiel"
        BackgroundCssClass="modalBackground"  
        Drag="True" PopupDragHandleControlID="dragCtrl_IngresarTiposCaracteristicasPiel" Enabled="True" />      
    <asp:panel id="Panel_IngresarTiposCaracteristicasPiel" BackColor="White" BorderColor="Black" BorderWidth="1" runat="server" style="width: 500px; display: none;">
        <table cellpadding="0" cellspacing="0" border="0" id="panelRegistro" style="width: 500px;">          
            <tr>
                ...
                <td style="width: 440px; height: 26px; cursor: pointer;" align="left" valign="middle" class="header" colspan="2" id="dragCtrl_IngresarTiposCaracteristicasPiel">                
                    <span style="font-weight:bold; font-size:11px; font-family:Arial; cursor: pointer;">
                        <asp:Label ID="lbltitulo" runat="server" text="Registro de TiposCaracteristicasPiel" />
                    </span>
                </td>
                <td style="width: 30px; height: 26px" align="right" valign="middle" class="header">
                    <asp:ImageButton ID="btnCerrar_IngresarTiposCaracteristicasPiel" runat="server" Width="16px" Height="15px"
                        ImageUrl="~/App_Themes/Imagenes/cross_icon_normal.png"
                        onclick="btnCerrar_IngresarTiposCaracteristicasPiel_Click" ToolTip="Cerrar Panel"/>                                        
                </td>
            </tr>
            <tr><td colspan="4">
            ...
            <tr>
                <td colspan="4" align="center" valign="middle"> 
                    <asp:ImageButton ID="btnGrabar_IngresarTiposCaracteristicasPiel" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnGrabar_IngresarTiposCaracteristicasPiel_Click" />&nbsp;
                    <asp:ImageButton ID="btnCancelar_IngresarTiposCaracteristicasPiel" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnCerrar_IngresarTiposCaracteristicasPiel_Click" CausesValidation="False"/>
                </td>
            </tr>   
            <tr><td colspan="4"><br /></td></tr>             
        </table>  
        <div id="controlIngresarTiposCaracteristicasPiel" style="display:none">
            <input type="button" id="btnVer_IngresarTiposCaracteristicasPiel" runat="server" />
            <input type="button" id="btnOK_IngresarTiposCaracteristicasPiel" />
            <input type="button" id="btnCancel_IngresarTiposCaracteristicasPiel" />
        </div>       
    </asp:panel> 
    </ContentTemplate>        
    </asp:UpdatePanel> 