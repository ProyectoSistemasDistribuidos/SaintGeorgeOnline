...
Partial Class Controles_IngresarTipoAlergia
...
#Region "Eventos"
    ...
    End Sub
    Protected Sub btnGrabar_IngresarTipoAlergia_Click()
        Try
        ...
        End Try
    End Sub
    Protected Sub btnCerrar_IngresarTipoAlergia_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
...
#Region "Métodos Públicos"
    ...
    Public Sub ocultarModal()
        ...
        Me.ModalPopupExtender_IngresarTipoAlergia.Hide()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub mostrarModal()
        ...
        Me.ModalPopupExtender_IngresarTipoAlergia.Show()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub Grabar()
        ...
        Dim obj_BE_TiposAlergias As New be_TiposAlergias
        ...
        obj_BE_TiposAlergias.Descripcion = Me.tbDescripcion.Text.Trim
        usp_valor = obj_BL_TiposAlergias.FUN_INS_TipoAlergia(obj_BE_TiposAlergias, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
...
#Region "Métodos Privados"
    ...
    Private Sub actualizarComboPadre()
        ...
        Dim obj_BL_TiposAlergias As New bl_TiposAlergias
        Dim obj_BE_TiposAlergias As New be_TiposAlergias
        Dim int_CodigoTipoAlergia As Integer = obj_BE_TiposAlergias.CodigoTipoAlergia
        Dim ds_Lista As DataSet = obj_BL_Tiposalergias.FUN_LIS_TipoAlergia(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 1)
