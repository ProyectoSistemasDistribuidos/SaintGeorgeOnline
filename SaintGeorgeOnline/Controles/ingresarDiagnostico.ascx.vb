...
Partial Class Controles_ingresarDiagnostico
...
#Region "Eventos"
    ...
    Protected Sub btnGrabar_IngresarDiagnostico_Click()
        Try
    ...
    Protected Sub btnCerrar_IngresarDiagnostico_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
...
#Region "Métodos Públicos"
    ...
    Public Sub ocultarModal()
        ...
        Me.ModalPopupExtender_IngresarDiagnostico.Hide()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub mostrarModal()
        ...
        Me.ModalPopupExtender_IngresarDiagnostico.Show()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub Grabar()
        ...
        obj_BE_Diagnostico.Descripcion = Me.tbDescripcion.Text.Trim
        usp_valor = obj_BL_Diagnostico.FUN_INS_Diagnostico(obj_BE_Diagnostico, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
