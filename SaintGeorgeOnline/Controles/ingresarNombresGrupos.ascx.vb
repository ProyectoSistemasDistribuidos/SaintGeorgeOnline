...
Partial Class Controles_ingresarNombresGrupos
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'tbDescripcion.Attributes.Add("onkeypress", "return ValidarPuntoDecimal(this,event);")
        'tbDescripcion.Attributes.Add("onkeypress", "return ValidarPuntoDecimal(this,event);")

    End Sub

    Protected Sub btnGrabar_IngresarNombresGrupos_Click()
        Try
    ...
    Protected Sub btnCerrar_IngresarNombresGrupos_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
...
#Region "Métodos Públicos"
    ...
    Public Sub ocultarModal()
        ...
        Me.ModalPopupExtender_IngresarNombresGrupos.Hide()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub mostrarModal()
        ...
        Me.ModalPopupExtender_IngresarNombresGrupos.Show()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub Grabar()
        ...
        Dim obj_BE_NombresGrupos As New be_NombresGrupos
        Dim obj_BL_NombresGrupos As New bl_NombresGrupos
        ...
        obj_BE_NombresGrupos.NombreGrupo = Me.tbDescripcion.Text.Trim
        obj_BE_NombresGrupos.Abreviatura = Me.tbAbreviatura.Text.Trim

        usp_valor = obj_BL_NombresGrupos.FUN_INS_NombresGrupos(obj_BE_NombresGrupos, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
...
#Region "Métodos Privados"
    ...
    Private Sub actualizarComboPadre()
        ...
        Dim int_CodigoUsuario As Integer = Me.Obtener_CodigoUsuarioLogueado
        Dim obj_BL_NombresGrupos As New bl_NombresGrupos
        Dim ds_Lista As DataSet = obj_BL_NombresGrupos.FUN_LIS_NombresGrupos(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
