<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ingresarProcedimiento.ascx.vb" Inherits="Controles_ingresarProcedimiento" %>
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel_IngresarProdecimiento" runat="server">
    <ContentTemplate>  
    <atk:ModalPopupExtender ID="ModalPopupExtender_IngresarProdecimiento" runat="server"
        PopupControlID="Panel_IngresarProdecimiento"
        TargetControlID="btnVer_IngresarProdecimiento"
        OkControlID="btnOK_IngresarProdecimiento" 
        CancelControlID="btnCancel_IngresarProdecimiento"
        BackgroundCssClass="modalBackground"  
        Drag="True" PopupDragHandleControlID="dragCtrl_IngresarProdecimiento" Enabled="True" />      
    <asp:panel id="Panel_IngresarProdecimiento" BackColor="White" BorderColor="Black" BorderWidth="1" runat="server" style="width: 500px; display: none;">
        <table cellpadding="0" cellspacing="0" border="0" id="panelRegistro" style="width: 500px;">          
            <tr>
                ...
                <td style="width: 440px; height: 26px; cursor: pointer;" align="left" valign="middle" class="header" colspan="2" id="dragCtrl_IngresarProdecimiento">                
                    <span style="font-weight:bold; font-size:11px; font-family:Arial; cursor: pointer;">
                        <asp:Label ID="lbltitulo" runat="server" text="Registro de Procedimiento de Enfermería" />
                    </span>
                </td>
                <td style="width: 30px; height: 26px" align="right" valign="middle" class="header">
                    <asp:ImageButton ID="btnCerrar_IngresarProdecimiento" runat="server" Width="16px" Height="15px"
                        ImageUrl="~/App_Themes/Imagenes/cross_icon_normal.png"
                        onclick="btnCerrar_IngresarProdecimiento_Click" ToolTip="Cerrar Panel"/>                                        
                </td>
            </tr>
            <tr><td colspan="4">
            ...
            <tr>
                <td colspan="4" align="center" valign="middle"> 
                    <asp:ImageButton ID="btnGrabar_IngresarProdecimiento" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnGrabar_IngresarProdecimiento_Click" />&nbsp;
                    <asp:ImageButton ID="btnCancelar_IngresarProdecimiento" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnCerrar_IngresarProdecimiento_Click" CausesValidation="False"/>
                </td>
            </tr>   
            <tr><td colspan="4"><br /></td></tr>             
        </table>  
        <div id="controlIngresarProdecimiento" style="display:none">
            <input type="button" id="btnVer_IngresarProdecimiento" runat="server" />
            <input type="button" id="btnOK_IngresarProdecimiento" />
            <input type="button" id="btnCancel_IngresarProdecimiento" />
        </div>       
    </asp:panel> 
    </ContentTemplate>        
    </asp:UpdatePanel>   