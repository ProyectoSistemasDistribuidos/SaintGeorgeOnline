<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ingresarDiagnostico.ascx.vb" Inherits="Controles_ingresarDiagnostico" %>
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel_IngresarDiagnostico" runat="server">
    <ContentTemplate>      
    <atk:ModalPopupExtender ID="ModalPopupExtender_IngresarDiagnostico" runat="server"
        PopupControlID="Panel_IngresarDiagnostico"
        TargetControlID="btnVer_IngresarDiagnostico"
        OkControlID="btnOK_IngresarDiagnostico" 
        CancelControlID="btnCancel_IngresarDiagnostico"
        BackgroundCssClass="modalBackground" 
        Drag="True" PopupDragHandleControlID="dragCtrl_IngresarDiagnostico" Enabled="True" />      
    <asp:panel id="Panel_IngresarDiagnostico" BackColor="White" BorderColor="Black" BorderWidth="1" runat="server" style="width: 500px; display: none;">
        <table cellpadding="0" cellspacing="0" border="0" id="panelRegistro" style="width: 500px;">          
            <tr>
                ...
                <td style="width: 440px; height: 26px; cursor: pointer;" align="left" valign="middle" class="header" colspan="2" id="dragCtrl_IngresarDiagnostico">                
                    <span style="font-weight:bold; font-size:11px; font-family:Arial; cursor: pointer;">
                        <asp:Label ID="lbltitulo" runat="server" text="Registro de Diagnóstico" />
                    </span>
                </td>
                <td style="width: 30px; height: 26px" align="right" valign="middle" class="header">
                    <asp:ImageButton ID="btnCerrar_IngresarDiagnostico" runat="server" Width="16px" Height="15px"
                        ImageUrl="~/App_Themes/Imagenes/cross_icon_normal.png"
                        onclick="btnCerrar_IngresarDiagnostico_Click" ToolTip="Cerrar Panel"/>                                        
                </td>
            </tr>
            <tr><td colspan="4">
            ...
            <tr>
                <td colspan="4" align="center" valign="middle"> 
                    <asp:ImageButton ID="btnGrabar_IngresarDiagnostico" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnGrabar_IngresarDiagnostico_Click" />&nbsp;
                    <asp:ImageButton ID="btnCancelar_IngresarDiagnostico" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnCerrar_IngresarDiagnostico_Click" CausesValidation="False"/>
                </td>
            </tr>   
            <tr><td colspan="4"><br /></td></tr>             
        </table>  
        <div id="controlIngresarDiagnostico" style="display:none">
            <input type="button" id="btnVer_IngresarDiagnostico" runat="server" />
            <input type="button" id="btnOK_IngresarDiagnostico" />
            <input type="button" id="btnCancel_IngresarDiagnostico" />
        </div>       
    </asp:panel> 
    </ContentTemplate>        
    </asp:UpdatePanel>   
