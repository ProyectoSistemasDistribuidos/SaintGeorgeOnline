...
Partial Class Controles_ingresarProcedimiento
...
#Region "Eventos"
    ...
    Protected Sub btnGrabar_IngresarProdecimiento_Click()
        Try
    ...
    Protected Sub btnCerrar_IngresarProdecimiento_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
...
#Region "Métodos Públicos"
    ...
    Public Sub ocultarModal()
        ...
        Me.ModalPopupExtender_IngresarProdecimiento.Hide()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub mostrarModal()
        ...
        Me.ModalPopupExtender_IngresarProdecimiento.Show()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub Grabar()
        ...
        Dim obj_BE_ProcedimientosRealizados As New be_ProcedimientosRealizados
        ...
        obj_BE_ProcedimientosRealizados.Descripcion = Me.tbDescripcion.Text.Trim
        usp_valor = obj_BL_ProcedimientosRealizados.FUN_INS_ProcedimientoRealizado(obj_BE_ProcedimientosRealizados, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
...
#Region "Métodos Privados"
    ...
    Private Sub actualizarComboPadre()
        ...
        Dim int_CodigoUsuario As Integer = Me.Obtener_CodigoUsuarioLogueado
        Dim obj_BL_ProcedimientosRealizados As New bl_ProcedimientosRealizados
        Dim ds_Lista As DataSet = obj_BL_ProcedimientosRealizados.FUN_LIS_ProcedimientoRealizado(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
