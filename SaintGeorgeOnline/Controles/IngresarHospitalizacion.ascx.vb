...
Partial Class Controles_IngresarHospitalizacion
...
#Region "Eventos"
    ...
    End Sub
    Protected Sub btnGrabar_IngresarHospitalizacion_Click()
        Try
        ...
        End Try
    End Sub
    Protected Sub btnCerrar_IngresarHospitalizacion_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
...
#Region "Métodos Públicos"
    ...
    Public Sub ocultarModal()
        ...
        Me.ModalPopupExtender_IngresarHospitalizacion.Hide()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub mostrarModal()
        ...
        Me.ModalPopupExtender_IngresarHospitalizacion.Show()
        If Me.tieneModalPadre Then
            Me.mostrarModalPadre()
        End If
    ...
    Public Sub Grabar()
        ...
        Dim obj_BE_Hospitalizacion As New be_MotivosHospitalizaciones
        Dim obj_BL_Hospitalizacion As New bl_MotivosHospitalizaciones
        Dim usp_mensaje As String = ""
        ...
        obj_BE_Hospitalizacion.Descripcion = Me.tbDescripcion.Text.Trim
        usp_valor = obj_BL_Hospitalizacion.FUN_INS_MotivoHospitalizacion(obj_BE_Hospitalizacion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
...
#Region "Métodos Privados"
    ...
    Private Sub actualizarComboPadre()
        ...
        Dim obj_BL_Hospitalizacion As New bl_MotivosHospitalizaciones
        Dim obj_BE_Hospitalizacion As New be_MotivosHospitalizaciones
        Dim int_CodigoTipoHospitalizacion As Integer = obj_BE_Hospitalizacion.CodigoMotivoHospitalizacion
        Dim ds_Lista As DataSet = obj_BL_Hospitalizacion.FUN_LIS_MotivoHospitalizacion(str_Descripcion, 1, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 1)
