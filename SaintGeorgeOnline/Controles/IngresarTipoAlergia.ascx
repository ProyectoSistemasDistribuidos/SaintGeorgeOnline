<%@ Control Language="VB" AutoEventWireup="false" CodeFile="IngresarTipoAlergia.ascx.vb" Inherits="Controles_IngresarTipoAlergia" %>
<style type="text/css">   
    .miTextBox{
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel_IngresarTipoAlergia" runat="server">
    <ContentTemplate>      
    <atk:ModalPopupExtender ID="ModalPopupExtender_IngresarTipoAlergia" runat="server"
        PopupControlID="Panel_IngresarTipoAlergia"
        TargetControlID="btnVer_IngresarTipoAlergia"
        OkControlID="btnOK_IngresarTipoAlergia" 
        CancelControlID="btnCancel_IngresarTipoAlergia"
        BackgroundCssClass="modalBackground"  
        Drag="True" PopupDragHandleControlID="dragCtrl_IngresarTipoAlergia" Enabled="True" />      
    <asp:panel id="Panel_IngresarTipoAlergia" BackColor="White" BorderColor="Black" BorderWidth="1" runat="server" style="width: 500px; display: none;">
        <table cellpadding="0" cellspacing="0" border="0" id="panelRegistro" style="width: 500px;">          
            <tr>
                ...
                <td style="width: 440px; height: 26px; cursor: pointer;" align="left" valign="middle" class="header" colspan="2" id="dragCtrl_IngresarTipoAlergia">                
                    <span style="font-weight:bold; font-size:11px; font-family:Arial; cursor: pointer;">
                        <asp:Label ID="lbltitulo" runat="server" text="Registro de TipoAlergia" />
                    </span>
                </td>
                <td style="width: 30px; height: 26px" align="right" valign="middle" class="header">
                    <asp:ImageButton ID="btnCerrar_IngresarTipoAlergia" runat="server" Width="16px" Height="15px"
                        ImageUrl="~/App_Themes/Imagenes/cross_icon_normal.png"
                        onclick="btnCerrar_IngresarTipoAlergia_Click" ToolTip="Cerrar Panel"/>                                        
                </td>
            </tr>
            <tr><td colspan="4">
            ...
            <tr>
                <td colspan="4" align="center" valign="middle"> 
                    <asp:ImageButton ID="btnGrabar_IngresarTipoAlergia" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnGrabar_IngresarTipoAlergia_Click" />&nbsp;
                    <asp:ImageButton ID="btnCancelar_IngresarTipoAlergia" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnCerrar_IngresarTipoAlergia_Click" CausesValidation="False"/>
                </td>
            </tr>   
            <tr><td colspan="4"><br /></td></tr>             
        </table>  
        <div id="controlIngresarTipoAlergia" style="display:none">
            <input type="button" id="btnVer_IngresarTipoAlergia" runat="server" />
            <input type="button" id="btnOK_IngresarTipoAlergia" />
            <input type="button" id="btnCancel_IngresarTipoAlergia" />
        </div>       
    </asp:panel> 
    </ContentTemplate>        
    </asp:UpdatePanel> 