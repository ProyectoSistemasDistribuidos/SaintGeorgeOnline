<%@ Control Language="VB" AutoEventWireup="false" CodeFile="IngresarOperaciones.ascx.vb" Inherits="Controles_IngresarOperaciones" %>
<style type="text/css">   
    .miTextBox{
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel_IngresarOperaciones" runat="server">
    <ContentTemplate>      
    <atk:ModalPopupExtender ID="ModalPopupExtender_IngresarOperaciones" runat="server"
        PopupControlID="Panel_IngresarOperaciones"
        TargetControlID="btnVer_IngresarOperaciones"
        OkControlID="btnOK_IngresarOperaciones" 
        CancelControlID="btnCancel_IngresarOperaciones"
        BackgroundCssClass="modalBackground"  
        Drag="True" PopupDragHandleControlID="dragCtrl_IngresarOperaciones" Enabled="True" />      
    <asp:panel id="Panel_IngresarOperaciones" BackColor="White" BorderColor="Black" BorderWidth="1" runat="server" style="width: 500px; display: none;">
        <table cellpadding="0" cellspacing="0" border="0" id="panelRegistro" style="width: 500px;">          
            <tr>
                ...
                <td style="width: 440px; height: 26px; cursor: pointer;" align="left" valign="middle" class="header" colspan="2" id="dragCtrl_IngresarOperaciones">                
                ...
                <td style="width: 30px; height: 26px" align="right" valign="middle" class="header">
                    <asp:ImageButton ID="btnCerrar_IngresarOperaciones" runat="server" Width="16px" Height="15px"
                        ImageUrl="~/App_Themes/Imagenes/cross_icon_normal.png"
                        onclick="btnCerrar_IngresarOperaciones_Click" ToolTip="Cerrar Panel"/>                                        
                </td>
            </tr>
            <tr><td colspan="4">
            ...
            <tr>
                <td colspan="4" align="center" valign="middle"> 
                    <asp:ImageButton ID="btnGrabar_IngresarOperaciones" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnGrabar_IngresarOperaciones_Click" />&nbsp;
                    <asp:ImageButton ID="btnCancelar_IngresarOperaciones" runat="server" Width="84px" Height="19px" 
                            ...
                            onclick="btnCerrar_IngresarOperaciones_Click" CausesValidation="False"/>
                </td>
            </tr>   
            <tr><td colspan="4"><br /></td></tr>             
        </table>  
        <div id="controlIngresarOperaciones" style="display:none">
            <input type="button" id="btnVer_IngresarOperaciones" runat="server" />
            <input type="button" id="btnOK_IngresarOperaciones" />
            <input type="button" id="btnCancel_IngresarOperaciones" />
        </div>       
    </asp:panel> 
    </ContentTemplate>        
    </asp:UpdatePanel> 