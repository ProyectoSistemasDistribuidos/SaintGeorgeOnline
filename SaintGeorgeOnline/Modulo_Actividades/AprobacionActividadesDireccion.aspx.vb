...
Partial Class Modulo_Actividades_AprobacionActividadesDireccion
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Approval Activities - Headmaster")
...
#Region "Metodos"
    ...
    Private Sub Buscar()
        ...
        Dim int_NivelAprobacion As Integer = 2
    ...
    Private Sub Grabar(ByVal int_CodigoActividad As Integer, ByVal int_CodigoAprobacion As Integer, ByVal int_CodigoEstado As Integer, ByVal str_Observacion As String)
        ...
        If usp_valor > 0 Then
            ...
            If int_CodigoEstado = 2 Then ' aprobado
                ...
                dcValPro("NivelAprobacion") = 3
                dcValPro("codTrabajador") = int_CodigoUsuario
                dcValPro("codActividad") = int_CodigoActividad
                ...
                Dim NombreJN As String = ""
                Dim NombreDir As String = ""

                Nombre = ds_lista.Tables(0).Rows(0).Item("nombreAprobar").ToString
                listaCorreo.Add(ds_lista.Tables(0).Rows(0).Item("correo").ToString)

                For Each dr As DataRow In ds_lista.Tables(1).Rows
                    listaCorreoCo.Add(dr.Item("correo"))
                    NombreJN = NombreJN + dr.Item("nombreAprobar") + ", "
                Next
                NombreJN = NombreJN.Trim
                NombreJN = NombreJN.Substring(0, NombreJN.Length - 1)

                NombreDir = ds_lista.Tables(2).Rows(0).Item("nombreAprobar").ToString

                Dim estadoEnvio As Integer = 0
                Dim mensaje As String = ""
                Dim asunto As String = "Aprobación de Actividad"
                Dim cabecera As String = "Estimado(a) " & Nombre & ". <br>" & _
                                         "Se informa que la siguiente actividad ha sido aprobada por Dirección " & NombreDir & ".<br><br><br>"
