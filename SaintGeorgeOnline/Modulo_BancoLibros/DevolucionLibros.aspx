<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="DevolucionLibros.aspx.vb" Inherits="Modulo_BancoLibros_DevolucionLibros" title="Página sin título" %>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0px red; width:820px;">                                
                                                    <tr>
                                                        <td valign="top" align="left" style="width :820px;">
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" border="0" style="width:815px;">                                
                                                            <tr>
                                                                <td style="width:25px; height: 110px; color: #FFFFFF; font-size:10px; background-color:#0a0f14;" align="center" valign="bottom"> 
                                                                    <div style="width: 25px; height: 110px; border: solid 0px blue; position: relative;">
                                                                    <b><span style="position: absolute; bottom: 0; left: 8px;">N°</span></b>
                                                                    </div>
                                                                </td>
                                                                <td style="width: 245px; height: 110px; color: #FFFFFF; font-size:10px; background-color:#0a0f14;" align="left" valign="bottom">    
                                                                    <div style="width: 245px; height: 110px; border: solid 0px red; position: relative;">
                                                                    <b><span style="position: absolute; bottom: 0; left: 8px;">Alumnos</span></b>
                                                                    </div>
                                                                </td>
                                                                <td style="width: 32px; height: 110px; color: #FFFFFF; font-size:10px; background-color:#0a0f14;" align="center" valign="bottom">  
                                                                    
                                                                    <b><span class="bt">Todos</span></b>
                                                                    
                                                                </td>
                                                                <td style="width: 513px; height: 110px; color: #FFFFFF; font-size:10px; background-color:#0a0f14;" align="left">                                                                    
                                                                    <asp:HiddenField ID="hd_activado" runat="server" />
                                                                    <div style="width: 513px; height: 110px; border: solid 0px red; position: relative;"> 
                                                                    <asp:DataList ID="dl_NombreLibros" runat="server" RepeatDirection="Horizontal"> 
                                                                        <ItemStyle Width="25px" Height="110px" />                                                                 
                                                                        <ItemTemplate> 
                                                                            <div style="width: 25px; height: 110px; border: solid 0px red;">
                                                                            <table cellpadding="0" cellspacing="0" border="0" style="width: 25px; height: 110px;">
                                                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td colspan="4" style="height: 5px; width: 815px; background-color: #0a0f14">
                                                                <div style="width: 815px; height: 5px; border: solid 0px red; display: none">
                                                                &nbsp;
                                                                </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="4" style="width: 815px;" align="left" valign="middle">  
    ...
    $(document).ready(function() {
        ...
        function miFocus(index) {
            if (grid.rows.length > 0) {
                ...
                $('#miPanelGridview').scrollTo($(row), 300);
            }
        }
        ...
        $('input:checkbox[id$=chkAll]', grid).click(function(e) {
            if (grid.rows.length > 0) {
                ...
                var table = $('table#' + $(child).attr('id'));
                var SpansList = $('table#' + $(child).attr('id')).find('span');
                var ChecksList = $('table#' + $(child).attr('id')).find('input:checkbox');

                $.each(ChecksList, function(e, checkbox) {
                    if ($(checkbox).attr('style') != "visibility:hidden") { //if ( checkbox.disabled == false ) {
                    ...
                    for (i = 0; i < grid.rows.length; i++) {
                        ...
                        if (child != undefined) {
                            ...
                            if (i == rowIndex) {
                                ...
                                $.each(ChecksList, function(e, checkbox) {
                                    if ($(checkbox).attr('style') == "visibility:hidden") {
