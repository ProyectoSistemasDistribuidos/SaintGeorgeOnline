...
''' <remarks>
''' Código del Modulo:    3
''' Código de la Opción:  38
''' </remarks>
Partial Class Modulo_Permisos_Panel_Configuraciones_Menu
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Configuraciones de Menús")
...
#Region "Metodos"
    ...
    ''' <summary>
    ''' Crea el menú de opciones según el usuario logueado.
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub cargarSubMenusConfiguracion()
        ...
        Try
            ...
            While cont_grupos <= dt_Grupos.Rows.Count - 1
                ...
                If dt_Grupos.Rows(cont_grupos).Item("BM_CodigoBloque").ToString = 3 Then

                    dt_Modulos.RowFilter = " 1=1 and SBM_CodigoSubBloquePadre = 38 and BM_CodigoBloque = " & dt_Grupos.Rows(cont_grupos).Item("BM_CodigoBloque").ToString
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(3, 38, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(3, 38)
    End Sub
