<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="CalificativosEvaluacion.aspx.vb" Inherits="Mantenimientos_Seguimientos_CalificativosEvaluacion" title="Página sin título" %>
                                ...
                                <asp:TemplateField HeaderText="Descripción">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="570px">
                                        <tr>
                                            ...
                                            <td style="width:470px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting" runat="server" 
                                                ToolTip="Descendente"    
