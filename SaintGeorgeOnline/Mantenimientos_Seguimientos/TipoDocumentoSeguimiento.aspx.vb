...
Imports System.IO
''' <summary>
''' Modulo de Mantenimiento de TipoDocumentoSeguimiento
''' </summary>
''' <remarks>
''' Código del Modulo:    
''' Código de la Opción: 
''' </remarks>
Partial Class Mantenimientos_Seguimientos_TipoDocumentoSeguimiento
    Inherits System.Web.UI.Page
    Private cod_Modulo As Integer = 1
    Private cod_Opcion As Integer = 1
    Public obj_BL_TipoDocumentoSeguimiento As New bl_TipoDocumentoSeguimiento

#Region "Eventos"

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Tipo de Documento Seguimiento")
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        str_TituloCabeceraArchivo = "TipoDocumentoSeguimiento"
    ...
    ''' <summary>
    ''' Lista los datos de TipoDocumento    
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Edgar Chang 
    ''' Fecha de Creación:     01/08/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_TipoDocumentoSeguimiento.FUN_LIS_TipoDocumentoSeguimiento(str_Descripcion, int_Estado, int_CodigoUsuario, _
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_TipoDocumentoSeguimiento.FUN_GET_TipoDocumentoSeguimiento(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        Dim obj_BL_TipoDocumentoSeguimiento As New bl_TipoDocumentoSeguimiento
        Dim usp_mensaje As String = ""
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_TipoDocumentoSeguimiento.FUN_DEL_TipoDocumentoSeguimiento(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_TipoDocumentoSeguimiento As New be_TipoDocumentoSeguimiento
        Dim obj_BL_TipoDocumentoSeguimiento As New bl_TipoDocumentoSeguimiento
        ...
        obj_BE_TipoDocumentoSeguimiento.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_TipoDocumentoSeguimiento.FUN_INS_TipoDocumentoSeguimiento(obj_BE_TipoDocumentoSeguimiento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_TipoDocumentoSeguimiento.CodigoTipoDocumento = CInt(BoolGrabar)
            usp_valor = obj_BL_TipoDocumentoSeguimiento.FUN_UPD_TipoDocumentoSeguimiento(obj_BE_TipoDocumentoSeguimiento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
