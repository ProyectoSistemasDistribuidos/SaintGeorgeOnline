...
''' <summary>
''' Modulo de Mantenimiento de Calificativos de Evaluación
''' </summary>
''' <remarks>
''' Código del Modulo:    
''' Código de la Opción:  
''' </remarks>
Partial Class Mantenimientos_Seguimientos_CalificativosEvaluacion
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Calificativos de Evaluación")
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        dt = Datos.agregarColumna(dt, "Leyenda en Ingles", "String")
        dt = Datos.agregarColumna(dt, "Leyenda en Español", "String")
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            ...
            auxDR.Item("Leyenda en Ingles") = dr.Item("LeyendaIngles").ToString
            auxDR.Item("Leyenda en Español") = dr.Item("LeyendaEspanol").ToString
            dt.Rows.Add(auxDR)
            cont += 1
        Next
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Calificativos")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Calificativos")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Calificativos")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_CalificativosEvaluacion As New bl_CalificativosEvaluacion
            ds_Lista = obj_BL_CalificativosEvaluacion.FUN_LIS_CalificativosEvaluacion(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_CalificativosEvaluacion.FUN_GET_CalificativosEvaluacion(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_CalificativosEvaluacion.FUN_DEL_CalificativosEvaluacion(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_CalificativosEvaluacion As New be_CalificativosEvaluacion
        Dim obj_BL_CalificativosEvaluacion As New bl_CalificativosEvaluacion
        ...
        obj_BE_CalificativosEvaluacion.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_CalificativosEvaluacion.FUN_INS_CalificativosEvaluacion(obj_BE_CalificativosEvaluacion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_CalificativosEvaluacion.CodigoCalificativo = CInt(BoolGrabar)
            usp_valor = obj_BL_CalificativosEvaluacion.FUN_UPD_CalificativosEvaluacion(obj_BE_CalificativosEvaluacion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
