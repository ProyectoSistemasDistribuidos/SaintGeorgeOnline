...
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  14
''' </remarks>
Partial Class Mantenimientos_Enfermeria_Vacunas
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Vacunas")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 14)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 14)
        Master.SeteoPermisosAcciones(btnExportar, 14)
        Master.SeteoPermisosAcciones(btnGrabar, 14)
        Master.SeteoPermisosAcciones(btnNuevo, 14)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 14, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Try
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Vacunas")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Vacunas")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Vacunas")
        ...
        Catch ex As Exception
            ...
            MostrarSexyAlertBox("Error en la exportación", "Alert")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Vacuna.FUN_LIS_Vacuna(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 14)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Vacuna</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim int_CodigoUsuario As Integer = Me.Master.Obtener_CodigoUsuarioLogueado
        Dim int_CodigoTipoUsuario As Integer = Me.Master.Obtener_CodigoTipoUsuarioLogueado
        Dim ds_Lista As DataSet = obj_BL_Vacuna.FUN_GET_Vacuna(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 14)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Vacuna.FUN_DEL_Vacuna(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 14)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Vacuna As New be_Vacunas
        Dim obj_BL_Vacuna As New bl_Vacunas
        ...
        obj_BE_Vacuna.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Vacuna.FUN_INS_Vacuna(obj_BE_Vacuna, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 14)
        Else
            obj_BE_Vacuna.CodigoVacuna = CInt(BoolGrabar)
            usp_valor = obj_BL_Vacuna.FUN_UPD_Vacuna(obj_BE_Vacuna, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 14)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 14)
                Master.SeteoPermisosAcciones(btnActualizar, 14)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 14)
            End If
