<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="MotivosHospitalizaciones.aspx.vb" Inherits="Mantenimientos_Enfermeria_MotivosHospitalizaciones" title="Página sin título" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" 
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbDescripcion" runat="server" CssClass="miTextBox" Width="450px" Height="35px" Rows="2" TextMode="MultiLine" />
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
