...
''' <summary>
''' Modulo de Mantenimiento de IndicacionEnfermeria
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  9
''' </remarks>
Partial Class Mantenimientos_Enfermeria_IndicacionEnfermeria
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Indicación de Enfermeria")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 9)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 9)
        Master.SeteoPermisosAcciones(btnExportar, 9)
        Master.SeteoPermisosAcciones(btnGrabar, 9)
        Master.SeteoPermisosAcciones(btnNuevo, 9)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 9, int_CodigoAccion, str_DetalleError, "", 0)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Indicación de Enfermeria")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Indicación de Enfermeria")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Indicación de Enfermeria")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_IndicacionEnfermeria.FUN_LIS_IndicacionEnfermeria(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 9)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Indicación de Enfermeria</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     10/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_IndicacionEnfermeria.FUN_GET_IndicacionEnfermeria(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 9)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_IndicacionEnfermeria.FUN_DEL_IndicacionEnfermeria(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 9)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_IndicacionEnfermeria As New be_IndicacionEnfermeria
        Dim obj_BL_IndicacionEnfermeria As New bl_IndicacionEnfermeria
        ...
        obj_BE_IndicacionEnfermeria.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_IndicacionEnfermeria.FUN_INS_IndicacionEnfermeria(obj_BE_IndicacionEnfermeria, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 9)
        Else
            obj_BE_IndicacionEnfermeria.CodigoIndicacionEnfermeria = CInt(BoolGrabar)
            usp_valor = obj_BL_IndicacionEnfermeria.FUN_UPD_IndicacionEnfermeria(obj_BE_IndicacionEnfermeria, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 9)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 9)
                Master.SeteoPermisosAcciones(btnActualizar, 9)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 9)
            End If
