...
''' <summary>
''' Modulo de Mantenimiento de Motivo de Salida de medicamentos
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  25
''' </remarks>
Partial Class Mantenimientos_Enfermeria_MotivoSalidaMedicamento
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Motivo de Salida de Medicamento")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 25)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 25)
        Master.SeteoPermisosAcciones(btnExportar, 25)
        Master.SeteoPermisosAcciones(btnGrabar, 25)
        Master.SeteoPermisosAcciones(btnNuevo, 25)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 25, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Motivos de salida")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Motivos de salida")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Motivos de salida")
    ...
    ''' <summary>
    ''' Lista la relación de motivos de salidas de medicamentos.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_MotivoSalidaMedicamento.FUN_LIS_MotivoSalidaMedicamento(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 25)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de motivo de salida de mendicamento</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_MotivoSalidaMedicamento.FUN_GET_MotivoSalidaMedicamento(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 25)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de motivo de salida de medicamento</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_MotivoSalidaMedicamento.FUN_DEL_MotivoSalidaMedicamento(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 25)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_MotivoSalidaMedicamento As New be_MotivoSalidaMedicamento
        Dim obj_BL_MotivoSalidaMedicamento As New bl_MotivoSalidaMedicamento
        ...
        obj_BE_MotivoSalidaMedicamento.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_MotivoSalidaMedicamento.FUN_INS_MotivoSalidaMedicamento(obj_BE_MotivoSalidaMedicamento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 25)
        Else
            obj_BE_MotivoSalidaMedicamento.CodigoMotivoSalidaMedicamento = CInt(BoolGrabar)
            usp_valor = obj_BL_MotivoSalidaMedicamento.FUN_UPD_MotivoSalidaMedicamento(obj_BE_MotivoSalidaMedicamento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 25)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 25)
                Master.SeteoPermisosAcciones(btnActualizar, 25)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 25)
            End If
