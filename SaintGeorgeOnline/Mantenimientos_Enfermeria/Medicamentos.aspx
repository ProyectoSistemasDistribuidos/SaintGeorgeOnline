<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="Medicamentos.aspx.vb" Inherits="Mantenimientos_Enfermeria_Medicamentos" title="Página sin título" %>
...
<div id="miPaginaMantenimiento">
 ...
 <div id="miContainerMantenimiento">
    <atk:TabContainer ID="TabContainer1" runat="server" Width="670px" ActiveTabIndex="0"
        AutoPostBack="true" ScrollBars="None" >
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red;
                                ...
                                <tr>
                                    ...
                                    <td style="width: 360px; height: 25px;" align="left" valign="bottom">                                        
                                        <asp:DropDownList ID="ddlBuscarNombre" runat="server" Width="280px" 
                                            Height="16px">
                                        </asp:DropDownList>
                                        <asp:HiddenField ID="hfTotalRegs" runat="server" Value="0" />
                                    </td>
                                    <td style="width: 100px; padding-top:6px" align="right" valign="top" rowspan="3">
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 360px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList ID="ddlBuscarPresentacion" runat="server" Width="150px" 
                                            AutoPostBack="True"
                                            OnSelectedIndexChanged="ddlBuscarPresentacion_SelectedIndexChanged">
                                        </asp:DropDownList>                                   
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="min-width: 360px; height: 25px; " align="left" valign="bottom">
                                        <asp:DropDownList ID="ddlBuscarUnidadMedida" runat="server" Width="150px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Nombre">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:150px;" align="right" valign="middle">Nombre&nbsp;</td>
                                            <td style="width:155px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescripcionNombre" runat="server" 
                                                ToolTip="Descendente"    
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("DescripcionNombre") %>' />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Presentación / Unidad Medida">  
                                    <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:185px;" align="right" valign="middle">Presentación / Unidad Medida&nbsp;</td>
                                            <td style="width:50px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescripcionRelacion" runat="server" 
                                                ToolTip="Descendente"    
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("DescripcionRelacion") %>' />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="235px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="235px" />
                                </asp:TemplateField>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">   
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList  ID="ddlNombre" runat="server" Width="150">
                                        </asp:DropDownList>                                  
                                    </td>
                                </tr>  
                                <tr>
                                    <td style="width: 150px; height: 30px;" align="left" valign="middle">
                                        <span>Concentración</span>
                                    </td>
                                    <td style="min-width: 460px; height: 30px;" align="left" valign="bottom">
                                        ...
                                        <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterType="LowercaseLetters,UppercaseLetters,Numbers,Custom"
                                            TargetControlID="tbConcentracion" ValidChars="' ','.','/','á','é','í','ó','ú','(',')'">
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList  ID="ddlPresentacion" runat="server" Width="150" 
                                            AutoPostBack="true"
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:DropDownList  ID="ddlUnidadMedida" runat="server" Width="150">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
