...
''' <summary>
''' Modulo de Mantenimiento de Alergias
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  51
''' </remarks>
Partial Class Mantenimientos_Enfermeria_Alergias
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Alergias")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 51)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 51)
        Master.SeteoPermisosAcciones(btnExportar, 51)
        Master.SeteoPermisosAcciones(btnGrabar, 51)
        Master.SeteoPermisosAcciones(btnNuevo, 51)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 51, int_CodigoAccion, str_DetalleError, "", 0)
    ...
    Private Sub Exportar()
        ...
        dt = Datos.agregarColumna(dt, "Tipo de Alergia", "String")
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            auxDR = dt.NewRow
            auxDR.Item("N°") = cont
            auxDR.Item("Alergia") = dr.Item("Descripcion").ToString
            auxDR.Item("Tipo de Alergia") = dr.Item("DescripcionTipoAlergia").ToString
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Alergias")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            NombreArchivo = Exportacion.ExportarReporte(dt, "Alergias")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Alergias")
    ...
    ''' <summary>
    '''  Muestra un mensaje en el formulario de cualquier metodo que lo invoque.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     10/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        Dim int_CodigoTipoAlergia As Integer = CInt(ddlBuscarTipo.SelectedValue)
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Alergia.FUN_LIS_Alergia(str_Descripcion, int_CodigoTipoAlergia, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 51)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Alergia</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     10/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Alergia.FUN_GET_Alergia(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 51)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Alergía</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Alergia.FUN_DEL_Alergia(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 51)
        End If
    ...
    Private Sub Grabar()
        ...
        obj_BE_Alergia.Descripcion = tbDescripcion.Text.Trim
        ...
        Else
            obj_BE_Alergia.CodigoAlergia = CInt(BoolGrabar)
            usp_valor = obj_BL_Alergia.FUN_UPD_Alergia(obj_BE_Alergia, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 51)
        End If
...
#Region "Metodos del Gridview"
    ...
    Private Sub ImagenSorting(ByVal nombreBoton As String)
        ...
        Dim _btnSorting_d2 As ImageButton = CType(GridView1.HeaderRow.FindControl("btnSorting_DescripcionTipoAlergia"), ImageButton)
