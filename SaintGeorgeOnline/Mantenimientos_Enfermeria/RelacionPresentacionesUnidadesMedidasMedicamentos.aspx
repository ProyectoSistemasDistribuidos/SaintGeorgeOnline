<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="RelacionPresentacionesUnidadesMedidasMedicamentos.aspx.vb" Inherits="Mantenimientos_Enfermeria_RelacionPresentacionesUnidadesMedidasMedicamentos" title="Página sin título" %>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Presentación">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:350px;" align="right" valign="middle">Presentación&nbsp;/&nbsp;Unidad Medida&nbsp</td>
                                            <td style="width:190px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting" runat="server" 
                                                ToolTip="Descendente"    
                                    ...
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Center" Width="540px" />
                                </asp:TemplateField>                                                                             
                    ...
                    <div id="miDetalleMant">
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">
                                ...
                                <tr>
                                    <td style="width: 150px; height: 25px;" align="left" valign="middle">
                                        <span>Unidad&nbsp;</span><span class="camposObligatorios">(*)</span>
                                    </td>
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
