<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="TiposControles.aspx.vb" Inherits="Mantenimientos_Enfermeria_TiposControles" title="Página sin título" %>
                        ...
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" 
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 300px; " align="left" class="style1">
                                        ...
                                        <atk:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters"
                                            TargetControlID="tbBuscarDescripcion" ValidChars="' ','.','á','é','í','ó','ú','(',')'" Enabled="True">
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 460px; height: 50px;" align="left" valign="bottom">
                                        <asp:TextBox ID="tbDescripcion" runat="server" CssClass="miTextBox" 
                                            MaxLength="100" Width="450px" Height="35px" Rows="2" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
