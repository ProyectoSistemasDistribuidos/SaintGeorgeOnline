...
''' <summary>
''' Modulo de Mantenimiento de Diagnosticos
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  7
''' </remarks>
Partial Class Mantenimientos_Enfermeria_Diagnosticos
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Diagnósticos")
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Diagnósticos")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Diagnósticos")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Diagnósticos")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Diagnostico.FUN_LIS_Diagnostico(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 7)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Diagnostico.FUN_GET_Diagnostico(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 7)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Diagnostico.FUN_DEL_Diagnostico(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 7)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Diagnostico As New be_Diagnosticos
        Dim obj_BL_Diagnostico As New bl_Diagnosticos
        ...
        obj_BE_Diagnostico.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Diagnostico.FUN_INS_Diagnostico(obj_BE_Diagnostico, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 7)
        Else
            obj_BE_Diagnostico.CodigoDiagnostico = CInt(BoolGrabar)
            usp_valor = obj_BL_Diagnostico.FUN_UPD_Diagnostico(obj_BE_Diagnostico, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 7)
        End If
