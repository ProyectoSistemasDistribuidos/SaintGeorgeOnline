...
''' <summary>
''' Modulo de Mantenimiento de Presentaciones de Unidades de Medidas de Medicamentos
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción: 60
''' </remarks>
Partial Class Mantenimientos_Enfermeria_RelacionPresentacionesUnidadesMedidasMedicamentos
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Presentación por Unidad de Medida")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 60)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 60)
        Master.SeteoPermisosAcciones(btnExportar, 60)
        Master.SeteoPermisosAcciones(btnGrabar, 60)
        Master.SeteoPermisosAcciones(btnNuevo, 60)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 60, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Dim NombreArchivo As String = ""
            ...
            dt = Datos.agregarColumna(dt, "Presentación / Unidad de Medida", "String")
            ...
            For Each dr As DataRow In ds_Lista.Tables(0).Rows
                auxDR = dt.NewRow
                auxDR.Item("N°") = cont
                auxDR.Item("Presentación / Unidad de Medida") = dr.Item("Descripcion").ToString
                'auxDR.Item("Presentación") = dr.Item("DescripcionPresentacion").ToString
                'auxDR.Item("Unidad Medida") = dr.Item("DescripcionUnidadMedida").ToString
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Presentación por Unidad de Medida")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Presentación por Unidad de Medida")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Presentación por Unidad de Medida")
    ...
    ''' <summary>
    '''  Muestra mensaje de alertas en el formulario  de cualquier metodo que lo invoque.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ...
    Private Sub MostrarAlertas()
        ...
        If ddlPresentacion.SelectedValue = 0 Then
            str_alertas = Alertas.ObtenerAlerta(str_alertas, 3, "Presentación de medicamento")
        End If
    ...
    ''' <summary>
    ''' Carga la lista de Presentación de medicamentos
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ...
    Private Sub cargarComboPresentacion()
        ...
        Dim ds_Lista As DataSet = obj_BL_PresentacionMedicamento.FUN_LIS_PresentacionMedicamento("", 1, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 60)
    ...
    ''' <summary>
    ''' Carga la lista de Unidad de medida de medicamento
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ...
    Private Sub cargarComboUnidad()
        ...
        Dim obj_BL_UnidadMedidaMedicamento As New bl_UnidadesMedidasMedicamentos
        Dim int_CodigoUsuario As Integer = Me.Master.Obtener_CodigoUsuarioLogueado
        Dim int_CodigoTipoUsuario As Integer = Me.Master.Obtener_CodigoTipoUsuarioLogueado

        Dim ds_Lista As DataSet = obj_BL_UnidadMedidaMedicamento.FUN_LIS_UnidadMedidaMedicamento("", 1, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 60)
    ...
    Private Function ObtenerResultadoBusqueda() As DataSet
        ...
        Dim ds_Lista As DataSet = obj_BL_RelacionPresentacionUnidadMedidaMedicamento.FUN_LIS_RelacionPresentacionUnidadMedidaMedicamento( _
                                    int_CodigoPresentacion, int_CodigoUnidadMedida, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 60)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Relación de presentación de unidad de medida de medicamento</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     11/01/2011
    ''' Modificado por:        _____________
    ''' Fecha de modificación: _____________ 
    ''' </remarks>
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = _
        obj_BL_RelacionPresentacionUnidadMedidaMedicamento.FUN_GET_RelacionPresentacionUnidadMedidaMedicamento(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 60)
        ...
        ddlUnidadMedida.SelectedValue = CInt(ds_Lista.Tables(0).Rows(0).Item("CodigoUnidadMedida").ToString)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_RelacionPresentacionUnidadMedidaMedicamento.FUN_DEL_RelacionPresentacionUnidadMedidaMedicamento(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 60)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_RelacionPresentacionUnidadMedidaMedicamento As New be_RelacionPresentacionesUnidadesMedidasMedicamentos
        Dim obj_BL_RelacionPresentacionUnidadMedidaMedicamento As New bl_RelacionPresentacionesUnidadesMedidasMedicamentos
        ...
        obj_BE_RelacionPresentacionUnidadMedidaMedicamento.CodigoPresentacion = ddlPresentacion.SelectedValue
        obj_BE_RelacionPresentacionUnidadMedidaMedicamento.CodigoUnidadMedida = ddlUnidadMedida.SelectedValue

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_RelacionPresentacionUnidadMedidaMedicamento.FUN_INS_RelacionPresentacionUnidadMedidaMedicamento( _
                obj_BE_RelacionPresentacionUnidadMedidaMedicamento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 60)
        Else
            obj_BE_RelacionPresentacionUnidadMedidaMedicamento.CodigoRelacion = CInt(BoolGrabar)
            usp_valor = obj_BL_RelacionPresentacionUnidadMedidaMedicamento.FUN_UPD_RelacionPresentacionUnidadMedidaMedicamento( _
                obj_BE_RelacionPresentacionUnidadMedidaMedicamento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 60)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 60)
                Master.SeteoPermisosAcciones(btnActualizar, 60)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 60)
            End If
