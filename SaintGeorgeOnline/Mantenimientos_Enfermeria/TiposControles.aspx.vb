...
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  19
''' </remarks>
Partial Class Mantenimientos_Enfermeria_TiposControles
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Tipos de Controles")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 19)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 19)
        Master.SeteoPermisosAcciones(btnExportar, 19)
        Master.SeteoPermisosAcciones(btnGrabar, 19)
        Master.SeteoPermisosAcciones(btnNuevo, 19)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 19, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Tipos de controles de salud")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Tipos de controles de salud")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Tipos de controles de salud")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_TipoControl As New bl_TiposControles
            ds_Lista = obj_BL_TipoControl.FUN_LIS_TipoControl(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 19)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Tipo de control</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     10/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_TipoControl.FUN_GET_TipoControl(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 19)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_TipoControl.FUN_DEL_TipoControl(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 19)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_TipoControl As New be_TiposControles
        Dim obj_BL_TipoControl As New bl_TiposControles
        ...
        obj_BE_TipoControl.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_TipoControl.FUN_INS_TipoControl(obj_BE_TipoControl, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 19)
        Else
            obj_BE_TipoControl.CodigoTipoControl = CInt(BoolGrabar)
            usp_valor = obj_BL_TipoControl.FUN_UPD_TipoControl(obj_BE_TipoControl, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 19)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 19)
                Master.SeteoPermisosAcciones(btnActualizar, 19)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 19)
            End If
