...
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  13
''' </remarks>
Partial Class Mantenimientos_Enfermeria_Enfermedades
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Enfermedades")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 13)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 13)
        Master.SeteoPermisosAcciones(btnExportar, 13)
        Master.SeteoPermisosAcciones(btnGrabar, 13)
        Master.SeteoPermisosAcciones(btnNuevo, 13)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 13, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Enfermedades")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Enfermedades")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Enfermedades")
    ...
    ''' </summary>
    ''' <param name="TipoAlerta">Tipo de alerta según la validacion</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    ''' <summary>
    ''' Lista la relación de enfermedades.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_Enfermedad.FUN_LIS_Enfermedad(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 13)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de la enfermedad</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_Enfermedad.FUN_GET_Enfermedad(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 13)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de la enfermedad</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_Enfermedad.FUN_DEL_Enfermedad(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 13)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_Enfermedad As New be_Enfermedades
        Dim obj_BL_Enfermedad As New bl_Enfermedades
        ...
        obj_BE_Enfermedad.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_Enfermedad.FUN_INS_Enfermedad(obj_BE_Enfermedad, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 13)
        Else
            obj_BE_Enfermedad.CodigoEnfermedad = CInt(BoolGrabar)
            usp_valor = obj_BL_Enfermedad.FUN_UPD_Enfermedad(obj_BE_Enfermedad, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 13)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 13)
                Master.SeteoPermisosAcciones(btnActualizar, 13)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 13)
            End If
