...
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  21
''' </remarks>
Partial Class Mantenimientos_Enfermeria_TiposOperacionesMedicas
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Tipos de Operación")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 21)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 21)
        Master.SeteoPermisosAcciones(btnExportar, 21)
        Master.SeteoPermisosAcciones(btnGrabar, 21)
        Master.SeteoPermisosAcciones(btnNuevo, 21)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 21, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Tipos de Operación Medica")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Tipos de Operación Medica")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Tipos de Operación Medica")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_TipoOperacionMedica As New bl_TiposOperacionesMedicas
            ds_Lista = obj_BL_TipoOperacionMedica.FUN_LIS_TipoOperacionMedica(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 21)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Operación</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     10/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_TipoOperacionMedica.FUN_GET_TipoOperacionMedica(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 21)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_TipoOperacionMedica.FUN_DEL_TipoOperacionMedica(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 21)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_TipoOperacionMedica As New be_TiposOperacionesMedicas
        Dim obj_BL_TipoOperacionMedica As New bl_TiposOperacionesMedicas
        ...
        obj_BE_TipoOperacionMedica.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_TipoOperacionMedica.FUN_INS_TipoOperacionMedica(obj_BE_TipoOperacionMedica, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 21)
        Else
            obj_BE_TipoOperacionMedica.CodigoTipoOperaciones = CInt(BoolGrabar)
            usp_valor = obj_BL_TipoOperacionMedica.FUN_UPD_TipoOperacionMedica(obj_BE_TipoOperacionMedica, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 21)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 21)
                Master.SeteoPermisosAcciones(btnActualizar, 21)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 21)
            End If
