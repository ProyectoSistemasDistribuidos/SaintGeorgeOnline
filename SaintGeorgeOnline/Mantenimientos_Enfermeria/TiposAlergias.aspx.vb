...
''' <summary>
''' Modulo de Mantenimiento de Tpos de Alergias
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  16
''' </remarks>
Partial Class Mantenimientos_Enfermeria_TiposAlergias
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Tipos de Alergias")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 16)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 16)
        Master.SeteoPermisosAcciones(btnExportar, 16)
        Master.SeteoPermisosAcciones(btnGrabar, 16)
        Master.SeteoPermisosAcciones(btnNuevo, 16)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 16, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Tipos de Alergia")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Tipos de Alergia")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Tipos de Alergia")
    ...
    ''' <summary>
    ''' Lista la relación de tipos de alergias.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_TipoAlergia.FUN_LIS_TipoAlergia(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 16)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de tipo de alergia</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_TipoAlergia.FUN_GET_TipoAlergia(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 16)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de tipo de alergia</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_TipoAlergia.FUN_DEL_TipoAlergia(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 16)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_TipoAlergia As New be_TiposAlergias
        Dim obj_BL_TipoAlergia As New bl_TiposAlergias
        ...
        obj_BE_TipoAlergia.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_TipoAlergia.FUN_INS_TipoAlergia(obj_BE_TipoAlergia, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 16)
        Else
            obj_BE_TipoAlergia.CodigoTipoAlergia = CInt(BoolGrabar)
            usp_valor = obj_BL_TipoAlergia.FUN_UPD_TipoAlergia(obj_BE_TipoAlergia, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 16)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 16)
                Master.SeteoPermisosAcciones(btnActualizar, 16)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 16)
            End If
