...
''' <summary>
''' Modulo de Mantenimiento de MedicamentosAlumnos
''' </summary>
''' <remarks>
''' Código del Modulo:    
''' Código de la Opción: 
''' </remarks>
Partial Class Mantenimientos_Enfermeria_MedicamentosAlumnos
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("MedicamentosAlumnos")
...
#Region "Metodos"
    ...
    Private Sub Exportar()
        ...
        str_TituloCabeceraArchivo = "Medicamentos Alumnos"
        ...
        dt = Datos.agregarColumna(dt, "Validado", "String")
        ...
        For Each dr As DataRow In ds_Lista.Tables(0).Rows
            ...
            auxDR.Item("Validado") = dr.Item("Validado").ToString
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        Dim int_Validado As Integer = CInt(rbValidado.SelectedValue)
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_MedicamentosAlumnos.FUN_LIS_MedicamentosAlumnos(str_Descripcion, int_Validado, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_MedicamentosAlumnos.FUN_GET_MedicamentosAlumnos(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        ...
        rbValidadoIns.SelectedValue = IIf(CInt(ds_Lista.Tables(0).Rows(0).Item("Validado")), 1, 0)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_MedicamentosAlumnos.FUN_DEL_MedicamentosAlumnos(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_MedicamentosAlumnos As New be_MedicamentosAlumnos
        Dim obj_BL_MedicamentosAlumnos As New bl_MedicamentosAlumnos
        ...
        obj_BE_MedicamentosAlumnos.Descripcion = tbDescripcion.Text.Trim
        obj_BE_MedicamentosAlumnos.Validado = rbValidadoIns.SelectedValue
        If BoolGrabar = 0 Then
            usp_valor = obj_BL_MedicamentosAlumnos.FUN_INS_MedicamentosAlumnos(obj_BE_MedicamentosAlumnos, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        Else
            obj_BE_MedicamentosAlumnos.CodigoMedicamento = CInt(BoolGrabar)
            usp_valor = obj_BL_MedicamentosAlumnos.FUN_UPD_MedicamentosAlumnos(obj_BE_MedicamentosAlumnos, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
        End If
