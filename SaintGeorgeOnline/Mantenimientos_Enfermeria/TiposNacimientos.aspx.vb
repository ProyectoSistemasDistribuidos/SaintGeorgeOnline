...
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  23
''' </remarks>
Partial Class Mantenimientos_Enfermeria_TiposNacimientos
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Tipos de Nacimiento")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 23)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 23)
        Master.SeteoPermisosAcciones(btnExportar, 23)
        Master.SeteoPermisosAcciones(btnGrabar, 23)
        Master.SeteoPermisosAcciones(btnNuevo, 23)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 23, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Dim ds_Lista As DataSet = ObtenerResultadoBusqueda(1)
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Tipos de Nacimiento")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Tipos de Nacimiento")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Tipos de Nacimiento")
    ...
    ''' </summary>
    ''' <param name="TipoAlerta">Tipo de alerta según la validación</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas
    ''' Fecha de Creación:     12/01/2011
    ''' Modificado por:        _____________
    ...
    ''' <summary>
    ''' Lista los datos de Tipo de Nacimiento     
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_TipoNacimiento.FUN_LIS_TipoNacimiento(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 23)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Tipo de Nacimiento</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_TipoNacimiento.FUN_GET_TipoNacimiento(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 23)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de Tipo de Nacimiento</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_TipoNacimiento.FUN_DEL_TipoNacimiento(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 23)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_TipoNacimiento As New be_TiposNacimientos
        Dim obj_BL_TipoNacimiento As New bl_TiposNacimientos
        ...
        obj_BE_TipoNacimiento.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_TipoNacimiento.FUN_INS_TipoNacimiento(obj_BE_TipoNacimiento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 23)
        Else
            obj_BE_TipoNacimiento.CodigoTipoNacimiento = CInt(BoolGrabar)
            usp_valor = obj_BL_TipoNacimiento.FUN_UPD_Diagnostico(obj_BE_TipoNacimiento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 23)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 23)
                Master.SeteoPermisosAcciones(btnActualizar, 23)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 23)
            End If
