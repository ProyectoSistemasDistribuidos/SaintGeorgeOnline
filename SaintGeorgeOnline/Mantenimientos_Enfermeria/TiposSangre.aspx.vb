...
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  22
''' </remarks>
Partial Class Mantenimientos_Enfermeria_TiposSangre
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Tipos de Sangre")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 22)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 22)
        Master.SeteoPermisosAcciones(btnExportar, 22)
        Master.SeteoPermisosAcciones(btnGrabar, 22)
        Master.SeteoPermisosAcciones(btnNuevo, 22)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 22, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        Dim ds_Lista As DataSet = ObtenerResultadoBusqueda(1)
            ...
            If rbExportar.SelectedValue = 0 Then 'WORD
                ...
                Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Tipos de sangre")
            ...
            ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
                ...
                NombreArchivo = Exportacion.ExportarReporte(dt, "Tipos de sangre")
            ...
            ElseIf rbExportar.SelectedValue = 2 Then 'PDF
                ...
                m = Exportacion.ExportarReporte_Pdf(dt, "Tipos de sangre")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_TipoSangre.FUN_LIS_TipoSangre(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 22)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Sangre</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     12/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_TipoSangre.FUN_GET_TipoSangre(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 22)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de sangre</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_TipoSangre.FUN_DEL_TipoSangre(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 22)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_TipoSangre As New be_TiposSangre
        Dim obj_BL_TipoSangre As New bl_TiposSangre
        ...
        obj_BE_TipoSangre.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_TipoSangre.FUN_INS_TipoSangre(obj_BE_TipoSangre, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 22)
        Else
            obj_BE_TipoSangre.codigoTipoSangre = CInt(BoolGrabar)
            usp_valor = obj_BL_TipoSangre.FUN_UPD_TipoSangre(obj_BE_TipoSangre, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 22)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 22)
                Master.SeteoPermisosAcciones(btnActualizar, 22)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 22)
            End If
