<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" CodeFile="MedicamentosAlumnos.aspx.vb" Inherits="Mantenimientos_Enfermeria_MedicamentosAlumnos" title="Página sin título" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red;
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 360px; height: 25px;" align="left" valign="bottom">
                                        <asp:RadioButtonList ID="rbValidado" runat="server" 
                                            RepeatDirection="Horizontal">
                                            <asp:ListItem Value="-1" Text="Todos" />
                                            <asp:ListItem Value="1" Text="Validado" Selected="True" />
                                            <asp:ListItem Value="0" Text="Por Validar" />                                        
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                        ...
                        <asp:GridView ID="GridView1" runat="server" 
                            ...
                            <Columns>                            
                                ...
                                <asp:TemplateField HeaderText="Validado">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:310px;" align="right" valign="middle">Validado&nbsp;</td>
                                            <td style="width:260px;" align="left" valign="middle"></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="lblValidado" runat="server" Text='<%# Bind("Validado") %>' />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="570px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="570px" />
                                </asp:TemplateField>
                                ...
                                <tr>
                                   ...
                                   <tr>
                                    ...
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        <asp:RadioButtonList ID="rbValidadoIns" runat="server" RepeatDirection="Horizontal">
                                            <asp:ListItem Value="1" Text="Validado" Selected="True" />
                                            <asp:ListItem Value="0" Text="Por Validar" />                                       
                                        </asp:RadioButtonList>
                                    </td>  
