...
''' <summary>
''' Modulo de Mantenimiento de Tipos de Caracteristicas de la piel
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  17
''' </remarks>
Partial Class Mantenimientos_Enfermeria_TiposCaracteristicasPiel
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Tipos de Caracteristicas de la Piel")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 17)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 17)
        Master.SeteoPermisosAcciones(btnExportar, 17)
        Master.SeteoPermisosAcciones(btnGrabar, 17)
        Master.SeteoPermisosAcciones(btnNuevo, 17)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 17, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Características de la Piel")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Características de la Piel")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Características de la Piel")
    ...
    ''' <summary>
    ''' Lista la relación de tipos de caracteristica de la piel.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_TipoCaracteristicaPiel As New bl_TiposCaracteristicasPiel
            ds_Lista = obj_BL_TipoCaracteristicaPiel.FUN_LIS_TipoCaracteristicaPiel(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 17)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de tipo de caracteristica de la piel</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_TipoCaracteristicaPiel.FUN_GET_TipoCaracteristicaPiel(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 17)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de tipo de caracteristica de la piel</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_TipoCaracteristicaPiel.FUN_DEL_TipoCaracteristicaPiel(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 17)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_TipoCaracteristicaPiel As New be_TiposCaracteristicasPiel
        Dim obj_BL_TipoCaracteristicaPiel As New bl_TiposCaracteristicasPiel
        ...
        obj_BE_TipoCaracteristicaPiel.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_TipoCaracteristicaPiel.FUN_INS_TipoCaracteristicaPiel(obj_BE_TipoCaracteristicaPiel, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 17)
        Else
            obj_BE_TipoCaracteristicaPiel.CodigoCaracteristicaPiel = CInt(BoolGrabar)
            usp_valor = obj_BL_TipoCaracteristicaPiel.FUN_UPD_TipoCaracteristicaPiel(obj_BE_TipoCaracteristicaPiel, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 17)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 17)
                Master.SeteoPermisosAcciones(btnActualizar, 17)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 17)
            End If
