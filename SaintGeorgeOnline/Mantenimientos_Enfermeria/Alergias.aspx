<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false"  CodeFile="Alergias.aspx.vb" Inherits="Mantenimientos_Enfermeria_Alergias" title="Alergias" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red;
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 410px; height: 25px; padding-left: 10px;" align="left" 
                                        ...
                                        <asp:DropDownList ID="ddlBuscarTipo" runat="server" Height="18px" Width="235px">
                                        </asp:DropDownList>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Descripción">  
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:190px;" align="right" valign="middle">Alergia&nbsp;</td>
                                            <td style="width:193px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_Descripcion" runat="server" 
                                                ToolTip="Descendente"    
                                    ...
                                    <HeaderStyle HorizontalAlign="Center" Width="383px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="383px" />
                                </asp:TemplateField>                                                                         
                                                   
                                <asp:TemplateField HeaderText="Tipo Alergia">  
                                    <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:100px;" align="right" valign="middle">Tipo Alergia</td>
                                            <td style="width:55px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_DescripcionTipoAlergia" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="DescripcionTipoAlergia"/></td>
                                        </tr>
                                    </table>                                    
                                    </HeaderTemplate>                                                                      
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("DescripcionTipoAlergia") %>' />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="155px"/>
                                    <ItemStyle CssClass="miGridviewBusqueda_Rows" HorizontalAlign="Left" Width="155px" />
                                </asp:TemplateField>
                        ...
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border: solid 0x red; min-width: 610px;">
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 460px; height: 50px; padding-left:10px" align="left" valign="bottom">
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 460px; height: 25px;" align="left" valign="bottom">
                                        ...
                                        <asp:DropDownList ID="ddlTipo" runat="server" Height="18px" Width="235px">
                                        </asp:DropDownList>
