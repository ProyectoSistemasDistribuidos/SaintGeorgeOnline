...
''' <summary>
''' Modulo de Configuración de Codificadores Médicos
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  5
''' </remarks>
Partial Class Mantenimientos_Enfermeria_MantenimientoEnfermeria
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Configuraciones de Enfermería")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 5)
    End Sub
    ...
    Private Sub cargarSubMenusConfiguracion()
        ...
        While cont_grupos <= dt_Grupos.Rows.Count - 1
            ...
            If dt_Grupos.Rows(cont_grupos).Item("BM_CodigoBloque").ToString = 1 Then

                dt_Modulos.RowFilter = " 1=1 and SBM_CodigoSubBloquePadre = 3 and BM_CodigoBloque = " & dt_Grupos.Rows(cont_grupos).Item("BM_CodigoBloque").ToString
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 5, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
