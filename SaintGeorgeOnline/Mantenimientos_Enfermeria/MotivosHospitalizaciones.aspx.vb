...
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  20
''' </remarks>
Partial Class Mantenimientos_Enfermeria_MotivosHospitalizaciones
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Motivos de las Hospitalizaciones")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 20)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 20)
        Master.SeteoPermisosAcciones(btnExportar, 20)
        Master.SeteoPermisosAcciones(btnGrabar, 20)
        Master.SeteoPermisosAcciones(btnNuevo, 20)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 20, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Motivos de Hospitalización")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Motivos de Hospitalización")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Motivos de Hospitalización")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_MotivoHospitalizacion As New bl_MotivosHospitalizaciones
            ds_Lista = obj_BL_MotivoHospitalizacion.FUN_LIS_MotivoHospitalizacion(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 20)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Hospitalización</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     10/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_MotivoHospitalizacion.FUN_GET_MotivoHospitalizacion(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 20)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_MotivoHospitalizacion.FUN_DEL_MotivoHospitalizacion(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 20)
       End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_MotivoHospitalizacion As New be_MotivosHospitalizaciones
        Dim obj_BL_MotivoHospitalizacion As New bl_MotivosHospitalizaciones
        ...
        obj_BE_MotivoHospitalizacion.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_MotivoHospitalizacion.FUN_INS_MotivoHospitalizacion(obj_BE_MotivoHospitalizacion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 20)
        Else
            obj_BE_MotivoHospitalizacion.CodigoMotivoHospitalizacion = CInt(BoolGrabar)
            usp_valor = obj_BL_MotivoHospitalizacion.FUN_UPD_MotivoHospitalizacion(obj_BE_MotivoHospitalizacion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 20)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 20)
                Master.SeteoPermisosAcciones(btnActualizar, 20)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 20)
            End If
