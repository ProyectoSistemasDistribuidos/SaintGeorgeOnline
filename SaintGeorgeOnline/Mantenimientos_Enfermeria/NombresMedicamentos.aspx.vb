...
''' <summary>
''' Modulo de Mantenimiento de Nombres de Medicamentos
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  12
''' </remarks>
Partial Class Mantenimientos_Enfermeria_NombresMedicamentos
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Nombres de medicamentos")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 12)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 12)
        Master.SeteoPermisosAcciones(btnExportar, 12)
        Master.SeteoPermisosAcciones(btnGrabar, 12)
        Master.SeteoPermisosAcciones(btnNuevo, 12)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 12, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Nombre de Medicamento")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Nombre de Medicamento")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Nombre de Medicamento")
    ...
    ''' <summary>
    ''' Lista la relación de nombres de medicamentos.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_NombreMedicamentos As New bl_NombresMedicamentos
            ds_Lista = obj_BL_NombreMedicamentos.FUN_LIS_NombreMedicamento(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 12)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de nombre de mendicamento</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_NombreMedicamento.FUN_GET_NombreMedicamento(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 12)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_NombreMedicamento.FUN_DEL_NombreMedicamento(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 12)
        End If
    ...
    Private Sub Grabar()
        ...
        obj_BE_NombreMedicamento.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_NombreMedicamento.FUN_INS_NombreMedicamento(obj_BE_NombreMedicamento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 12)
        Else
            obj_BE_NombreMedicamento.CodigoNombreMedicamento = CInt(BoolGrabar)
            usp_valor = obj_BL_NombreMedicamento.FUN_UPD_NombreMedicamento(obj_BE_NombreMedicamento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 12)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 12)
                Master.SeteoPermisosAcciones(btnActualizar, 12)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 12)
            End If
