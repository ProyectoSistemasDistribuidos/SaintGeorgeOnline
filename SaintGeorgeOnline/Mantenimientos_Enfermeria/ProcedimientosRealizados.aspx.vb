...
''' </remarks>
Partial Class Mantenimientos_Enfermeria_ProcedimientosRealizados
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Procedimientos Realizados")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 8)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 8)
        Master.SeteoPermisosAcciones(btnExportar, 8)
        Master.SeteoPermisosAcciones(btnGrabar, 8)
        Master.SeteoPermisosAcciones(btnNuevo, 8)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 8, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Procedimientos de Enfermería")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Procedimientos de Enfermería")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Procedimientos de Enfermería")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_ProcedimientoRealizado As New bl_ProcedimientosRealizados
            ds_Lista = obj_BL_ProcedimientoRealizado.FUN_LIS_ProcedimientoRealizado(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 8)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de Procedimiento realizado</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     07/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_ProcedimientoRealizado.FUN_GET_ProcedimientoRealizado(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 8)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_ProcedimientoRealizado.FUN_DEL_ProcedimientoRealizado(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 8)
       End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_ProcedimientoRealizado As New be_ProcedimientosRealizados
        Dim obj_BL_ProcedimientoRealizado As New bl_ProcedimientosRealizados
        ...
        obj_BE_ProcedimientoRealizado.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_ProcedimientoRealizado.FUN_INS_ProcedimientoRealizado(obj_BE_ProcedimientoRealizado, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 8)
        Else
            obj_BE_ProcedimientoRealizado.CodigoProcedimientoRealizado = CInt(BoolGrabar)
            usp_valor = obj_BL_ProcedimientoRealizado.FUN_UPD_ProcedimientoRealizado(obj_BE_ProcedimientoRealizado, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 8)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 8)
                Master.SeteoPermisosAcciones(btnActualizar, 8)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 8)
            End If
