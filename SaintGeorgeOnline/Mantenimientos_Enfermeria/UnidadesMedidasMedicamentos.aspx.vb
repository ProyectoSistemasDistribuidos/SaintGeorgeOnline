...
''' <summary>
''' Modulo de Mantenimiento de UnidadesMedidasMedicamentos
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  11
''' </remarks>
Partial Class Mantenimientos_Enfermeria_UnidadesMedidasMedicamentos
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Unidades de Medidas de Medicamento")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 11)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 11)
        Master.SeteoPermisosAcciones(btnExportar, 11)
        Master.SeteoPermisosAcciones(btnGrabar, 11)
        Master.SeteoPermisosAcciones(btnNuevo, 11)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 11, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Unidad de Medida de Medicamento")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Unidad de Medida de Medicamento")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Unidad de Medida de Medicamento")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_UnidadMedidaMedicamento.FUN_LIS_UnidadMedidaMedicamento(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 11)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de unidad de medida de medicamento</param>
    ''' <remarks>
    ''' Creador:               Fanny Salinas 
    ''' Fecha de Creación:     10/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_UnidadMedidaMedicamento.FUN_GET_UnidadMedidaMedicamento(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 11)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_UnidadMedidaMedicamento.FUN_DEL_UnidadMedidaMedicamento(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 11)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_UnidadMedidaMedicamento As New be_UnidadesMedidasMedicamentos
        Dim obj_BL_UnidadMedidaMedicamento As New bl_UnidadesMedidasMedicamentos
        ...
        obj_BE_UnidadMedidaMedicamento.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_UnidadMedidaMedicamento.FUN_INS_UnidadMedidaMedicamento(obj_BE_UnidadMedidaMedicamento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 11)
        Else
            obj_BE_UnidadMedidaMedicamento.CodigoUnidadMedida = CInt(BoolGrabar)
            usp_valor = obj_BL_UnidadMedidaMedicamento.FUN_UPD_UnidadMedidaMedicamento(obj_BE_UnidadMedidaMedicamento, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 11)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 11)
                Master.SeteoPermisosAcciones(btnActualizar, 11)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 11)
            End If
