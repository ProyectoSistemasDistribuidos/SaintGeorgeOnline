...
''' <summary>
''' Modulo de Mantenimiento de Dosis de Vacunas
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  15
''' </remarks>
Partial Class Mantenimientos_Enfermeria_DosisVacunas
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Dosis de la Vacuna")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 15)
        ...
        Master.SeteoPermisosAcciones(btnBuscar, 15)
        Master.SeteoPermisosAcciones(btnExportar, 15)
        Master.SeteoPermisosAcciones(btnGrabar, 15)
        Master.SeteoPermisosAcciones(btnNuevo, 15)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As Integer, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 15, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "Dosis de Vacunas")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "Dosis de Vacunas")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "Dosis de Vacunas")
    ...
    ''' <summary>
    ''' Lista la relación de dosis de vacunas.
    ''' </summary>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            ds_Lista = obj_BL_DosisVacuna.FUN_LIS_DosisVacuna(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 15)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">Código de dosis de vacuna</param>
    ''' <remarks>
    ''' Creador:               Johnatan Matta
    ''' Fecha de Creación:     06/01/2011
    ''' Modificado por:        _____________
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_DosisVacuna.FUN_GET_DosisVacuna(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 15)
    ...
    ''' </summary>
    ''' <param name="int_Codigo">codigo de dosis de vacuna</param>
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_DosisVacuna.FUN_DEL_DosisVacuna(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 15)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_DosisVacuna As New be_DosisVacunas
        Dim obj_BL_DosisVacuna As New bl_DosisVacunas
        ...
        obj_BE_DosisVacuna.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_DosisVacuna.FUN_INS_DosisVacuna(obj_BE_DosisVacuna, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 15)
        Else
            obj_BE_DosisVacuna.CodigoDosis = CInt(BoolGrabar)
            usp_valor = obj_BL_DosisVacuna.FUN_UPD_DosisVacuna(obj_BE_DosisVacuna, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 15)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("Estado") = "Activo" Then
                ...
                Master.SeteoPermisosAcciones(btnEliminar, 15)
                Master.SeteoPermisosAcciones(btnActualizar, 15)
            Else
                ...
                Master.SeteoPermisosAcciones(btnActivar, 15)
            End If
