...
''' <summary>
''' Modulo de Mantenimiento de FormasCalificacion
''' </summary>
''' <remarks>
''' Código del Modulo:    1
''' Código de la Opción:  7
''' </remarks>
Partial Class Mantenimientos_Notas_FormasCalificacion
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Me.Master.MostrarTitulo("Formas de Calificación")
...
#Region "Metodos"
    ...
    Private Sub SetearAccionesAcceso()
        Me.Master.RegistrarAccesoPagina(1, 7)
    ...
    Private Sub EnvioEmailError(ByVal int_CodigoAccion As String, ByVal str_DetalleError As String)
        ...
        Dim str_MensajeUsuario As String = Alertas.EnviarMensajeErrorEmail(1, 7, int_CodigoAccion, str_DetalleError, str_NombreUsuario, int_TipoUsuario)
    ...
    Private Sub Exportar()
        ...
        If rbExportar.SelectedValue = 0 Then 'WORD
            ...
            Arreglo_Datos = Exportacion.ExportarReporte_Html(dt, "FormasCalificacion")
            reporte_html = Arreglo_Datos(0)
            NombreArchivo = Arreglo_Datos(1)
            NombreArchivo = NombreArchivo & ".doc"

            rutamadre = Server.MapPath(".")
            rutamadre = rutamadre.Replace("\Mantenimientos_Notas", "\Reportes\")
        ...
        ElseIf rbExportar.SelectedValue = 1 Then 'EXCEL
            ...
            NombreArchivo = Exportacion.ExportarReporte(dt, "FormasCalificacion")
        ...
        ElseIf rbExportar.SelectedValue = 2 Then 'PDF
            ...
            m = Exportacion.ExportarReporte_Pdf(dt, "FormasCalificacion")
    ...
    Private Function ObtenerResultadoBusqueda(ByVal int_Modo As Integer) As DataSet
        ...
        If int_Modo = 1 Then 'LLAMAR A LA BASE DE DATOS
            ...
            Dim obj_BL_FormasCalificacion As New bl_FormasCalificacion
            ds_Lista = obj_BL_FormasCalificacion.FUN_LIS_FormasCalificacion(str_Descripcion, int_Estado, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 7)
    ...
    Private Sub obtener(ByVal int_Codigo As Integer)
        ...
        Dim ds_Lista As DataSet = obj_BL_FormasCalificacion.FUN_GET_FormasCalificacion(int_Codigo, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 7)
    ...
    Protected Sub cambiarEstado(ByVal int_Codigo As Integer, ByVal str_accion As String)
        ...
        If str_accion = "Eliminar" Then
            usp_valor = obj_BL_FormasCalificacion.FUN_DEL_FormasCalificacion(int_Codigo, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 7)
        End If
    ...
    Private Sub Grabar()
        ...
        Dim obj_BE_FormasCalificacion As New be_FormasCalificacion
        Dim obj_BL_FormasCalificacion As New bl_FormasCalificacion
        ...
        obj_BE_FormasCalificacion.Descripcion = tbDescripcion.Text.Trim

        If BoolGrabar = 0 Then
            usp_valor = obj_BL_FormasCalificacion.FUN_INS_FormasCalificacion(obj_BE_FormasCalificacion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 7)
        Else
            obj_BE_FormasCalificacion.CodigoFormaCalificacion = CInt(BoolGrabar)
            usp_valor = obj_BL_FormasCalificacion.FUN_UPD_FormasCalificacion(obj_BE_FormasCalificacion, usp_mensaje, int_CodigoUsuario, int_CodigoTipoUsuario, 1, 7)
        End If
