<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AgregarEnfermedad.aspx.vb" Inherits="Popups_AgregarEnfermedad" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AgregarEnfermedad</title>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
       ...
       <asp:UpdatePanel ID="updPanel_AgregarEnfermedad" runat="server">
        <ContentTemplate>
        ...
        <table border="0" cellpadding="0" cellspacing="0" 
            ...
            <tr>                
                <td style="width: 640px; height: 25px;" colspan="2" valign="middle" align="left" class="TitlebarLeft">
                    <span>Agregar Enfermedad</span></td>
