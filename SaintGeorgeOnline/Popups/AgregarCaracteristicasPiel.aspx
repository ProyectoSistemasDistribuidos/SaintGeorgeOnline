<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AgregarCaracteristicasPiel.aspx.vb" Inherits="Popups_AgregarCaracteristicasPiel" %>
    ...
    <asp:UpdatePanel ID="updPanel_AgregarTipoAlergia" runat="server">
       ...
       <div id="miModalWindow">        
        ...
        <table border="0" cellpadding="0" cellspacing="0" 
                style="width: 500px; height: 107px;">            
            <tr>                
                <td style="height: 25px;" colspan="2" valign="middle" align="left" 
                    class="TitlebarLeft">
                    <span>Agregar Caracteristicas de la Piel</span>
                </td>
            ...
            <tr>
                ...
                <td valign="middle" align="center" class="style2">
                    <asp:TextBox ID="tbCaracteristicaPiel" runat="server" CssClass="miTextBox" 
                        Height="28px" Rows="2" TextMode="MultiLine" Width="390px" />
                </td>
