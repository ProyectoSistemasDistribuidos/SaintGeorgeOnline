<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AgregarHospitalización.aspx.vb" Inherits="Popups_AgregarHospitalizacion" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" 
            ...
            <tr>                
                <td style="width: 640px; height: 25px;" colspan="2" valign="middle" align="left" class="TitlebarLeft">
                    <span>Agregar Hospitalización</span></td>
            ...
            <tr>
                ...
                <td style="width: 470px; height: 25px;" valign="middle" align="left">
                    <asp:TextBox ID="tbHospitalizacion" runat="server" CssClass="miTextBox" 
