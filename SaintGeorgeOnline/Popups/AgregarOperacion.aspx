<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AgregarOperacion.aspx.vb" Inherits="Popups_AgregarOperacion" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" 
            ...
            <tr>                
                <td style="width: 640px; height: 25px;" colspan="2" valign="middle" align="left" class="TitlebarLeft">
                    <span>Agregar Operación</span></td>
            ...
            <tr>
                ...
                <td style="width: 470px; height: 25px;" valign="middle" align="left">
                    <asp:TextBox ID="tbOperacion" runat="server" CssClass="miTextBox" 
