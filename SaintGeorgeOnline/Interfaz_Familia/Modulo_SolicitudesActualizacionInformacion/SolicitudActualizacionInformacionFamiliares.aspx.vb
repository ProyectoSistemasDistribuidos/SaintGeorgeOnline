...
Partial Class Interfaz_Familia_Modulo_SolicitudesActualizacionInformacion_SolicitudActualizacionInformacionFamiliares
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                ActivarCampos()
                ObtenerFicha(CInt(Request.QueryString("codigoFamiliar")))
                If Not Request.QueryString("codigoFamiliar") Is Nothing Then
                    Dim str_CodigoFamiliar As String = Request.QueryString("codigoFamiliar")
...
#Region "Ficha Familiar"
    ...
    Private Sub GrabarFicha()
        ...
        ojb_BE_SolicitudActualizacionFichaFamiliares.CodigoPeronsaSolicitante = Me.Master.Obtener_CodigoFamiliarLogueado() 'hidenCodigoPersona.Value
        ...
        If BoolGrabar Then
            ...
            ojb_BE_SolicitudActualizacionFichaFamiliares.CodigoAnioSolicitud = 2 'hiddenCodigoAnioAcademico.Value
