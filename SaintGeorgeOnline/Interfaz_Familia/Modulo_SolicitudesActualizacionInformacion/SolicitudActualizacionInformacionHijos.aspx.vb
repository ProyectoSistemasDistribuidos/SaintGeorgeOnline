...
Partial Class Interfaz_Familia_Modulo_SolicitudesActualizacionInformacion_SolicitudActualizacionInformacionHijos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not Page.IsPostBack Then
                ...
                ObtenerFicha(CInt(Request.QueryString("codigoAlumno")))
...
#Region "Metodos"
    ...
    Private Sub cargarComboTipoDocumento()
        ...
        Dim int_CodigoTipoUsuario As Integer = Me.Master.Obtener_CodigoFamiliarLogueado()
        Dim int_CodigoUsuario As Integer = Me.Master.Obtener_CodigoTipoUsuarioLogueado()
...
#Region "Ficha Alumno"
    ...
    Private Sub ObtenerFicha(ByVal str_Codigo As String)
        ...
        hd_CodigoPersonaSolicitante.Value = Me.Master.Obtener_CodigoFamiliarLogueado()
