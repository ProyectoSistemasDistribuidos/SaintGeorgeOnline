<%@ Page Language="VB" MasterPageFile="~/Interfaz_Familia/Plantilla_Principal.master" AutoEventWireup="false" CodeFile="CompanierosAula.aspx.vb" Inherits="Interfaz_Familia_Modulo_CompanierosAula_CompanierosAula" title="Página sin título" %>
                                                        ...
                                                        <table>
                                                          <tr>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" border="0" style="width: 250px;background-color:#d8ce35;border:1px;border-color:#79742c;border-style:solid ;     ">
                                                                <tr>
                                                                    <td rowspan="3" style="padding-left:5px; width:60px; Height:60; "   valign="middle">                                                             
                                                                        <asp:Image ID="img_Foto_dlCompanierosAula" runat="server" Width="40" Height="50" Style=" border: #7f9db9 1px solid" />
                                                                    </td>
                                                                    <td colspan ="2" style=" width:180px; height: 15px; text-align:left ; color:White; font-size:10px; " align="left" valign="bottom">                                                                                    
                                                                        <b> <asp:Label ID="lblNombre_dlCompanierosAula" ForeColor="White"  runat="server" Font-Bold="true" Text='<%# Eval("NombreCompleto") %>'  /> </b>                                                                                       
                                                                    </td>
                                                               ...
                                                               <tr>
                                                                    <td style=" width:25px; height: 15px; text-align:left ; color:White; font-size:10px;" align="left" valign="middle">                                                                                    
                                                                          <asp:ImageButton ID="btnCumpleanios" runat="server" Width="15px"  
                                                                             ImageUrl="~/App_Themes/Imagenes/opc_cumpleanio.png"
                                                                           />                                                                
                                                                    </td>
                                                                    <td style="width:155px; height: 15px; text-align:left ; color:White; font-size:10px;" align="left" valign="middle">                                                                                    
                                                                       <asp:Label ID="lblFechaNacimiento_dlCompanierosAula" ForeColor="White"  runat="server" Font-Bold="true" Text='<%# Eval("FechaNacimiento") %>'  />                                                                                      
                                                                    </td>
                                                                </tr>                                                                
                                                            </table>
                                                            </td>
