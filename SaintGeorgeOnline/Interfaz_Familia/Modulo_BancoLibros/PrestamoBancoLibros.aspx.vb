...
Partial Class Interfaz_Familia_Modulo_BancoLibros_PrestamoBancoLibros
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Master.MostrarTitulo("Banco de Libros")
        Try
...
#Region "Método"
    ...
    Private Sub AlumnosPorCodigoFamilia()
        ...
        Dim ds_Lista As DataSet = obj_BL_Alumnos.FUN_LIS_AlumnosPorCodigoFamilia(int_CodigoFamilia, int_CodigoFamiliar, int_CodigoUsuario, int_CodigoTipoUsuario, 0, 8)

        lblAnioActualLP.Text = Me.Master.Obtener_DescripcionPeriodoEscolar
    ...
    Private Sub listar()
        ...
        GridView2.DataSource = ds_Lista.Tables(1)
        GridView2.DataBind()

        lblCantidadAnioActual.Text = ds_Lista.Tables(2).Rows(0).Item("cantidadAnioActual")

        lblCantidadAnioAnterior.Text = ds_Lista.Tables(3).Rows(0).Item("cantidadAnioAnterior")

        lblAnioAnteriorLP.Text = ds_Lista.Tables(4).Rows(0).Item("AnioAcademicoAnterior")
    End Sub
    ...
    Private Function ObtenerResultadoBusqueda() As DataSet
        ...
        Dim obj_BL_CalendarioPagos As New bl_Prestamos
        ds_Lista = obj_BL_CalendarioPagos.FUN_LIS_LibrosPrestadosAlumnos( _
        int_CodigoAlumno, int_CodigoAnioAcademico, int_CodigoUsuario, int_CodigoTipoUsuario, cod_Modulo, cod_Opcion)
...
#Region "Eventos del Gridview"
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        Dim lblRutaPortada As Label = e.Row.FindControl("lblRutaFoto")

        If e.Row.RowType = DataControlRowType.DataRow Then

            btnVerFoto.Attributes.Add("rel", "sexylightbox")

            btnVerFoto.HRef = ConfigurationManager.AppSettings("RutaImagenesBancoLibro_Web").ToString() & lblCodigoLibro.Text & "/" & lblRutaPortada.Text
    ...
    Protected Sub GridView2_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        Dim btnVerFoto As HtmlAnchor = e.Row.FindControl("btnVerPortada2")
        Dim lblCodigoLibro As Label = e.Row.FindControl("lblCodigoLibro2")
        Dim lblRutaPortada As Label = e.Row.FindControl("lblRutaFoto2")
