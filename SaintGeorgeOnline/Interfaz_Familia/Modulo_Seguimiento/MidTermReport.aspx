<%@ Page Language="VB"  MasterPageFile="~/Interfaz_Familia/Plantilla_Principal.master" AutoEventWireup="false" CodeFile="MidTermReport.aspx.vb" Inherits="Interfaz_Familia_Modulo_Seguimiento_MidTermReport" title="Página sin título" %>
...
<script type="text/javascript" >
    ...
    function MostrarImpresionMidTermR_html() {

        window.open('/SaintGeorgeOnline/Plantillas/Exportaciones/Plantilla_Rep_MidTermReport_html.aspx', '_blank', '');
    }
                ...
                <td style="height:250px;background-image: url('/SaintGeorgeOnline/App_Themes/Imagenes/Familia/contenedores/grupoCronogramaPago_contenedor_centro.jpg');background-repeat:repeat-y;">
                     <table cellpadding="0" cellspacing="0" border="0" style="padding-left :15px; width: 540px; ">
                      ...
                      <HeaderStyle CssClass="miGridviewBusqueda_Header" Font-Underline="False" ForeColor="White"
                        ...
                        <Columns>       
                        <asp:BoundField DataField="CodigoProgramacion" HeaderText="CodigoProgramacion" ItemStyle-Width="0" HeaderStyle-CssClass="miHiddenStyle" ItemStyle-CssClass="miHiddenStyle" />                                
                                  
                            <asp:TemplateField HeaderText="Fecha de Registro">
                                <HeaderTemplate>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td style="width:65px;" align="right" valign="middle">Mes&nbsp;</td>
                                            <td style="width:35px;" align="left" valign="middle"><asp:ImageButton ID="btnSorting_Mes" runat="server" 
                                                ToolTip="Descendente"    
                                                ImageUrl="~/App_Themes/Imagenes/DOWN.png"                             
                                                CommandName="Sort" 
                                                CommandArgument="Mes"/></td>
                                        </tr>
                                    </table>                                    
                                </HeaderTemplate>      
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnVer" runat="server" ImageUrl="~/App_Themes/Imagenes/opc_ver.png" 
                                        CommandName="Visualizar" CommandArgument='<%# Bind("CodigoMidTerm") %>' ToolTip="Ver Registro" />
                                </ItemTemplate>
