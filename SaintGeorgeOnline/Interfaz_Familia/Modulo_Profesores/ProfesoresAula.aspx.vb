...
Partial Class Interfaz_Familia_Modulo_Profesores_ProfesoresAula
...
#Region "Eventos"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Master.MostrarTitulo("Profesores de Aula")
        Try
    ...
    Protected Sub dl_CompanierosAula_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs)
        ...
        img.ImageUrl = ConfigurationManager.AppSettings("RutaFotosUsuarios_Web_Admin").ToString() & e.Item.DataItem("RutaFoto")
...
#Region "Método"
    ...
    Private Function ObtenerResultadoBusqueda() As DataSet
        ...
        Dim obj_BL_Alumnos As New bl_Alumnos
        ds_Lista = obj_BL_Alumnos.FUN_LIS_ProfesoresPorAlumno( _
