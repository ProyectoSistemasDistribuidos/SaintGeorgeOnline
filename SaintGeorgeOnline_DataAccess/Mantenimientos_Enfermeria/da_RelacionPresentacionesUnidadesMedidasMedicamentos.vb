...
Namespace ModuloEnfermeria
    ...
    Public Class da_RelacionPresentacionesUnidadesMedidasMedicamentos
...
#Region "Metodos Transaccionales"
        ...
        Public Function FUN_INS_RelacionPresentacionUnidadMedidaMedicamento( _
            ...
            dbCommand = Me.dbBase.GetStoredProcCommand("EN_USP_INS_PresentacionesUnidadesMedidasMedicamentos")
            'Parámetros de entrada
            dbBase.AddInParameter(dbCommand, "@p_CodigoPresentacion", DbType.String, objRelacionPresentacionesUnidadesMedidasMedicamentos.CodigoPresentacion)
            dbBase.AddInParameter(dbCommand, "@p_CodigoUnidadMedida", DbType.String, objRelacionPresentacionesUnidadesMedidasMedicamentos.CodigoUnidadMedida)
        ...
        Public Function FUN_UPD_RelacionPresentacionUnidadMedidaMedicamento( _
            ByVal objRelacionPresentacionesUnidadesMedidasMedicamentos As be_RelacionPresentacionesUnidadesMedidasMedicamentos, _
            ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            dbCommand = Me.dbBase.GetStoredProcCommand("EN_USP_UPD_PresentacionesUnidadesMedidasMedicamentos")
            'Parámetros de entrada
            dbBase.AddInParameter(dbCommand, "@p_Codigo", DbType.Int16, objRelacionPresentacionesUnidadesMedidasMedicamentos.CodigoRelacion)
            dbBase.AddInParameter(dbCommand, "@p_CodigoPresentacion", DbType.String, objRelacionPresentacionesUnidadesMedidasMedicamentos.CodigoPresentacion)
            dbBase.AddInParameter(dbCommand, "@p_CodigoUnidadMedida", DbType.String, objRelacionPresentacionesUnidadesMedidasMedicamentos.CodigoUnidadMedida)
            dbBase.AddInParameter(dbCommand, "@p_CodigoUsuario", DbType.Int16, int_CodigoUsuario)
            dbBase.AddInParameter(dbCommand, "@p_CodigoTipoUsuario", DbType.Int16, int_CodigoTipoUsuario)
        ...
        Public Function FUN_DEL_RelacionPresentacionUnidadMedidaMedicamento(ByVal int_Codigo As Integer, ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            dbCommand = Me.dbBase.GetStoredProcCommand("EN_USP_DEL_PresentacionesUnidadesMedidasMedicamentos")
            'Parámetros de entrada
...
#Region "Metodos No Transaccionales"
        ...
        Public Function FUN_LIS_RelacionPresentacionUnidadMedidaMedicamento( _
            ...
            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("EN_USP_LIS_PresentacionesUnidadesMedidasMedicamentos")
            'Parámetros de entrada
            dbBase.AddInParameter(cmd, "@p_CodigoPresentacion", DbType.Int16, int_CodigoPresentacion)
            dbBase.AddInParameter(cmd, "@p_CodigoUnidadMedida", DbType.Int16, int_CodigoUnidadMedida)
        ...
        Public Function FUN_GET_RelacionPresentacionUnidadMedidaMedicamento(ByVal int_Codigo As Integer, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet
            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("EN_USP_GET_PresentacionesUnidadesMedidasMedicamentos")
            'Parámetros de entrada
        ...
        Public Function FUN_LIS_PresentacionMedicaDisponible(ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet
            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("EN_USP_LIS_PresentacionMedicaDisponible")
        ...
        Public Function FUN_LIS_UnidadMedidaxPresentacionMedicaDisponible(ByVal int_Codigo As Integer, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet
            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("EN_USP_LIS_UnidadMedidaxPresentacionMedicaDisponible")
            'Parámetros de entrada
            dbBase.AddInParameter(cmd, "@p_CodigoPresentacion", DbType.Int32, int_Codigo)
            dbBase.AddInParameter(cmd, "@p_CodigoUsuario", DbType.Int32, int_CodigoUsuario)
            dbBase.AddInParameter(cmd, "@p_CodigoTipoUsuario", DbType.Int32, int_CodigoTipoUsuario)
            dbBase.AddInParameter(cmd, "@p_CodigoModulo", DbType.Int32, int_CodigoModulo)
            dbBase.AddInParameter(cmd, "@p_CodigoOpcion", DbType.Int32, int_CodigoOpcion)
