...
Namespace ModuloNotas
    ...
    Public Class da_ProgramacionRegistroGradosPronosticos
...
#Region "Metodos No Transaccionales"
        ...
        Public Function FUN_LIS_ProgramacionRegistroGradosPronosticos(ByVal int_CodigoAnioAcademico As Integer, _
            ...
            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("CU_USP_LIS_ProgramacionRegistroGradosPronosticos")
