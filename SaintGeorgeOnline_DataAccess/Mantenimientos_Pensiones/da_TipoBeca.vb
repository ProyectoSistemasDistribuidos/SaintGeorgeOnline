...
#Region "Metodos Transaccionales"
        ...
        Public Function FUN_INS_TipoBeca(ByVal objTipoBeca As be_TipoBeca, ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            dbCommand = Me.dbBase.GetStoredProcCommand("PG_USP_INS_TipoBeca")
            'Parámetros de entrada
            dbBase.AddInParameter(dbCommand, "@p_Descripcion", DbType.String, objTipoBeca.Descripcion)
            dbBase.AddInParameter(dbCommand, "@p_Abrev", DbType.String, objTipoBeca.Abrev)
            dbBase.AddInParameter(dbCommand, "@p_PorcentajeDescuento", SqlDbType.Decimal, objTipoBeca.PorcentajeDescuento)
        ...
        Public Function FUN_UPD_TipoBeca(ByVal objTipoBeca As be_TipoBeca, ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            dbCommand = Me.dbBase.GetStoredProcCommand("PG_USP_UPD_TipoBeca")
            'Parámetros de entrada
            dbBase.AddInParameter(dbCommand, "@p_Codigo", DbType.Int16, objTipoBeca.CodigoTipoBeca)
            dbBase.AddInParameter(dbCommand, "@p_Descripcion", DbType.String, objTipoBeca.Descripcion)
            dbBase.AddInParameter(dbCommand, "@p_Abrev", DbType.String, objTipoBeca.Abrev)
            dbBase.AddInParameter(dbCommand, "@p_PorcentajeDescuento", DbType.Decimal, objTipoBeca.PorcentajeDescuento)
        ...
        Public Function FUN_DEL_TipoBeca(ByVal int_Codigo As Integer, ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            dbCommand = Me.dbBase.GetStoredProcCommand("PG_USP_DEL_TipoBeca")
            'Parámetros de entrada
...
#Region "Metodos No Transaccionales"
        ...
        Public Function FUN_LIS_TipoBeca(ByVal Descripcion As String, ByVal PorcentajeDescuento As Double, ByVal int_Estado As Integer, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet

            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("PG_USP_LIS_TipoBeca")
            'Parámetros de entrada
            dbBase.AddInParameter(cmd, "@p_Descripcion", DbType.String, Descripcion)
            dbBase.AddInParameter(cmd, "@p_PorcentajeDescuento", DbType.Decimal, PorcentajeDescuento)
        ...
        Public Function FUN_GET_TipoBeca(ByVal int_Codigo As Integer, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet
            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("PG_USP_GET_TipoBeca")
            'Parámetros de entrada
