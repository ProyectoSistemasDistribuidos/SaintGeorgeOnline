...
Namespace ModuloPensiones
    ...
    Public Class da_PagosDeExamenes
...
#Region "Metodos Transaccionales"
        ...
        Public Function FUN_UPD_PagosDeExamenes(ByVal int_CodigoDeuda As String, _
            ...
            dbCommand = Me.dbBase.GetStoredProcCommand("PG_USP_UPD_PagosDeExamenes")
...
#Region "Metodos No Transaccionales"
        ...
        'PG_USP_LIS_InformacionPagosDeViajesAlumnosGeneral
        Public Function FUN_LIS_InformacionPagosExamenesAlumnos(ByVal str_CodigoAlumno As String, _
            ...
            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("PG_USP_LIS_InformacionPagosDeExamenesAlumnos")
        ...
        Public Function FUN_REP_DinamicoInformacionPagosExamenesAlumnos(ByVal int_CodigoPeriodoAcademico As Integer, _
            ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet

            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("PG_USP_REP_InformacionPagosExamenesAlumnos")
