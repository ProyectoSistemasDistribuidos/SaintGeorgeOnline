...
Namespace ModuloColegio
    ...
    Public Class da_AsignacionSemanasPorBimestres
...
#Region "Metodos Transaccionales"
        ...
        Public Function FUN_INS_AsignacionSemanasPorBimestres(ByVal objAsignacionSemanasPorBimestres As be_AsignacionSemanasPorBimestres, ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            dbCommand = Me.dbBase.GetStoredProcCommand("CO_USP_INS_AsignacionSemanasPorBimestres")
            'Parámetros de entrada
            dbBase.AddInParameter(dbCommand, "@p_CodigoSemanaAcademica", DbType.Int16, objAsignacionSemanasPorBimestres.CodigoSemanaAcademica)
            dbBase.AddInParameter(dbCommand, "@p_CodigoBimestre", DbType.Int16, objAsignacionSemanasPorBimestres.CodigoBimestre)
            dbBase.AddInParameter(dbCommand, "@p_CodigoAnioAcademico", DbType.Int16, objAsignacionSemanasPorBimestres.CodigoAnioAcademico)
            dbBase.AddInParameter(dbCommand, "@p_Orden", DbType.Int16, objAsignacionSemanasPorBimestres.Orden)
            dbBase.AddInParameter(dbCommand, "@p_FechaInicio", DbType.Date, objAsignacionSemanasPorBimestres.FechaInicio)
            dbBase.AddInParameter(dbCommand, "@p_FechaFinal", DbType.Date, objAsignacionSemanasPorBimestres.FechaFinal)
        ...
        Public Function FUN_UPD_AsignacionSemanasPorBimestres(ByVal objAsignacionSemanasPorBimestres As be_AsignacionSemanasPorBimestres, ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            dbCommand = Me.dbBase.GetStoredProcCommand("CO_USP_UPD_AsignacionSemanasPorBimestres")
            'Parámetros de entrada
            dbBase.AddInParameter(dbCommand, "@p_Codigo", DbType.Int16, objAsignacionSemanasPorBimestres.CodigoAsignacionSemana)
            dbBase.AddInParameter(dbCommand, "@p_CodigoSemanaAcademica", DbType.Int16, objAsignacionSemanasPorBimestres.CodigoSemanaAcademica)
            dbBase.AddInParameter(dbCommand, "@p_CodigoBimestre", DbType.Int16, objAsignacionSemanasPorBimestres.CodigoBimestre)
            dbBase.AddInParameter(dbCommand, "@p_CodigoAnioAcademico", DbType.Int16, objAsignacionSemanasPorBimestres.CodigoAnioAcademico)
            dbBase.AddInParameter(dbCommand, "@p_Orden", DbType.Int16, objAsignacionSemanasPorBimestres.Orden)
        ...
        Public Function FUN_DEL_AsignacionSemanasPorBimestres(ByVal int_Codigo As Integer, ByRef str_Mensaje As String, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As Integer
            dbCommand = Me.dbBase.GetStoredProcCommand("CO_USP_DEL_AsignacionSemanasPorBimestres")
            'Parámetros de entrada
...
#Region "Metodos No Transaccionales"
        ...
        Public Function FUN_LIS_AsignacionSemanasPorBimestres(ByVal int_CodigoBimestre As Integer, ByVal int_CodigoAnioAcademico As Integer, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet
            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("CO_USP_LIS_AsignacionSemanasPorBimestres")
            'Parámetros de entrada
        ...
        Public Function FUN_LIS_AsignacionSemanasPorBimestreAgregar(ByVal int_CodigoBimestre As Integer, ByVal int_CodigoAnioAcademico As Integer, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet
            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("CO_USP_LIS_AsignacionSemanasPorBimestreAgregar")
            'Parámetros de entrada
            dbBase.AddInParameter(cmd, "@p_CodigoBimestre", DbType.Int32, int_CodigoBimestre)
            dbBase.AddInParameter(cmd, "@p_CodigoAnioAcademico", DbType.Int32, int_CodigoAnioAcademico)
            dbBase.AddInParameter(cmd, "@p_CodigoUsuario", DbType.Int16, int_CodigoUsuario)
        ...
        Public Function FUN_GET_AsignacionSemanasPorBimestres(ByVal int_Codigo As Integer, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet
            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("CO_USP_GET_AsignacionSemanasPorBimestres")
            'Parámetros de entrada
