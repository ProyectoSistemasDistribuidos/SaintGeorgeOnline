...
Namespace ModuloConfiguraciones
    ...
    Public Class da_AsignacionSubCategoriasPeriodo
...
#Region "Metodos No Transaccionales"
        ...
        Public Function FUN_LIS_AsignacionSubCategoriaPeriodoPorCategoria(ByVal int_CodigoAsignacionSubCategoria As Integer, ByVal int_CodigoUsuario As Integer, ByVal int_CodigoTipoUsuario As Integer, ByVal int_CodigoModulo As Integer, ByVal int_CodigoOpcion As Integer) As DataSet

            Dim cmd As DbCommand = dbBase.GetStoredProcCommand("PS_USP_LIS_AsignacionSubCategoriaPeriodoPorCategoria")
