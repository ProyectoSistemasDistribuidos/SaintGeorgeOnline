...
#Region "utiles"
    ...
    ''' Fecha de Creación:     03/10/2011
    ''' Modificado por:        _____________
    ''' Fecha de modificación: _____________ 
    ''' </remarks>
    Public Shared Function ListaMeses(ByVal int_MesIni As Integer, ByVal int_MesFin As Integer) As DataSet
        ...
        Dim str_Mes As String = ""
        Dim r As DataRow
        For i As Integer = int_MesIni To int_MesFin
            r = objDT_Meses.NewRow
            r.Item("Codigo") = i
            Select Case i
                Case 1 : str_Mes = "Enero"
    ...
    ''' Fecha de modificación: _____________ 
    ''' </remarks>
    Public Shared Function ListaNumerica(ByVal int_Inicio As Integer, _
                                         ByVal int_Fin As Integer) As DataSet
...
#Region "Filtro caracteres validos"
        ...
        ''' Fecha de modificación: _____________ 
        ''' </remarks>
        Public Shared Sub agregarGrupo(ByVal FilterTextBox As AjaxControlToolkit.FilteredTextBoxExtender, _
                                       ByVal int_Grupo As Integer)
